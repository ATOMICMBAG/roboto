  ...
  return {
    c() {
      ((e = k("div")),
        ...
        X(r, "class", "svelte-kxb172"),
        X(e, "class", "panel svelte-kxb172"));
    },
    m(o, a) {
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (i = ae()),
        (r = k("canvas")),
        X(r, "class", "svelte-1biaxg0"),
        X(e, "class", "panel svelte-1biaxg0"));
    },
    m(s, o) {
      (qe(s, e, o), R(e, t), R(e, i), R(e, r), n[1](r));
    },
...
class Et {
  ...
  multiplyMatrices(e, t) {
    ...
    return (
      ...
      (s[4] = o * A + a * V + l * F + c * j),
      (s[8] = o * N + a * Z + l * W + c * q),
      (s[12] = o * S + a * se + l * J + c * ee),
      (s[1] = u * w + f * b + d * D + m * K),
      (s[5] = u * A + f * V + d * F + m * j),
      (s[9] = u * N + f * Z + d * W + m * q),
      (s[13] = u * S + f * se + d * J + m * ee),
      (s[2] = _ * w + g * b + p * D + h * K),
      (s[6] = _ * A + g * V + p * F + h * j),
      (s[10] = _ * N + g * Z + p * W + h * q),
      (s[14] = _ * S + g * se + p * J + h * ee),
      (s[3] = M * w + x * b + T * D + P * K),
      (s[7] = M * A + x * V + T * F + P * j),
      (s[11] = M * N + x * Z + T * W + P * q),
      (s[15] = M * S + x * se + T * J + P * ee),
      this
    );
  }
  multiplyScalar(e) {
...
function hp(n, e, t, i) {
  ...
  function p(D) {
    const F = [],
      W = [],
      J = [];
    for (let K = 0; K < r; K++) ((F[K] = 0), (W[K] = 0), (J[K] = 0));
    return {
      geometry: null,
      program: null,
      wireframe: !1,
  ...
  function x() {
    ...
    for (let F = 0, W = D.length; F < W; F++) D[F] = 0;
  }
  function T(D) {
    P(D, 0);
  }
  ...
  function w() {
    ...
    for (let W = 0, J = F.length; W < J; W++)
      F[W] !== D[W] && (n.disableVertexAttribArray(W), (F[W] = 0));
  }
  function A(D, F, W, J, K, j, q) {
    q === !0 ?
      n.vertexAttribIPointer(D, F, W, K, j)
    : n.vertexAttribPointer(D, F, W, J, K, j);
  }
  function N(D, F, W, J) {
    if (
      i.isWebGL2 === !1 &&
  ...
  function l(c, u, f) {
    ...
    if (e.isWebGL2 === !0) {
      ...
      if (p === void 0 || p.count !== g) {
        let F = function () {
          (se.dispose(), s.delete(u), u.removeEventListener("dispose", F));
        };
        var m = F;
...
function Hm(n, e, t, i, r, s, o) {
  ...
  function p(S, b, V, Z, se) {
    const D = Z.fog,
      F = se.geometry,
      W = S.isMeshStandardMaterial ? Z.environment : null,
      J = (S.isMeshStandardMaterial ? t : e).get(S.envMap || W),
    ...
    let Q = 0;
    (F.morphAttributes.position !== void 0 && (Q = 1),
      F.morphAttributes.normal !== void 0 && (Q = 2),
      F.morphAttributes.color !== void 0 && (Q = 3));
    let I, Y, $, ce;
    if (j) {
      const Nt = fn[j];
    ...
    const me = n.getRenderTarget(),
      ...
      re = S.sheen > 0,
      Ee = S.transmission > 0,
      fe = B && !!S.anisotropyMap,
      _e = ie && !!S.clearcoatMap,
      Re = ie && !!S.clearcoatNormalMap,
      Be = ie && !!S.clearcoatRoughnessMap,
      te = ne && !!S.iridescenceMap,
      et = ne && !!S.iridescenceThicknessMap,
      We = re && !!S.sheenColorMap,
      De = re && !!S.sheenRoughnessMap,
      be = !!S.specularMap,
    ...
    return (
        ...
        (rt = n.toneMapping),
      {
        ...
        anisotropyMapUv: fe && g(S.anisotropyMap.channel),
        ...
        vertexTangents: !!F.attributes.tangent && (ve || B),
        ...
        vertexUv2s: Ae,
        vertexUv3s: it,
        pointsUvs: se.isPoints === !0 && !!F.attributes.uv && (Te || oe),
        fog: !!D,
        useFog: S.fog === !0,
        ...
        extensionDerivatives: he && S.extensions.derivatives === !0,
        extensionFragDepth: he && S.extensions.fragDepth === !0,
        extensionDrawBuffers: he && S.extensions.drawBuffers === !0,
        extensionShaderTextureLOD: he && S.extensions.shaderTextureLOD === !0,
    ...
    for (let Z = 0, se = u.length; Z < se; Z++) {
      ...
      if (D.isAmbientLight)
        ...
        (j.position.setFromMatrixPosition(D.matrixWorld),
          j.color.copy(F).multiplyScalar(W * b),
          (j.distance = J),
...
function t_(n, e, t) {
    ...
    for (let F = 0, W = w.length; F < W; F++) {
      ...
      for (let ee = 0; ee < q; ee++) {
        ...
        (o.set(s.x * Q.x, s.y * Q.y, s.x * Q.z, s.y * Q.w),
          ...
          (i = K.getFrustum()),
          T(A, N, K.camera, J, this.type));
      }
      (K.isPointLightShadow !== !0 && this.type === En && M(K, N),
        (K.needsUpdate = !1));
    }
    ((h = this.type), (p.needsUpdate = !1), n.setRenderTarget(S, b, V));
  };
  function M(w, A) {
    const N = e.update(g);
  ...
  function x(w, A, N, S) {
    ...
    if (V !== void 0) b = V;
      ...
      let F = D[se];
      (F === void 0 &&
        ((F = b.clone()), (D[se] = F), A.addEventListener("dispose", P)),
        (b = F));
    }
    if (
      ((b.visible = A.visible),
    ...
    if (
      ...
      if (Array.isArray(D)) {
        ...
        for (let W = 0, J = F.length; W < J; W++) {
          ...
          if (j && j.visible) {
            const q = x(w, j, S, b);
            (w.onBeforeShadow(n, w, A, N, se, q, K),
              n.renderBufferDirect(N, null, se, q, w, K),
              w.onAfterShadow(n, w, A, N, se, q, K));
          }
        }
      } else if (D.visible) {
        const F = x(w, D, S, b);
        (w.onBeforeShadow(n, w, A, N, se, F, null),
          n.renderBufferDirect(N, null, se, F, w, null),
          w.onAfterShadow(n, w, A, N, se, F, null));
      }
    }
    const Z = w.children;
    for (let se = 0, D = Z.length; se < D; se++) T(Z[se], A, N, S, b);
  }
  function P(w) {
...
function n_(n, e, t) {
  ...
  function r() {
    ...
    return {
      setMask: function (Ae) {
        he !== Ae && !C && (n.colorMask(Ae, Ae, Ae, Ae), (he = Ae));
      },
  ...
  function o() {
    ...
    return {
      ...
      setFunc: function (st, Ft, hn) {
        (he !== st || Ce !== Ft || Ae !== hn) &&
          (n.stencilFunc(st, Ft, hn), (he = st), (Ce = Ft), (Ae = hn));
      },
  ...
  function L(C, ue) {
    ...
    if (C)
      if (
        ...
        const Ae = C.texture;
        if (he.length !== Ae.length || he[0] !== n.COLOR_ATTACHMENT0) {
          for (let it = 0, rt = Ae.length; it < rt; it++)
            he[it] = n.COLOR_ATTACHMENT0 + it;
          ((he.length = Ae.length), (Ce = !0));
        }
      } else
        he[0] !== n.COLOR_ATTACHMENT0 &&
          ((he[0] = n.COLOR_ATTACHMENT0), (Ce = !0));
    else he[0] !== n.BACK && ((he[0] = n.BACK), (Ce = !0));
    Ce &&
      (t.isWebGL2 ?
        n.drawBuffers(he)
  ...
  function ve(C, ue, he, Ce, Ae, it, rt, bt, Nt, st) {
    if (C === Fn) {
      h === !0 && (Te(n.BLEND), (h = !1));
      return;
    }
    ...
    ((Ae = Ae || ue),
      ...
      (he !== T || Ce !== P || it !== A || rt !== N) &&
        (n.blendFuncSeparate(Se[he], Se[Ce], Se[it], Se[rt]),
        (T = he),
        (P = Ce),
        (A = it),
        (N = rt)),
  ...
  function pt(C, ue) {
    ...
    (c.setTest(Ce),
      ...
      B(C.polygonOffset, C.polygonOffsetFactor, C.polygonOffsetUnits),
      C.alphaToCoverage === !0 ?
  ...
  function v(C) {
    C !== D && (K && n.lineWidth(C), (D = C));
  }
  function B(C, ue, he) {
    C ?
      (Pe(n.POLYGON_OFFSET_FILL),
      (F !== ue || W !== he) && (n.polygonOffset(ue, he), (F = ue), (W = he)))
  ...
  function re(C, ue, he) {
    he === void 0 && (ee === null ? (he = n.TEXTURE0 + J - 1) : (he = ee));
    let Ce = Q[he];
    (Ce === void 0 && ((Ce = { type: void 0, texture: void 0 }), (Q[he] = Ce)),
      (Ce.type !== C || Ce.texture !== ue) &&
        (ee !== he && (n.activeTexture(he), (ee = he)),
  ...
  function Ne(C) {
    $.equals(C) === !1 && (n.scissor(C.x, C.y, C.z, C.w), $.copy(C));
  }
  function Je(C) {
  ...
  function _t(C, ue) {
    let he = f.get(ue);
    he === void 0 && ((he = new WeakMap()), f.set(ue, he));
    let Ce = he.get(C);
    Ce === void 0 && ((Ce = n.getUniformBlockIndex(ue, C.name)), he.set(C, Ce));
  }
  function Ge(C, ue) {
    const Ce = f.get(ue).get(C);
    u.get(ue) !== Ce &&
...
function i_(n, e, t, i, r, s, o) {
    ...
    if (
      ...
      if (
        ...
        const re = v ? zs : Math.floor,
          ...
          fe = re(ne * y.height);
        f === void 0 && (f = _(Ee, fe));
        const _e = B ? _(Ee, fe) : f;
        return (
          (_e.width = Ee),
          (_e.height = fe),
          _e.getContext("2d").drawImage(y, 0, 0, Ee, fe),
          console.warn(
  ...
  function T(y, v, B, ie, ne = !1) {
    ...
    if (
      (v === n.RED &&
        (B === n.FLOAT && (re = n.R32F),
        B === n.HALF_FLOAT && (re = n.R16F),
        B === n.UNSIGNED_BYTE && (re = n.R8)),
      v === n.RED_INTEGER &&
        (B === n.UNSIGNED_BYTE && (re = n.R8UI),
        B === n.UNSIGNED_SHORT && (re = n.R16UI),
        B === n.UNSIGNED_INT && (re = n.R32UI),
        B === n.BYTE && (re = n.R8I),
        B === n.SHORT && (re = n.R16I),
        B === n.INT && (re = n.R32I)),
      v === n.RG &&
        (B === n.FLOAT && (re = n.RG32F),
        B === n.HALF_FLOAT && (re = n.RG16F),
        B === n.UNSIGNED_BYTE && (re = n.RG8)),
      v === n.RGBA)
    ) {
      const Ee = ne ? Ur : tt.getTransfer(ie);
      (B === n.FLOAT && (re = n.RGBA32F),
        B === n.HALF_FLOAT && (re = n.RGBA16F),
        B === n.UNSIGNED_BYTE && (re = Ee === lt ? n.SRGB8_ALPHA8 : n.RGBA8),
        B === n.UNSIGNED_SHORT_4_4_4_4 && (re = n.RGBA4),
        B === n.UNSIGNED_SHORT_5_5_5_1 && (re = n.RGB5_A1));
    }
    return (
      (re === n.R16F ||
        re === n.R32F ||
  ...
  function N(y) {
    const v = y.target;
    (v.removeEventListener("dispose", N), V(v));
  }
  function S(y) {
    const v = i.get(y);
    ...
    if (ie) {
      ...
      (ne.usedTimes--,
        ne.usedTimes === 0 && b(y),
        Object.keys(ie).length === 0 && d.delete(B));
    }
    i.remove(y);
  }
  function b(y) {
    ...
    if (
      ...
      for (let ne = 0; ne < 6; ne++) {
        if (Array.isArray(B.__webglFramebuffer[ne]))
          for (let re = 0; re < B.__webglFramebuffer[ne].length; re++)
            n.deleteFramebuffer(B.__webglFramebuffer[ne][re]);
        else n.deleteFramebuffer(B.__webglFramebuffer[ne]);
        B.__webglDepthbuffer && n.deleteRenderbuffer(B.__webglDepthbuffer[ne]);
      }
    else {
      if (Array.isArray(B.__webglFramebuffer))
        for (let ne = 0; ne < B.__webglFramebuffer.length; ne++)
          n.deleteFramebuffer(B.__webglFramebuffer[ne]);
      ...
      if (
        ...
        for (let ne = 0; ne < B.__webglColorRenderbuffer.length; ne++)
          B.__webglColorRenderbuffer[ne] &&
            n.deleteRenderbuffer(B.__webglColorRenderbuffer[ne]);
  ...
  function $(y, v, B) {
    ...
    const ne = Y(y, v),
      re = v.source;
    t.bindTexture(ie, y.__webglTexture, n.TEXTURE0 + B);
    const Ee = i.get(re);
    if (re.version !== Ee.__version || ne === !0) {
      ...
      const fe = tt.getPrimaries(tt.workingColorSpace),
        ...
        Re =
          v.colorSpace === nn || fe === _e ? n.NONE : n.BROWSER_DEFAULT_WEBGL;
  ...
  function ce(y, v, B) {
    ...
    if (ne.version !== re.__version || ie === !0) {
      ...
      const Ee = tt.getPrimaries(tt.workingColorSpace),
        fe = v.colorSpace === nn ? null : tt.getPrimaries(v.colorSpace),
        _e =
          v.colorSpace === nn || Ee === fe ? n.NONE : n.BROWSER_DEFAULT_WEBGL;
      (n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL, v.flipY),
        n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL, v.premultiplyAlpha),
        n.pixelStorei(n.UNPACK_ALIGNMENT, v.unpackAlignment),
  ...
  function me(y, v, B, ie, ne, re) {
    const Ee = s.convert(B.format, B.colorSpace),
      fe = s.convert(B.type),
      _e = T(B.internalFormat, Ee, fe, B.colorSpace);
    if (!i.get(v).__hasExternalTextures) {
      ...
      ne === n.TEXTURE_3D || ne === n.TEXTURE_2D_ARRAY ?
        t.texImage3D(ne, re, _e, Be, te, v.depth, 0, Ee, fe, null)
      : t.texImage2D(ne, re, _e, Be, te, 0, Ee, fe, null);
    }
    ...
    if (
      ...
      for (let ne = 0; ne < ie.length; ne++) {
        const re = ie[ne],
          ...
          _e = T(re.internalFormat, Ee, fe, re.colorSpace),
          Re = Se(v);
        B && ve(v) === !1 ?
          n.renderbufferStorageMultisample(
            n.RENDERBUFFER,
    ...
    if (ne) {
      ...
      for (let fe = 0; fe < 6; fe++)
        if (a && v.mipmaps && v.mipmaps.length > 0) {
          B.__webglFramebuffer[fe] = [];
          for (let _e = 0; _e < v.mipmaps.length; _e++)
            B.__webglFramebuffer[fe][_e] = n.createFramebuffer();
        } else B.__webglFramebuffer[fe] = n.createFramebuffer();
    } else {
      if (a && v.mipmaps && v.mipmaps.length > 0) {
        B.__webglFramebuffer = [];
        for (let fe = 0; fe < v.mipmaps.length; fe++)
          B.__webglFramebuffer[fe] = n.createFramebuffer();
      } else B.__webglFramebuffer = n.createFramebuffer();
      if (re)
        if (r.drawBuffers) {
          const fe = y.texture;
          for (let _e = 0, Re = fe.length; _e < Re; _e++) {
            const Be = i.get(fe[_e]);
      ...
      if (a && y.samples > 0 && ve(y) === !1) {
        ...
        for (let _e = 0; _e < fe.length; _e++) {
          const Re = fe[_e];
          ((B.__webglColorRenderbuffer[_e] = n.createRenderbuffer()),
            n.bindRenderbuffer(n.RENDERBUFFER, B.__webglColorRenderbuffer[_e]));
          ...
          (n.renderbufferStorageMultisample(
            ...
            n.framebufferRenderbuffer(
              ...
              n.RENDERBUFFER,
              B.__webglColorRenderbuffer[_e],
            ));
        }
        (n.bindRenderbuffer(n.RENDERBUFFER, null),
          y.depthBuffer &&
            ((B.__webglDepthRenderbuffer = n.createRenderbuffer()),
            Me(B.__webglDepthRenderbuffer, y, !0)),
          t.bindFramebuffer(n.FRAMEBUFFER, null));
      }
    }
    if (ne) {
      ...
      if (
        ...
        t.bindTexture(fe, ie.__webglTexture),
        I(fe, v, Ee),
        a && v.mipmaps && v.mipmaps.length > 0)
      )
        for (let _e = 0; _e < v.mipmaps.length; _e++)
          me(B.__webglFramebuffer[_e], y, v, n.COLOR_ATTACHMENT0, fe, _e);
      else me(B.__webglFramebuffer, y, v, n.COLOR_ATTACHMENT0, fe, 0);
      (M(v, Ee) && x(fe), t.unbindTexture());
    }
    y.depthBuffer && Te(y);
  }
  function Ze(y) {
    ...
    for (let ie = 0, ne = B.length; ie < ne; ie++) {
      const re = B[ie];
      if (M(re, v)) {
        const Ee =
            y.isWebGLCubeRenderTarget ? n.TEXTURE_CUBE_MAP : n.TEXTURE_2D,
          fe = i.get(re).__webglTexture;
        (t.bindTexture(Ee, fe), x(Ee), t.unbindTexture());
      }
    }
  }
  function xe(y) {
    if (a && y.samples > 0 && ve(y) === !1) {
      ...
      for (let Re = 0; Re < v.length; Re++) {
        ...
        if (
          ...
          _e &&
            n.framebufferRenderbuffer(
              ...
              n.COLOR_ATTACHMENT0,
              n.RENDERBUFFER,
              fe.__webglColorRenderbuffer[Re],
            ),
          Be === !0 &&
        ...
        (n.blitFramebuffer(0, 0, B, ie, 0, 0, B, ie, ne, n.NEAREST),
  ...
  constructor(e, t) {
    ...
    function J(I, Y, $) {
      ...
      const y = Pe + pt,
        ...
        ne = (($e * Te) / v) * y,
        re = ((L * Te) / v) * y;
      (I.projectionMatrix.makePerspective(B, ie, ne, re, y, v),
    ...
    function ee(I, Y) {
      if (((u = Y.getViewerPose(c || o)), (_ = Y), u !== null)) {
        ...
        m !== null &&
          ...
          e.setRenderTarget(h));
        let ce = !1;
        $.length !== S.cameras.length && ((S.cameras.length = 0), (ce = !0));
      ...
      for (let $ = 0; $ < M.length; $++) {
        const ce = x[$],
          me = M[$];
        ce !== null && me !== void 0 && me.update(ce, Y, c || o);
      }
      (q && q(I, Y),
        Y.detectedPlanes &&
  ...
  function _(M) {
    ...
    for (let A = 0, N = x.length; A < N; A++) {
      ...
      for (let b = 0, V = S.length; b < V; b++) {
        ...
        for (let D = 0, F = se.length; D < F; D++) {
          const W = se[D],
            J = g(W),
            K = T % P;
          (K !== 0 && P - K < J.boundary && (T += P - K),
  ...
  constructor(e = {}) {
    ...
    function _t() {
      ((xe = new xp(L)),
        ...
        (B = new vp(x)),
        (ie = new Ch(L, Se)),
        (Ne = new hp(L, xe, ie, Se)),
        (ne = new Mp(L, ie, pt, Ne)),
        (re = new Ap(L, ne, ie, pt)),
        (We = new bp(L, Se, y)),
        (Be = new pp(Oe)),
        (Ee = new Hm(x, v, B, xe, Se, Ne, Be)),
        (fe = new l_(x, Oe)),
        (_e = new Wm()),
        (Re = new Km(xe, Se)),
        (et = new up(x, v, B, ve, re, d, l)),
        (te = new t_(x, re, Se)),
    ...
    ((this.xr = Ge),
      ...
      (this.setPixelRatio = function (E) {
        E !== void 0 && ((J = E), this.setSize(F, W, !1));
      }),
      ...
      (this.setViewport = function (E, U, z, H) {
        (E.isVector4 ? q.set(E.x, E.y, E.z, E.w) : q.set(E, U, z, H),
      ...
      (this.setScissor = function (E, U, z, H) {
        (E.isVector4 ? ee.set(E.x, E.y, E.z, E.w) : ee.set(E, U, z, H),
    ...
    function he(E) {
      const U = E.target;
      (U.removeEventListener("dispose", he), Ce(U));
    }
    function Ce(E) {
      (Ae(E), Oe.remove(E));
    }
    ...
    this.renderBufferDirect = function (E, U, z, H, O, de) {
      U === null && (U = Te);
      const ye = O.isMesh && O.matrixWorld.determinant() < 0,
        we = Hl(E, U, z, H, O);
      ve.setMaterial(H, ye);
      let Le = z.index,
        ze = 1;
      ...
      if (
        ...
        H.wireframe === !0 ?
          (ve.setLineWidth(H.wireframeLinewidth * $e()), mt.setMode(L.LINES))
        : mt.setMode(L.TRIANGLES);
      else if (O.isLine) {
        let He = H.linewidth;
        (He === void 0 && (He = 1),
          ve.setLineWidth(He * $e()),
          O.isLineSegments ? mt.setMode(L.LINES)
          : O.isLineLoop ? mt.setMode(L.LINE_LOOP)
          : mt.setMode(L.LINE_STRIP));
      } else
        O.isPoints ?
          mt.setMode(L.POINTS)
        : O.isSprite && mt.setMode(L.TRIANGLES);
      if (O.isBatchedMesh)
        mt.renderMultiDraw(
          O._multiDrawStarts,
          O._multiDrawCounts,
      ...
      else if (O.isInstancedMesh) mt.renderInstances(vt, At, O.count);
          ...
          function de() {
            if (
              (H.forEach(function (ye) {
                Oe.get(ye).currentProgram.isReady() && H.delete(ye);
              }),
              H.size === 0)
            ) {
              O(E);
    ...
    (Ft.setAnimationLoop(bt),
      ...
      (this.render = function (E, U) {
        ...
        if (
          ...
          const H = U.cameras;
          for (let O = 0, de = H.length; O < de; O++) {
            const ye = H[O];
    ...
    function hn(E, U, z, H) {
      ...
      if (E.layers.test(U.layers)) {
        if (E.isGroup) z = E.renderOrder;
          ...
          if (!E.frustumCulled || I.intersectsSprite(E)) {
            H && Pe.setFromMatrixPosition(E.matrixWorld).applyMatrix4(me);
            const ye = re.update(E),
              we = E.material;
      ...
      const de = E.children;
      for (let ye = 0, we = de.length; ye < we; ye++) hn(de[ye], U, z, H);
    }
    function ea(E, U, z, H) {
      const O = E.opaque,
        de = E.transmissive,
        ye = E.transparent;
      (p.setupLightsView(z),
        Y === !0 && Be.setGlobalState(x.clippingPlanes, z),
        de.length > 0 && Gl(O, de, U, z),
        H && ve.viewport(b.copy(H)),
        O.length > 0 && nr(O, U, z),
    ...
    function Gl(E, U, z, H) {
      ...
      for (let ze = 0, Ue = U.length; ze < Ue; ze++) {
        const Ie = U[ze],
          ...
          At = Ie.material,
          _n = Ie.group;
        if (At.side === dn && vt.layers.test(H.layers)) {
          const mt = At.side;
          ((At.side = Wt),
            (At.needsUpdate = !0),
            ta(vt, z, H, Xt, At, _n),
    ...
    function nr(E, U, z) {
      ...
      for (let O = 0, de = E.length; O < de; O++) {
        const ye = E[O],
          we = ye.object,
          Le = ye.geometry,
          ze = H === null ? ye.material : H,
          Ue = ye.group;
        we.layers.test(z.layers) && ta(we, U, z, Le, ze, Ue);
      }
    }
    function ta(E, U, z, H, O, de) {
      (E.onBeforeRender(x, U, z, H, O, de),
        E.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse, E.matrixWorld),
        E.normalMatrix.getNormalMatrix(E.modelViewMatrix),
        O.onBeforeRender(x, U, z, H, E, de),
        O.transparent === !0 && O.side === dn && O.forceSinglePass === !1 ?
          ((O.side = Wt),
          (O.needsUpdate = !0),
          x.renderBufferDirect(z, U, H, O, E, de),
          (O.side = Gn),
          (O.needsUpdate = !0),
          x.renderBufferDirect(z, U, H, O, E, de),
          (O.side = dn))
        : x.renderBufferDirect(z, U, H, O, E, de),
        E.onAfterRender(x, U, z, H, O, de));
    }
    function ir(E, U, z) {
      U.isScene !== !0 && (U = Te);
      const H = Oe.get(E),
        ...
        ye = O.state.version,
        we = Ee.getParameters(E, O.state, de, U, z),
      ...
      let Ue = ze.get(Le);
      if (Ue !== void 0) {
        if (H.currentProgram === Ue && H.lightsStateVersion === ye)
          return (ia(E, we), Ue);
      } else
      ...
      return (
        ...
        ia(E, we),
        (H.needsLights = Vl(E)),
        (H.lightsStateVersion = ye),
        H.needsLights &&
          ((Ie.ambientLightColor.value = O.state.ambient),
    ...
    function Hl(E, U, z, H, O) {
      ...
      const de = U.fog,
        ye = H.isMeshStandardMaterial ? U.environment : null,
        we =
          A === null ? x.outputColorSpace
          : A.isXRRenderTarget === !0 ? A.texture.colorSpace
          : An,
        Le = (H.isMeshStandardMaterial ? B : v).get(H.envMap || ye),
        ze =
          H.vertexColors === !0 &&
          !!z.attributes.color &&
          z.attributes.color.itemSize === 4,
        Ue = !!z.attributes.tangent && (!!H.normalMap || H.anisotropy > 0),
      ...
      if (O.isSkinnedMesh) {
        (Pt.setOptional(L, O, "bindMatrix"),
          Pt.setOptional(L, O, "bindMatrixInverse"));
        const Jt = O.skeleton;
        Jt &&
      ...
      O.isBatchedMesh &&
        (Pt.setOptional(L, O, "batchingTexture"),
        Pt.setValue(L, "batchingTexture", O._matricesTexture, y));
      ...
      if (
        ...
        (Bi || He.receiveShadow !== O.receiveShadow) &&
          ...
          Pt.setValue(L, "receiveShadow", O.receiveShadow)),
        ...
        Bi &&
          ...
          de && H.fog === !0 && fe.refreshFogUniforms(kn, de),
          fe.refreshMaterialUniforms(kn, H, J, W, ce),
          Cr.upload(L, na(He), kn, y)),
        H.isShaderMaterial &&
          H.uniformsNeedUpdate === !0 &&
          (Cr.upload(L, na(He), kn, y), (H.uniformsNeedUpdate = !1)),
        H.isSpriteMaterial && Pt.setValue(L, "center", O.center),
        Pt.setValue(L, "modelViewMatrix", O.modelViewMatrix),
        Pt.setValue(L, "normalMatrix", O.normalMatrix),
        Pt.setValue(L, "modelMatrix", O.matrixWorld),
    ...
    ((this.getActiveCubeFace = function () {
      ...
      (this.setRenderTarget = function (E, U = 0, z = 0) {
        ...
        if (E) {
          ...
          Le.__useDefaultFramebuffer !== void 0 ?
            (ve.bindFramebuffer(L.FRAMEBUFFER, null), (H = !1))
          ...
          (b.copy(q).multiplyScalar(J).floor(),
            ...
            (Z = Q));
        if (
          (ve.bindFramebuffer(L.FRAMEBUFFER, O) &&
            Se.drawBuffers &&
            H &&
            ve.drawBuffers(E, O),
          ve.viewport(b),
      ...
      (this.readRenderTargetPixels = function (E, U, z, H, O, de, ye) {
        ...
        if ((E.isWebGLCubeRenderTarget && ye !== void 0 && (we = we[ye]), we)) {
          ...
          try {
            ...
            U >= 0 &&
              ...
              z >= 0 &&
              z <= E.height - O &&
              L.readPixels(U, z, H, O, ge.convert(ze), ge.convert(Ue), de);
          } finally {
      ...
      (this.copyFramebufferToTexture = function (E, U, z = 0) {
        const H = Math.pow(2, -z),
          ...
          de = Math.floor(U.image.height * H);
        (y.setTexture2D(U, 0),
          L.copyTexSubImage2D(L.TEXTURE_2D, z, 0, 0, E.x, E.y, O, de),
          ve.unbindTexture());
      }),
      (this.copyTextureToTexture = function (E, U, z, H = 0) {
        ...
        (y.setTexture2D(z, 0),
          ...
          : L.texSubImage2D(L.TEXTURE_2D, H, E.x, E.y, ye, we, U.image),
          H === 0 && z.generateMipmaps && L.generateMipmap(L.TEXTURE_2D),
          ve.unbindTexture());
      }),
      (this.copyTextureToTexture3D = function (E, U, z, H, O = 0) {
        ...
        const de = E.max.x - E.min.x + 1,
          ...
          Le = ge.convert(H.format),
          ze = ge.convert(H.type);
        let Ue;
        ...
        const Ie = L.getParameter(L.UNPACK_ROW_LENGTH),
          ...
          mt = z.isCompressedTexture ? z.mipmaps[O] : z.image;
        (L.pixelStorei(L.UNPACK_ROW_LENGTH, mt.width),
          ...
          z.isDataTexture || z.isData3DTexture ?
            L.texSubImage3D(Ue, O, U.x, U.y, U.z, de, ye, we, Le, ze, mt.data)
          ...
          : L.texSubImage3D(Ue, O, U.x, U.y, U.z, de, ye, we, Le, ze, mt),
          ...
          O === 0 && H.generateMipmaps && L.generateMipmap(Ue),
          ve.unbindTexture());
      }),
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (i = ae()),
        (r = k("div")),
        X(r, "class", "svelte-19prjrk"),
        X(e, "class", "panel svelte-19prjrk"));
    },
    m(s, o) {
      (qe(s, e, o), R(e, t), R(e, i), R(e, r), n[1](r));
    },
  ...
  return {
    c() {
      ((e = k("article")),
        ...
        (s = ae()),
        X(t, "class", "svelte-y0nt3a"),
        X(r, "class", "svelte-y0nt3a"),
        X(e, "class", "svelte-y0nt3a"));
    },
    m(o, a) {
...
function E_(n) {
  ...
  return {
    ...
    ohne dass die App überfordert.`),
        X(t, "class", "svelte-y0nt3a"),
        X(r, "class", "svelte-y0nt3a"),
        X(o, "class", "svelte-y0nt3a"),
        X(l, "class", "svelte-y0nt3a"),
        X(u, "class", "svelte-y0nt3a"),
        X(d, "class", "svelte-y0nt3a"),
        X(_, "class", "svelte-y0nt3a"),
        X(p, "class", "svelte-y0nt3a"),
        X(M, "class", "svelte-y0nt3a"),
        X(T, "class", "svelte-y0nt3a"),
        X(w, "class", "svelte-y0nt3a"),
        X(N, "class", "svelte-y0nt3a"),
        X(b, "class", "svelte-y0nt3a"),
        X(Z, "class", "svelte-y0nt3a"),
        X(D, "class", "cards svelte-y0nt3a"),
        X(W, "class", "svelte-y0nt3a"),
        X(K, "class", "svelte-y0nt3a"),
        X(e, "class", "guide svelte-y0nt3a"));
    },
    m(I, Y) {
      (qe(I, e, Y),
        R(e, t),
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (a.__value = "pose"),
        Qe(a, a.__value),
        X(r, "class", "svelte-r2nhty"),
        n[0] === void 0 && ti(() => n[2].call(r)),
        X(e, "class", "panel svelte-r2nhty"));
    },
    m(u, f) {
      (qe(u, e, f),
        R(e, t),
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (p.__value = "mobile"),
        Qe(p, p.__value),
        X(d, "class", "svelte-qs5au8"),
        n[1] === void 0 && ti(() => n[5].call(d)),
        X(e, "class", "panel svelte-qs5au8"));
    },
    m(x, T) {
      (qe(x, e, T),
        R(e, t),
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (f = Ve(u)),
        (m = ae()),
        X(t, "class", "svelte-z2n7q3"),
        Rt(t, "selected", n[5].active),
        X(c, "class", (d = "status " + n[5].status + " svelte-z2n7q3")),
        X(e, "class", "node"),
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (T = ae()),
        A.c(),
        X(i, "class", (a = "badge " + Ti(n[2]) + " svelte-c7ghqi")),
        X(c, "class", (m = "badge " + Ti(n[3]) + " svelte-c7ghqi")),
        X(
          g,
          "class",
          (x = "badge " + Ti(n[4] === "connected") + " svelte-c7ghqi"),
        ),
        X(t, "class", "badges svelte-c7ghqi"),
        X(e, "class", "log svelte-c7ghqi"));
    },
    m(N, S) {
      (qe(N, e, S),
        R(e, t),
    ...
    p(N, S) {
      (S & 4 && s !== (s = N[2] ? "ONLINE" : "OFFLINE") && Mt(o, s),
        S & 4 &&
          a !== (a = "badge " + Ti(N[2]) + " svelte-c7ghqi") &&
          X(i, "class", a),
        S & 8 && f !== (f = N[3] ? "ONLINE" : "OFFLINE") && Mt(d, f),
        S & 8 &&
          m !== (m = "badge " + Ti(N[3]) + " svelte-c7ghqi") &&
          X(c, "class", m),
        S & 16 && h !== (h = N[4].toUpperCase() + "") && Mt(M, h),
        S & 16 &&
          x !== (x = "badge " + Ti(N[4] === "connected") + " svelte-c7ghqi") &&
          X(g, "class", x),
        w === (w = P(N)) && A ?
          A.p(N, S)
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        X(e, "class", "item muted svelte-c7ghqi"));
    },
    m(t, i) {
      qe(t, e, i);
    },
...
function Wo(n) {
  ...
  return {
    c() {
      ((e = k("span")), (t = Ve("— ")), (r = Ve(i)), X(e, "class", "details"));
    },
    m(s, o) {
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        M && M.c(),
        (p = ae()),
        X(t, "class", "time svelte-c7ghqi"),
        X(l, "class", "src svelte-c7ghqi"),
        X(d, "class", "act"),
        X(e, "class", (h = "item " + n[7].status + " svelte-c7ghqi")));
    },
    m(x, T) {
      (qe(x, e, T),
        R(e, t),
    ...
    p(x, T) {
      (T & 32 && r !== (r = x[7].ts + "") && Mt(s, r),
        ...
        : M && (M.d(1), (M = null)),
        T & 32 &&
          h !== (h = "item " + x[7].status + " svelte-c7ghqi") &&
          X(e, "class", h));
    },
    d(x) {
      (x && Xe(e), M && M.d());
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (c = ae()),
        m && m.c(),
        X(i, "class", "svelte-c7ghqi"),
        X(s, "class", "svelte-c7ghqi"),
        X(t, "class", "header svelte-c7ghqi"),
        X(e, "class", "panel svelte-c7ghqi"));
    },
    m(_, g) {
      (qe(_, e, g),
        R(e, t),
    ...
    ~(Y = $e(n)) && ($ = Te[Y] = Pe[Y](n)),
    {
      c() {
        ...
        ((w = ae()),
          ...
          (I = k("div")),
          $ && $.c(),
          X(i, "class", "svelte-1hbucwp"),
          X(o, "class", "badge svelte-1hbucwp"),
          Rt(o, "ok", n[1]),
          Rt(o, "bad", !n[1]),
          X(f, "class", "badge svelte-1hbucwp"),
          Rt(f, "ok", n[2]),
          Rt(f, "bad", !n[2]),
          X(p, "class", "badge svelte-1hbucwp"),
          Rt(p, "ok", n[3] === "connected"),
          Rt(p, "bad", n[3] !== "connected"),
          X(s, "class", "statusbar svelte-1hbucwp"),
          X(P, "class", "svelte-1hbucwp"),
          X(t, "class", "topbar svelte-1hbucwp"),
          X(N, "class", "sidebar svelte-1hbucwp"),
          X(I, "class", "workspace svelte-1hbucwp"),
          X(A, "class", "content svelte-1hbucwp"),
          X(e, "class", "app svelte-1hbucwp"));
      },
      m(L, Ze) {
        (qe(L, e, Ze),
          R(e, t),
