...
function Fo(n) {
  ...
  return {
    c() {
      ((e = k("button")),
        (e.textContent = `${n[9].label} `),
        Mt(e, "active", activeTab === n[9].id));
    },
    m(s, o) {
      ($e(s, e, o), t || ((i = Ye(e, "click", r)), (t = !0)));
    },
    p(s, o) {
      ((n = s), o & 0 && Mt(e, "active", activeTab === n[9].id));
    },
    d(s) {
      (s && We(e), (t = !1), i());
    },
...
function Bo(n) {
  ...
  return {
    c() {
      ((e = k("article")),
        (t = k("h4")),
        (t.textContent = `${n[3].title}`),
        (i = ce()),
        (r = k("p")),
        (r.textContent = `${n[3].text}`),
        (s = ce()),
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (T = ce()),
        A.c(),
        $(i, "class", (a = "badge " + bi(n[2]) + " svelte-c7ghqi")),
        $(c, "class", (m = "badge " + bi(n[3]) + " svelte-c7ghqi")),
        $(
          g,
          "class",
          (x = "badge " + bi(n[4] === "connected") + " svelte-c7ghqi"),
        ),
        $(t, "class", "badges svelte-c7ghqi"),
        $(e, "class", "log svelte-c7ghqi"));
    },
    m(I, S) {
      ($e(I, e, S),
        R(e, t),
    ...
    p(I, S) {
      (S & 4 && s !== (s = I[2] ? "ONLINE" : "OFFLINE") && St(o, s),
        S & 4 &&
          a !== (a = "badge " + bi(I[2]) + " svelte-c7ghqi") &&
          $(i, "class", a),
        S & 8 && f !== (f = I[3] ? "ONLINE" : "OFFLINE") && St(d, f),
        S & 8 &&
          m !== (m = "badge " + bi(I[3]) + " svelte-c7ghqi") &&
          $(c, "class", m),
        S & 16 && h !== (h = I[4].toUpperCase() + "") && St(M, h),
        S & 16 &&
          x !== (x = "badge " + bi(I[4] === "connected") + " svelte-c7ghqi") &&
          $(g, "class", x),
        w === (w = P(I)) && A ?
          A.p(I, S)
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        $(e, "class", "item muted svelte-c7ghqi"));
    },
    m(t, i) {
      $e(t, e, i);
    },
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        M && M.c(),
        (p = ce()),
        $(t, "class", "time svelte-c7ghqi"),
        $(l, "class", "src svelte-c7ghqi"),
        $(d, "class", "act"),
        $(e, "class", (h = "item " + n[7].status + " svelte-c7ghqi")));
    },
    m(x, T) {
      ($e(x, e, T),
        R(e, t),
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (c = ce()),
        m && m.c(),
        $(i, "class", "svelte-c7ghqi"),
        $(s, "class", "svelte-c7ghqi"),
        $(t, "class", "header svelte-c7ghqi"),
        $(e, "class", "panel svelte-c7ghqi"));
    },
    m(_, g) {
      ($e(_, e, g),
        R(e, t),
    ...
    ~(V = qe(n)) && (se = ge[V] = ee[V](n)),
    {
      c() {
        ...
        ((w = ce()),
          ...
          (G = k("div")),
          se && se.c(),
          $(i, "class", "svelte-1hbucwp"),
          $(o, "class", "badge svelte-1hbucwp"),
          Mt(o, "ok", n[1]),
          Mt(o, "bad", !n[1]),
          $(f, "class", "badge svelte-1hbucwp"),
          Mt(f, "ok", n[2]),
          Mt(f, "bad", !n[2]),
          $(p, "class", "badge svelte-1hbucwp"),
          Mt(p, "ok", n[3] === "connected"),
          Mt(p, "bad", n[3] !== "connected"),
          $(s, "class", "statusbar svelte-1hbucwp"),
          $(P, "class", "svelte-1hbucwp"),
          $(t, "class", "topbar svelte-1hbucwp"),
          $(I, "class", "sidebar svelte-1hbucwp"),
          $(G, "class", "workspace svelte-1hbucwp"),
          $(A, "class", "content svelte-1hbucwp"),
          $(e, "class", "app svelte-1hbucwp"));
      },
      m(L, Ze) {
        ($e(L, e, Ze),
          R(e, t),
