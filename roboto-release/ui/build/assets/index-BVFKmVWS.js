...
function Vc(n, e, t) {
  ...
  function l(h) {
    const M = r.getBoundingClientRect(),
      x = h.clientX - M.left,
      b = h.clientY - M.top;
    (o.push({ x, y: b, score: 1 }), o.length === 17 && (Ic(o), (o = [])), d());
  }
  function c(h) {
    const M = r.getBoundingClientRect(),
      x = h.clientX - M.left,
    ...
    i.forEach((L, w) => {
      L.type === "keypoints" &&
        L.points.forEach((A, $) => {
          const E = A.x - x,
            T = A.y - b;
          E * E + T * T < jr * jr && (a = { annIndex: w, pointIndex: $ });
        });
    });
  }
  function u(h) {
    ...
    const M = r.getBoundingClientRect(),
      x = h.clientX - M.left,
      b = h.clientY - M.top;
    (Nc(a.annIndex, a.pointIndex, x, b), d());
  }
  function f() {
    a = null;
  }
  ...
  function g(h) {
    ((s.strokeStyle = "lime"),
      ...
      _.forEach(([M, x]) => {
        ...
        !b ||
          !L ||
          (s.beginPath(), s.moveTo(b.x, b.y), s.lineTo(L.x, L.y), s.stroke());
      }),
...
function Zc(n) {
  let e, t, i, r, s, o, a, l, c, u, f, d, m, _, g, p, h, M, x, b, L, w;
  return {
    c() {
      ((e = H("div")),
        (t = H("h2")),
    ...
    p(A, [$]) {
      ($ & 1 && jt(o.value) !== A[0] && Qe(o, A[0]),
        $ & 2 && jt(l.value) !== A[1] && Qe(l, A[1]),
        $ & 4 && jt(d.value) !== A[2] && Qe(d, A[2]),
        $ & 8 && jt(_.value) !== A[3] && Qe(_, A[3]),
        $ & 16 && jt(M.value) !== A[4] && Qe(M, A[4]));
    },
    i: ve,
    o: ve,
    d(A) {
    ...
    if (
      ...
      return (
        ...
        : b > L ?
          ...
          : ((r = Math.sqrt(b)), (i = w / r), (s = $ / r))
        : L < 0.01 ? ((i = 0.707106781), (r = 0.707106781), (s = 0))
        : ((s = Math.sqrt(L)), (i = A / s), (r = $ / s)),
        this.set(i, r, s, t),
        this
      );
    }
...
class St {
  ...
  multiplyMatrices(e, t) {
    ...
    return (
      ...
      (s[4] = o * A + a * V + l * I + c * K),
      (s[8] = o * $ + a * j + l * B + c * Y),
      (s[12] = o * E + a * re + l * W + c * te),
      (s[1] = u * w + f * T + d * P + m * X),
      (s[5] = u * A + f * V + d * I + m * K),
      (s[9] = u * $ + f * j + d * B + m * Y),
      (s[13] = u * E + f * re + d * W + m * te),
      (s[2] = _ * w + g * T + p * P + h * X),
      (s[6] = _ * A + g * V + p * I + h * K),
      (s[10] = _ * $ + g * j + p * B + h * Y),
      (s[14] = _ * E + g * re + p * W + h * te),
      (s[3] = M * w + x * T + b * P + L * X),
      (s[7] = M * A + x * V + b * I + L * K),
      (s[11] = M * $ + x * j + b * B + L * Y),
      (s[15] = M * E + x * re + b * W + L * te),
      this
    );
  }
  multiplyScalar(e) {
  ...
  invert() {
    const e = this.elements,
      ...
      b = u * g * c - _ * f * c + _ * a * m - o * g * m - u * a * h + o * f * h,
...
class si extends Fi {
  ...
  computeTangents() {
    ...
    const l = this.getAttribute("tangent").array,
      c = [],
      u = [];
    for (let T = 0; T < a; T++) ((c[T] = new G()), (u[T] = new G()));
    const f = new G(),
      d = new G(),
      m = new G(),
      _ = new Ze(),
    ...
    const L = new G(),
      ...
      $ = new G();
    function E(T) {
      (A.fromArray(s, T * 3), $.copy(A));
      const V = c[T];
      (L.copy(V),
        L.sub(A.multiplyScalar(A.dot(V))).normalize(),
        w.crossVectors($, V));
      const re = w.dot(u[T]) < 0 ? -1 : 1;
      ((l[T * 4] = L.x),
        (l[T * 4 + 1] = L.y),
        (l[T * 4 + 2] = L.z),
        (l[T * 4 + 3] = re));
    ...
    if (a !== null)
      if (Array.isArray(o))
        for (let _ = 0, g = d.length; _ < g; _++) {
          ...
          for (let b = M, L = x; b < L; b += 3) {
            const w = a.getX(b),
              A = a.getX(b + 1),
              $ = a.getX(b + 2);
            ((r = yr(this, h, e, i, c, u, f, w, A, $)),
              r &&
...
class tr extends si {
  constructor(e = 1, t = 1, i = 1, r = 1, s = 1, o = 1) {
    ...
    function _(g, p, h, M, x, b, L, w, A, $, E) {
      const T = b / A,
        V = L / $,
        j = b / 2,
        re = L / 2,
      ...
      for (let Y = 0; Y < $; Y++)
        for (let te = 0; te < A; te++) {
          const Q = d + te + I * Y,
            ...
            J = d + (te + 1) + I * (Y + 1),
            Z = d + (te + 1) + I * Y;
          (l.push(Q, U, Z), l.push(U, J, Z), (X += 6));
        }
      (a.addGroup(m, X, E), (m += X), (d += W));
    }
  }
  copy(e) {
    return (
...
class Js {
  ...
  setFromProjectionMatrix(e, t = yn) {
    const i = this.planes,
      ...
      b = r[15];
    if (
      (i[0].setComponents(l - s, d - c, p - m, b - h).normalize(),
      i[1].setComponents(l + s, d + c, p + m, b + h).normalize(),
      i[2].setComponents(l + o, d + u, p + _, b + M).normalize(),
      i[3].setComponents(l - o, d - u, p - _, b - M).normalize(),
      i[4].setComponents(l - a, d - f, p - g, b - x).normalize(),
      t === yn)
    )
      i[5].setComponents(l + a, d + f, p + g, b + x).normalize();
...
class kr extends si {
  constructor(e = 1, t = 1, i = 1, r = 1) {
    ...
    for (let h = 0; h < u; h++) {
      ...
      for (let x = 0; x < c; x++) {
        const b = x * f - s;
        (_.push(b, -M, 0), g.push(0, 0, 1), p.push(x / a), p.push(1 - h / l));
      }
    }
    for (let h = 0; h < l; h++)
      for (let M = 0; M < a; M++) {
...
function hp(n, e, t, i) {
  ...
  function f(P, I, B, W, X) {
    ...
    if (o) {
      ...
      (c.geometry !== W.id || c.program !== B.id || c.wireframe !== Y) &&
        ((c.geometry = W.id), (c.program = B.id), (c.wireframe = Y), (K = !0));
    }
    (X !== null && t.update(X, n.ELEMENT_ARRAY_BUFFER),
      (K || u) &&
        ((u = !1),
        $(P, I, B, W),
        X !== null && n.bindBuffer(n.ELEMENT_ARRAY_BUFFER, t.get(X).buffer)));
  }
  function d() {
  ...
  function g(P, I, B) {
    ...
    K === void 0 && ((K = {}), (X[I.id] = K));
    let Y = K[W];
    return (Y === void 0 && ((Y = p(d())), (K[W] = Y)), Y);
  }
  function p(P) {
    const I = [],
      B = [],
      W = [];
    for (let X = 0; X < r; X++) ((I[X] = 0), (B[X] = 0), (W[X] = 0));
    return {
      geometry: null,
      program: null,
      wireframe: !1,
  ...
  function M(P, I, B, W) {
    ...
    for (const Q in te)
      if (te[Q].location >= 0) {
        ...
        const Z = {};
        ((Z.attribute = J), J && J.data && (Z.data = J.data), (X[Q] = Z), Y++);
      }
    ((c.attributes = X), (c.attributesNum = Y), (c.index = W));
  }
  function x() {
  ...
  function L(P, I) {
    ...
    ((B[P] = 1),
      W[P] === 0 && (n.enableVertexAttribArray(P), (W[P] = 1)),
      X[P] !== I &&
  ...
  function A(P, I, B, W, X, K, Y) {
    Y === !0 ?
      n.vertexAttribIPointer(P, I, B, X, K)
    : n.vertexAttribPointer(P, I, B, W, X, K);
  }
  function $(P, I, B, W) {
    if (
      i.isWebGL2 === !1 &&
          ...
          if (U.isInterleavedBufferAttribute) {
            ...
            if ($e.isInstancedInterleavedBuffer) {
              ...
              P.isInstancedMesh !== !0 &&
                ...
                (W._maxInstanceCount = $e.meshPerAttribute * $e.count);
            } else
              for (let ee = 0; ee < Q.locationSize; ee++) b(Q.location + ee);
            ...
            if (U.isInstancedBufferAttribute) {
              ...
              for (let $e = 0; $e < Q.locationSize; $e++) b(Q.location + $e);
            n.bindBuffer(n.ARRAY_BUFFER, pe);
            for (let $e = 0; $e < Q.locationSize; $e++)
              A(
                Q.location + $e,
  ...
  function E() {
    ...
    for (const P in a) {
      ...
      for (const B in I) {
        const W = I[B];
        for (const X in W) (_(W[X].object), delete W[X]);
        delete I[B];
      }
      delete a[P];
    }
  ...
  ((this.uniform = l),
    ...
    (this.setState = function (f, d, m) {
      ...
      if (!r || _ === null || _.length === 0 || (s && !p)) s ? u(null) : c();
        ...
        ((l.value = b), (b = u(_, d, x, m)));
        for (let L = 0; L !== x; ++L) b[L] = t[L];
        ((h.clippingState = b),
  ...
  function u(f, d, m, _) {
    ...
    if (g !== 0) {
      if (((p = l.value), _ !== !0 || p === null)) {
        ...
        for (let x = 0, b = m; x !== g; ++x, b += 4)
          (o.copy(f[x]).applyMatrix4(M, a),
            o.normal.toArray(p, b),
            (p[b + 3] = o.constant));
      }
...
class ho {
  ...
  _halfBlur(e, t, i, r, s, o, a) {
    ...
    const b = this._sizeLods[r],
      L = 3 * b * (r > x - Ai ? r - x + Ai : 0),
      w = 4 * (this._cubeSize - b);
    (Ar(t, L, w, 3 * b, 2 * b), l.setRenderTarget(t), l.render(f, Ss));
  }
}
function _p(n) {
  const e = [],
  ...
  for (let o = 0; o < s; o++) {
    ...
    (L.setAttribute("position", new pn(M, g)),
      ...
      L.setAttribute("faceIndex", new pn(b, h)),
      e.push(L),
      r > Ai && r--);
  }
...
function Mp(n, e, t, i) {
  ...
  function c(f) {
    ...
    if (m !== null) {
      const M = m.array;
      g = m.version;
      for (let x = 0, b = M.length; x < b; x += 3) {
        const L = M[x + 0],
          w = M[x + 1],
          A = M[x + 2];
        d.push(L, w, w, A, A, L);
      ...
      const M = _.array;
      g = _.version;
      for (let x = 0, b = M.length / 3 - 1; x < b; x += 3) {
        const L = x + 0,
          w = x + 1,
          A = x + 2;
        d.push(L, w, w, A, A, L);
    ...
    if (e.isWebGL2 === !0) {
      ...
      if (p === void 0 || p.count !== g) {
        ...
        const x = u.morphAttributes.position !== void 0,
          ...
          $ = u.morphAttributes.color || [];
        let E = 0;
        (x === !0 && (E = 1), b === !0 && (E = 2), L === !0 && (E = 3));
        let T = u.attributes.position.count * E,
          V = 1;
        T > e.maxTextureSize &&
          ((V = Math.ceil(T / e.maxTextureSize)), (T = e.maxTextureSize));
        const j = new Float32Array(T * V * 4 * g),
          re = new El(j, T, V, g);
        ...
        for (let B = 0; B < g; B++) {
          const W = w[B],
            ...
            K = $[B],
            Y = T * V * 4 * B;
          for (let te = 0; te < W.count; te++) {
            const Q = te * P;
            (x === !0 &&
              (o.fromBufferAttribute(W, te),
              (j[Y + Q + 0] = o.x),
              (j[Y + Q + 1] = o.y),
              (j[Y + Q + 2] = o.z),
              (j[Y + Q + 3] = 0)),
        ...
        ((p = { count: g, texture: re, size: new Ze(T, V) }),
          s.set(u, p),
      ...
      for (let b = 0; b < 8; b++) {
        ...
        w !== Number.MAX_SAFE_INTEGER && A ?
          (p &&
            u.getAttribute("morphTarget" + b) !== p[w] &&
            u.setAttribute("morphTarget" + b, p[w]),
          h &&
            u.getAttribute("morphNormal" + b) !== h[w] &&
            u.setAttribute("morphNormal" + b, h[w]),
          (r[b] = A),
          (M += A))
        : (p &&
...
` +
    ...
    (r.deleteShader(w), r.deleteShader(A), (E = new Cr(r, p)), (T = Am(r, p)));
  }
  let E;
...
function km(n, e, t, i, r, s, o) {
  ...
  function p(E, T, V, j, re) {
    const P = j.fog,
      I = re.geometry,
      B = E.isMeshStandardMaterial ? j.environment : null,
      W = (E.isMeshStandardMaterial ? t : e).get(E.envMap || B),
      X = W && W.mapping === Br ? W.image.height : null,
      K = _[E.type];
    E.precision !== null &&
    ...
    if (K) {
      const Nt = fn[K];
      ((U = Nt.vertexShader), (J = Nt.fragmentShader));
    } else
      ((U = E.vertexShader),
        (J = E.fragmentShader),
        l.update(E),
        (Z = l.getVertexShaderID(E)),
        (ue = l.getFragmentShaderID(E)));
    const pe = n.getRenderTarget(),
      ...
      ae = E.sheen > 0,
      ye = E.transmission > 0,
      de = O && !!E.anisotropyMap,
      xe = se && !!E.clearcoatMap,
      Ce = se && !!E.clearcoatNormalMap,
      Be = se && !!E.clearcoatRoughnessMap,
      ne = ie && !!E.iridescenceMap,
      et = ie && !!E.iridescenceThicknessMap,
      We = ae && !!E.sheenColorMap,
      De = ae && !!E.sheenRoughnessMap,
      be = !!E.specularMap,
      Me = !!E.specularColorMap,
      Fe = !!E.specularIntensityMap,
      Je = ye && !!E.transmissionMap,
      mt = ye && !!E.thicknessMap,
      Ge = !!E.gradientMap,
      le = !!E.alphaMap,
      C = E.alphaTest > 0,
      he = !!E.alphaHash,
    ...
    return (
        ...
        (rt = n.toneMapping),
      {
        ...
        emissiveMap: Ue,
        normalMapObjectSpace: _e && E.normalMapType === Yu,
        normalMapTangentSpace: _e && E.normalMapType === gl,
        metalnessMap: y,
        roughnessMap: v,
        anisotropy: O,
        anisotropyMap: de,
        ...
        alphaHash: he,
        combine: E.combine,
        mapUv: ge && g(E.map.channel),
        aoMapUv: Tt && g(E.aoMap.channel),
        lightMapUv: ee && g(E.lightMap.channel),
        bumpMapUv: Se && g(E.bumpMap.channel),
        normalMapUv: _e && g(E.normalMap.channel),
        displacementMapUv: qe && g(E.displacementMap.channel),
        emissiveMapUv: Ue && g(E.emissiveMap.channel),
        ...
        iridescenceMapUv: ne && g(E.iridescenceMap.channel),
        iridescenceThicknessMapUv: et && g(E.iridescenceThicknessMap.channel),
        sheenColorMapUv: We && g(E.sheenColorMap.channel),
        sheenRoughnessMapUv: De && g(E.sheenRoughnessMap.channel),
        specularMapUv: be && g(E.specularMap.channel),
        specularColorMapUv: Me && g(E.specularColorMap.channel),
        specularIntensityMapUv: Fe && g(E.specularIntensityMap.channel),
        transmissionMapUv: Je && g(E.transmissionMap.channel),
        thicknessMapUv: mt && g(E.thicknessMap.channel),
        alphaMapUv: le && g(E.alphaMap.channel),
  ...
  function h(E) {
    ...
    if (
      (E.shaderID ?
        T.push(E.shaderID)
      : (T.push(E.customVertexShaderID), T.push(E.customFragmentShaderID)),
      E.defines !== void 0)
    )
      for (const V in E.defines) (T.push(V), T.push(E.defines[V]));
    return (
      E.isRawShaderMaterial === !1 &&
        (M(T, E), x(T, E), T.push(n.outputColorSpace)),
      T.push(E.customProgramCacheKey),
      T.join()
    );
  }
  function M(E, T) {
  ...
  function L(E, T) {
    ...
    return (V === void 0 && ((V = new Om(n, T, E, s)), c.push(V)), V);
  }
  function w(E) {
    if (--E.usedTimes === 0) {
      const T = c.indexOf(E);
  ...
  function l(u, f) {
    ...
    for (let j = 0, re = u.length; j < re; j++) {
      ...
      if (P.isAmbientLight)
        ...
        const K = t.get(P);
        if (
          (K.color.copy(P.color).multiplyScalar(P.intensity * T), P.castShadow)
        ) {
          const Y = P.shadow,
            te = i.get(P);
        ...
        (K.position.setFromMatrixPosition(P.matrixWorld),
          K.color.copy(I).multiplyScalar(B * T),
          (K.distance = W),
        ...
        const K = t.get(P);
        if (
          (K.color.copy(P.color).multiplyScalar(P.intensity * T),
        ...
        const K = t.get(P);
        (K.skyColor.copy(P.color).multiplyScalar(B * T),
          K.groundColor.copy(P.groundColor).multiplyScalar(B * T),
          (r.hemi[x] = K),
          x++);
      }
    }
    ...
    (V.directionalLength !== g ||
      ...
      (r.spotLightMatrix.length = w + A - $),
      (r.spotLightMap.length = A),
      (r.numSpotLightShadowsWithMaps = $),
      (r.numLightProbes = E),
      (V.directionalLength = g),
      (V.pointLength = p),
      (V.spotLength = h),
  ...
  function c(u, f) {
    ...
    for (let M = 0, x = u.length; M < x; M++) {
      ...
      if (b.isDirectionalLight) {
        ...
        (L.direction.setFromMatrixPosition(b.matrixWorld),
        ...
        const L = r.spot[_];
        (L.position.setFromMatrixPosition(b.matrixWorld),
        ...
        (L.position.setFromMatrixPosition(b.matrixWorld),
          ...
          o.premultiply(h),
          a.extractRotation(o),
          L.halfWidth.set(b.width * 0.5, 0, 0),
          L.halfHeight.set(0, b.height * 0.5, 0),
...
function t_(n, e, t) {
    ...
    for (let I = 0, B = w.length; I < B; I++) {
      ...
      if (
        ...
        (X.map !== null && X.map.dispose(),
          (X.map = new ni(r.x, r.y, te)),
          (X.map.texture.name = W.name + ".shadowMap"),
          X.camera.updateProjectionMatrix());
      }
      (n.setRenderTarget(X.map), n.clear());
      const Y = X.getViewportCount();
      for (let te = 0; te < Y; te++) {
        const Q = X.getViewport(te);
        (o.set(s.x * Q.x, s.y * Q.y, s.x * Q.z, s.y * Q.w),
          j.viewport(o),
          X.updateMatrices(W, te),
          (i = X.getFrustum()),
          b(A, $, X.camera, W, this.type));
      }
      (X.isPointLightShadow !== !0 && this.type === En && M(X, $),
        (X.needsUpdate = !1));
    }
    ((h = this.type), (p.needsUpdate = !1), n.setRenderTarget(E, T, V));
  };
  function M(w, A) {
    const $ = e.update(g);
    (d.defines.VSM_SAMPLES !== w.blurSamples &&
      ...
      n.clear(),
      n.renderBufferDirect(A, null, $, d, g, null),
      ...
      n.clear(),
      n.renderBufferDirect(A, null, $, m, g, null));
  }
  function x(w, A, $, E) {
    let T = null;
    const V =
      $.isPointLight === !0 ? w.customDistanceMaterial : w.customDepthMaterial;
    if (V !== void 0) T = V;
    else if (
      ((T = $.isPointLight === !0 ? l : a),
      ...
      let I = P[re];
      (I === void 0 &&
        ((I = T.clone()), (P[re] = I), A.addEventListener("dispose", L)),
        (T = I));
    }
    if (
      ((T.visible = A.visible),
      (T.wireframe = A.wireframe),
      E === En ?
        (T.side = A.shadowSide !== null ? A.shadowSide : A.side)
      : (T.side = A.shadowSide !== null ? A.shadowSide : f[A.side]),
      (T.alphaMap = A.alphaMap),
      (T.alphaTest = A.alphaTest),
      (T.map = A.map),
      (T.clipShadows = A.clipShadows),
      (T.clippingPlanes = A.clippingPlanes),
      (T.clipIntersection = A.clipIntersection),
      (T.displacementMap = A.displacementMap),
      (T.displacementScale = A.displacementScale),
      (T.displacementBias = A.displacementBias),
      (T.wireframeLinewidth = A.wireframeLinewidth),
      (T.linewidth = A.linewidth),
      $.isPointLight === !0 && T.isMeshDistanceMaterial === !0)
    ) {
      const j = n.properties.get(T);
      j.light = $;
    }
    return T;
  }
  function b(w, A, $, E, T) {
    ...
    if (
      ...
      (w.castShadow || (w.receiveShadow && T === En)) &&
      ...
      if (Array.isArray(P)) {
        ...
        for (let B = 0, W = I.length; B < W; B++) {
          ...
          if (K && K.visible) {
            const Y = x(w, K, E, T);
            (w.onBeforeShadow(n, w, A, $, re, Y, X),
              n.renderBufferDirect($, null, re, Y, w, X),
              w.onAfterShadow(n, w, A, $, re, Y, X));
          }
        }
      } else if (P.visible) {
        const I = x(w, P, E, T);
        (w.onBeforeShadow(n, w, A, $, re, I, null),
          n.renderBufferDirect($, null, re, I, w, null),
          w.onAfterShadow(n, w, A, $, re, I, null));
      }
    }
    const j = w.children;
    for (let re = 0, P = j.length; re < P; re++) b(j[re], A, $, E, T);
  }
  function L(w) {
...
function n_(n, e, t) {
  ...
  Y.indexOf("WebGL") !== -1 ?
    ((K = parseFloat(/^WebGL (\d)/.exec(Y)[1])), (X = K >= 1))
  : Y.indexOf("OpenGL ES") !== -1 &&
    ((K = parseFloat(/^OpenGL ES (\d)/.exec(Y)[1])), (X = K >= 2));
  let te = null,
    Q = {};
  const U = n.getParameter(n.SCISSOR_BOX),
    J = n.getParameter(n.VIEWPORT),
    Z = new Ct().fromArray(U),
    ue = new Ct().fromArray(J);
  ...
  function _e(C, he, fe, Le, Ae, it, rt, bt, Nt, st) {
    ...
    ((Ae = Ae || he),
      ...
      (fe !== b || Le !== L || it !== A || rt !== $) &&
        ...
        ($ = rt)),
      (bt.equals(E) === !1 || Nt !== T) &&
        (n.blendColor(bt.r, bt.g, bt.b, Nt), E.copy(bt), (T = Nt)),
      (M = C),
      (V = !1));
  }
  function qe(C, he) {
  ...
  function ie(C) {
    (C === void 0 && (C = n.TEXTURE0 + W - 1),
      te !== C && (n.activeTexture(C), (te = C)));
  }
  function ae(C, he, fe) {
    fe === void 0 && (te === null ? (fe = n.TEXTURE0 + W - 1) : (fe = te));
    let Le = Q[fe];
  ...
  function Fe(C) {
    Z.equals(C) === !1 && (n.scissor(C.x, C.y, C.z, C.w), Z.copy(C));
  }
  function Je(C) {
...
function i_(n, e, t, i, r, s, o) {
  ...
  function $(y) {
    const v = y.target;
    (v.removeEventListener("dispose", $), V(v));
  }
  function E(y) {
    const v = i.get(y);
  ...
  function J(y, v) {
    ...
    if (ae !== y.__cacheKey) {
      ...
      (ye !== void 0 &&
        (ie[y.__cacheKey].usedTimes--, ye.usedTimes === 0 && T(v)),
        (y.__cacheKey = ae),
  ...
  function Z(y, v, O) {
    ...
    if (ae.version !== ye.__version || ie === !0) {
      ...
      let De = s.convert(v.type),
        be = b(v.internalFormat, We, De, v.colorSpace, v.isVideoTexture);
      U(se, v, et);
      let Me;
      const Fe = v.mipmaps,
  ...
  function ue(y, v, O) {
    ...
    if (ie.version !== ae.__version || se === !0) {
      ...
      const et = ne[0],
        ...
        be = s.convert(v.type),
        Me = b(v.internalFormat, De, be, v.colorSpace),
  ...
  function pe(y, v, O, se, ie, ae) {
    const ye = s.convert(O.format, O.colorSpace),
      de = s.convert(O.type),
      xe = b(O.internalFormat, ye, de, O.colorSpace);
    ...
    if (
      ...
      for (let ie = 0; ie < se.length; ie++) {
        const ae = se[ie],
          ...
          xe = b(ae.internalFormat, ye, de, ae.colorSpace),
          Ce = Se(v);
        O && _e(v) === !1 ?
          n.renderbufferStorageMultisample(
            n.RENDERBUFFER,
  ...
  constructor(e, t) {
    ...
    ((this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (U) {
        let J = M[U];
        return (
          J === void 0 && ((J = new As()), (M[U] = J)),
          J.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (U) {
        let J = M[U];
        return (J === void 0 && ((J = new As()), (M[U] = J)), J.getGripSpace());
      }),
      (this.getHand = function (U) {
        let J = M[U];
        return (J === void 0 && ((J = new As()), (M[U] = J)), J.getHandSpace());
      }));
    function j(U) {
      const J = x.indexOf(U.inputSource);
      if (J === -1) return;
      const Z = M[J];
      Z !== void 0 &&
        (Z.update(U.inputSource, U.frame, c || o),
        Z.dispatchEvent({ type: U.type, data: U.inputSource }));
    }
    function re() {
      ...
      for (let U = 0; U < M.length; U++) {
        const J = x[U];
        J !== null && ((x[U] = null), M[U].disconnect(J));
      }
      ((T = null),
        (V = null),
        e.setRenderTarget(p),
    ...
    function P(U) {
      for (let J = 0; J < U.removed.length; J++) {
        const Z = U.removed[J],
          ue = x.indexOf(Z);
        ue >= 0 && ((x[ue] = null), M[ue].disconnect(Z));
      }
    ...
    function W(U, J, Z) {
      ...
      const ue = I.distanceTo(B),
        pe = J.projectionMatrix.elements,
        Ee = Z.projectionMatrix.elements,
        Re = pe[14] / (pe[10] - 1),
        ge = pe[14] / (pe[10] + 1),
        $e = (pe[9] + 1) / pe[5],
        N = (pe[9] - 1) / pe[5],
    ...
    this.updateCamera = function (U) {
      if (r === null) return;
      ((E.near = A.near = w.near = U.near),
        (E.far = A.far = w.far = U.far),
        (T !== E.near || V !== E.far) &&
      ...
      const J = U.parent,
        Z = E.cameras;
      X(E, J);
      for (let ue = 0; ue < Z.length; ue++) X(Z[ue], J);
      (Z.length === 2 ?
        W(E, w, A)
    ...
    function te(U, J) {
      if (((u = J.getViewerPose(c || o)), (_ = J), u !== null)) {
        ...
        m !== null &&
          ...
          e.setRenderTarget(h));
        let ue = !1;
        Z.length !== E.cameras.length && ((E.cameras.length = 0), (ue = !0));
        for (let pe = 0; pe < Z.length; pe++) {
          ...
          (ge === void 0 &&
            ...
            pe === 0 &&
              (E.matrix.copy(ge.matrix),
              E.matrix.decompose(E.position, E.quaternion, E.scale)),
            ue === !0 && E.cameras.push(ge));
        }
      }
      for (let Z = 0; Z < M.length; Z++) {
        const ue = x[Z],
          pe = M[Z];
        ue !== null && pe !== void 0 && pe.update(ue, J, c || o);
      }
      (Y && Y(U, J),
        J.detectedPlanes &&
...
function c_(n, e, t, i) {
  ...
  function c(M, x) {
    let b = r[M.id];
    b === void 0 &&
      (_(M), (b = u(M)), (r[M.id] = b), M.addEventListener("dispose", p));
    const L = x.program;
  ...
  function u(M) {
    ...
    return (
      ...
      n.bindBufferBase(n.UNIFORM_BUFFER, x, b),
      b
    );
  }
  function f() {
  ...
  function d(M) {
    ...
    for (let w = 0, A = b.length; w < A; w++) {
      const $ = Array.isArray(b[w]) ? b[w] : [b[w]];
        ...
        if (m(V, w, E, L) === !0) {
          ...
          for (let I = 0; I < re.length; I++) {
            ...
            typeof B == "number" || typeof B == "boolean" ?
              ((V.__data[0] = B),
              n.bufferSubData(n.UNIFORM_BUFFER, j + P, V.__data))
            : B.isMatrix3 ?
              ...
              (V.__data[11] = 0))
            : (B.toArray(V.__data, P),
              (P += W.storage / Float32Array.BYTES_PER_ELEMENT));
          }
          n.bufferSubData(n.UNIFORM_BUFFER, j, V.__data);
        }
      }
    }
    n.bindBuffer(n.UNIFORM_BUFFER, null);
  ...
  function m(M, x, b, L) {
      ...
      );
    {
      ...
      if (typeof w == "number" || typeof w == "boolean") {
        if ($ !== w) return ((L[A] = w), !0);
      } else if ($.equals(w) === !1) return ($.copy(w), !0);
    }
    return !1;
  }
  function _(M) {
    ...
    let b = 0;
    const L = 16;
    for (let A = 0, $ = x.length; A < $; A++) {
      const E = Array.isArray(x[A]) ? x[A] : [x[A]];
      for (let T = 0, V = E.length; T < V; T++) {
        const j = E[T],
    ...
    const w = b % L;
    return (w > 0 && (b += L - w), (M.__size = b), (M.__cache = {}), this);
  }
  function g(M) {
  ...
  function p(M) {
    ...
    (o.splice(b, 1), n.deleteBuffer(r[x.id]), delete r[x.id], delete s[x.id]);
  }
  function h() {
  ...
  constructor(e = {}) {
    ...
    try {
      ...
      if (
        ...
        if (
          (x.isWebGL1Renderer === !0 && D.shift(), (N = Tt(D, S)), N === null)
        )
          throw Tt(D) ?
              new Error(
    ...
    ((this.xr = Ge),
      ...
      (this.setPixelRatio = function (S) {
        S !== void 0 && ((W = S), this.setSize(I, B, !1));
      }),
      ...
      (this.setSize = function (S, D, z = !0) {
        ...
        ((I = S),
          ...
          (t.height = Math.floor(D * W)),
          z === !0 && ((t.style.width = S + "px"), (t.style.height = D + "px")),
          this.setViewport(0, 0, S, D));
      }),
      (this.getDrawingBufferSize = function (S) {
        return S.set(I * W, B * W).floor();
      }),
      ...
      (this.setViewport = function (S, D, z, k) {
        (S.isVector4 ? Y.set(S.x, S.y, S.z, S.w) : Y.set(S, D, z, k),
          _e.viewport(T.copy(Y).multiplyScalar(W).floor()));
      }),
      (this.getScissor = function (S) {
        return S.copy(te);
      }),
      (this.setScissor = function (S, D, z, k) {
        (S.isVector4 ? te.set(S.x, S.y, S.z, S.w) : te.set(S, D, z, k),
          _e.scissor(V.copy(te).multiplyScalar(W).floor()));
      }),
      (this.getScissorTest = function () {
        return Q;
      }),
      (this.setScissorTest = function (S) {
        _e.setScissorTest((Q = S));
      }),
    ...
    this.renderBufferDirect = function (S, D, z, k, F, me) {
      D === null && (D = ge);
      ...
      if (
        ...
        k.wireframe === !0 ?
          (_e.setLineWidth(k.wireframeLinewidth * $e()), pt.setMode(N.LINES))
    ...
    ((this.compile = function (S, D, z = null) {
      ...
      (this.compileAsync = function (S, D, z = null) {
        const k = this.compile(S, D, z);
        return new Promise((F) => {
          function me() {
            if (
              (k.forEach(function (Te) {
                Ue.get(Te).currentProgram.isReady() && k.delete(Te);
              }),
              k.size === 0)
            ) {
              F(S);
    ...
    (Ft.setAnimationLoop(bt),
      ...
      (this.setAnimationLoop = function (S) {
        ((rt = S), Ge.setAnimationLoop(S), S === null ? Ft.stop() : Ft.start());
      }),
      ...
      (this.render = function (S, D) {
        ...
        (S.matrixWorldAutoUpdate === !0 && S.updateMatrixWorld(),
          ...
          Ge.enabled === !0 &&
            ...
            (D = Ge.getCamera())),
          S.isScene === !0 && S.onBeforeRender(x, S, D, A),
          (p = Ce.get(S, M.length)),
          p.init(),
          M.push(p),
          ...
          g.init(),
          h.push(g),
          hn(S, D, 0, x.sortObjects),
          g.finish(),
          x.sortObjects === !0 && g.sort(X, K),
        ...
        if (
          ...
          const k = D.cameras;
          for (let F = 0, me = k.length; F < me; F++) {
            const Te = k[F];
            ea(g, S, Te, Te.viewport);
          }
        } else ea(g, S, D);
        (A !== null &&
          (y.updateMultisampleRenderTarget(A), y.updateRenderTargetMipmap(A)),
          S.isScene === !0 && S.onAfterRender(x, S, D),
    ...
    function hn(S, D, z, k) {
      ...
      if (S.layers.test(D.layers)) {
        if (S.isGroup) z = S.renderOrder;
          ...
          if (!S.frustumCulled || U.intersectsSprite(S)) {
            k && Re.setFromMatrixPosition(S.matrixWorld).applyMatrix4(pe);
            const Te = ae.update(S),
              we = S.material;
            we.visible && g.push(S, Te, we, z, Re.z, null);
          }
        } else if (
          (S.isMesh || S.isLine || S.isPoints) &&
          (!S.frustumCulled || U.intersectsObject(S))
        ) {
          const Te = ae.update(S),
            we = S.material;
          if (
            ...
            for (let ze = 0, Ie = Pe.length; ze < Ie; ze++) {
              ...
              gt && gt.visible && g.push(S, Te, gt, z, Re.z, Ne);
            }
          } else we.visible && g.push(S, Te, we, z, Re.z, null);
        }
      }
      const me = S.children;
      for (let Te = 0, we = me.length; Te < we; Te++) hn(me[Te], D, z, k);
    }
    function ea(S, D, z, k) {
      const F = S.opaque,
        me = S.transmissive,
    ...
    function Gl(S, D, z, k) {
      ...
      for (let ze = 0, Ie = D.length; ze < Ie; ze++) {
        const Ne = D[ze],
          ...
          At = Ne.material,
          _n = Ne.group;
        if (At.side === dn && gt.layers.test(k.layers)) {
          const pt = At.side;
          ((At.side = Wt),
            (At.needsUpdate = !0),
            ta(gt, z, k, Xt, At, _n),
    ...
    function ir(S, D, z) {
      ...
      const k = Ue.get(S),
        ...
        Te = F.state.version,
        we = ye.getParameters(S, F.state, me, D, z),
        Pe = ye.getProgramCacheKey(we);
      let ze = k.programs;
      ((k.environment = S.isMeshStandardMaterial ? D.environment : null),
        (k.fog = D.fog),
        (k.envMap = (S.isMeshStandardMaterial ? O : v).get(
          S.envMap || k.environment,
        )),
        ze === void 0 &&
      ...
      let Ie = ze.get(Pe);
      if (Ie !== void 0) {
        if (k.currentProgram === Ie && k.lightsStateVersion === Te)
          return (ia(S, we), Ie);
      } else
        ((we.uniforms = ye.getUniforms(S)),
          S.onBuild(z, we, x),
    ...
    function na(S) {
      if (S.uniformsList === null) {
        ...
        S.uniformsList = Cr.seqWithValue(D.seq, S.uniforms);
      }
    ...
    function kl(S, D, z, k, F) {
      (D.isScene !== !0 && (D = ge), y.resetTextureUnits());
      const me = D.fog,
        Te = k.isMeshStandardMaterial ? D.environment : null,
        we =
          A === null ? x.outputColorSpace
          : A.isXRRenderTarget === !0 ? A.texture.colorSpace
          : An,
        Pe = (k.isMeshStandardMaterial ? O : v).get(k.envMap || Te),
        ze =
          k.vertexColors === !0 &&
          !!z.attributes.color &&
          z.attributes.color.itemSize === 4,
        Ie = !!z.attributes.tangent && (!!k.normalMap || k.anisotropy > 0),
      ...
      if (
        ...
        (Pt.setValue(N, "projectionMatrix", S.projectionMatrix),
          Pt.setValue(N, "viewMatrix", S.matrixWorldInverse));
        const Jt = Pt.map.cameraPosition;
        (Jt !== void 0 &&
          Jt.setValue(N, Re.setFromMatrixPosition(S.matrixWorld)),
          ...
          (k.isMeshPhongMaterial ||
            ...
            k.isShaderMaterial) &&
            Pt.setValue(N, "isOrthographic", S.isOrthographicCamera === !0),
          E !== S && ((E = S), (Bi = !0), (Wr = !0)));
      }
      if (F.isSkinnedMesh) {
      ...
      if (
        ...
        Bi &&
          ...
          me && k.fog === !0 && de.refreshFogUniforms(Hn, me),
          de.refreshMaterialUniforms(Hn, k, W, B, ue),
          Cr.upload(N, na(ke), Hn, y)),
        k.isShaderMaterial &&
          k.uniformsNeedUpdate === !0 &&
          (Cr.upload(N, na(ke), Hn, y), (k.uniformsNeedUpdate = !1)),
        k.isSpriteMaterial && Pt.setValue(N, "center", F.center),
    ...
    ((this.getActiveCubeFace = function () {
      ...
      (this.setRenderTargetTextures = function (S, D, z) {
        ((Ue.get(S.texture).__webglTexture = D),
          (Ue.get(S.depthTexture).__webglTexture = z));
        const k = Ue.get(S);
      ...
      (this.setRenderTarget = function (S, D = 0, z = 0) {
        ...
        if (S) {
          ...
          Pe.__useDefaultFramebuffer !== void 0 ?
            (_e.bindFramebuffer(N.FRAMEBUFFER, null), (k = !1))
          : Pe.__webglFramebuffer === void 0 ? y.setupRenderTarget(S)
          : Pe.__hasExternalTextures &&
            y.rebindTextures(
              S,
              Ue.get(S.texture).__webglTexture,
              Ue.get(S.depthTexture).__webglTexture,
            );
          const ze = S.texture;
          (ze.isData3DTexture ||
          ...
          (T.copy(Y).multiplyScalar(W).floor(),
            V.copy(te).multiplyScalar(W).floor(),
            (j = Q));
        if (
      ...
      (this.readRenderTargetPixels = function (S, D, z, k, F, me, Te) {
        ...
        let we = Ue.get(S).__webglFramebuffer;
        if ((S.isWebGLCubeRenderTarget && Te !== void 0 && (we = we[Te]), we)) {
          ...
          try {
            ...
            D >= 0 &&
              ...
              z >= 0 &&
              z <= S.height - F &&
              N.readPixels(D, z, k, F, Me.convert(ze), Me.convert(Ie), me);
          } finally {
      ...
      (this.copyFramebufferToTexture = function (S, D, z = 0) {
        const k = Math.pow(2, -z),
          F = Math.floor(D.image.width * k),
          me = Math.floor(D.image.height * k);
        (y.setTexture2D(D, 0),
          N.copyTexSubImage2D(N.TEXTURE_2D, z, 0, 0, S.x, S.y, F, me),
          _e.unbindTexture());
      }),
      (this.copyTextureToTexture = function (S, D, z, k = 0) {
        ...
        (y.setTexture2D(z, 0),
          ...
          : N.texSubImage2D(N.TEXTURE_2D, k, S.x, S.y, Te, we, D.image),
          k === 0 && z.generateMipmaps && N.generateMipmap(N.TEXTURE_2D),
          _e.unbindTexture());
      }),
      (this.copyTextureToTexture3D = function (S, D, z, k, F = 0) {
        ...
        const me = S.max.x - S.min.x + 1,
          Te = S.max.y - S.min.y + 1,
          we = S.max.z - S.min.z + 1,
          Pe = Me.convert(k.format),
          ze = Me.convert(k.type);
        let Ie;
        if (k.isData3DTexture) (y.setTexture3D(k, 0), (Ie = N.TEXTURE_3D));
        else if (k.isDataArrayTexture || k.isCompressedArrayTexture)
          (y.setTexture2DArray(k, 0), (Ie = N.TEXTURE_2D_ARRAY));
        else {
          console.warn(
        ...
        (N.pixelStorei(N.UNPACK_ROW_LENGTH, pt.width),
          ...
          F === 0 && k.generateMipmaps && N.generateMipmap(Ie),
          _e.unbindTexture());
      }),
...
function v_(n, e, t) {
  ...
  function f() {
    ...
    const b = new __(16777215, 1);
    (b.position.set(0, 0, 10), o.add(b), d());
  }
  function d() {
  ...
  return {
    ...
    Zusätzlich zeigt das Activity-Log jede Aktion und die Antwort vom Backend.`),
      ...
      ((L = oe()),
        ...
        (E = oe()),
        (T = H("h3")),
        (T.textContent = "Hardware-Strategie (praxisnah)"),
        (V = oe()),
        (j = H("p")),
        (j.textContent =
      ...
      ((I = oe()),
        ...
        (W = oe()),
        (X = H("p")),
        (X.textContent = `Ja, es macht absolut Sinn, Alltags-Hardware zu unterstützen. Der beste Weg ist ein\r
    ...
    m(U, J) {
      (Ye(U, e, J),
        ...
        R(e, x),
        R(e, b));
      for (let Z = 0; Z < Y.length; Z += 1) Y[Z] && Y[Z].m(b, null);
      (R(e, L),
        R(e, w),
        R(e, A),
        R(e, $),
    ...
    p(U, [J]) {
      if (J & 1) {
        ...
        for (Z = 0; Z < K.length; Z += 1) {
          const ue = Io(U, K, Z);
          Y[Z] ? Y[Z].p(ue, J) : ((Y[Z] = No(ue)), Y[Z].c(), Y[Z].m(b, null));
        }
        for (; Z < Y.length; Z += 1) Y[Z].d(1);
        Y.length = K.length;
      }
      if (J & 2) {
        te = rn(U[1]);
        ...
        for (Z = 0; Z < te.length; Z += 1) {
          const ue = Uo(U, te, Z);
          Q[Z] ? Q[Z].p(ue, J) : ((Q[Z] = Fo(ue)), Q[Z].c(), Q[Z].m(P, null));
        }
...
function Vo(n) {
  ...
  return {
    c() {
      ((e = H("div")), r.c(), q(e, "class", "log svelte-1781vg8"));
    },
    m(s, o) {
      (Ye(s, e, o), r.m(e, null));
    },
...
function Wo(n) {
  ...
  return {
    c() {
      ((e = H("span")), (t = Ve("— ")), (r = Ve(i)), q(e, "class", "details"));
    },
    m(s, o) {
...
function Xo(n) {
  ...
  return {
    ...
    p(x, b) {
      (b & 32 && r !== (r = x[7].ts + "") && xt(s, r),
        b & 32 && c !== (c = x[7].source + "") && xt(u, c),
        b & 32 && m !== (m = x[7].action + "") && xt(_, m),
        x[7].details ?
          M ? M.p(x, b)
          : ((M = Wo(x)), M.c(), M.m(e, p))
        : M && (M.d(1), (M = null)),
  ...
  return {
    c() {
      ((e = H("div")),
        ...
        q(p, "class", (b = "badge " + Ti(n[2]) + " svelte-1781vg8")),
        q(
          w,
          "class",
          (T = "badge " + Ti(n[3] === "connected") + " svelte-1781vg8"),
        ),
    ...
    p(W, [X]) {
      (X & 1 && o !== (o = W[0] ? "−" : "+") && xt(a, o),
        X & 2 && d !== (d = W[1] ? "ONLINE" : "OFFLINE") && xt(m, d),
        X & 2 &&
          _ !== (_ = "badge " + Ti(W[1]) + " svelte-1781vg8") &&
          q(u, "class", _),
        X & 4 && M !== (M = W[2] ? "ONLINE" : "OFFLINE") && xt(x, M),
        X & 4 &&
          b !== (b = "badge " + Ti(W[2]) + " svelte-1781vg8") &&
          q(p, "class", b),
        X & 8 && $ !== ($ = W[3].toUpperCase() + "") && xt(E, $),
        X & 8 &&
          T !== (T = "badge " + Ti(W[3] === "connected") + " svelte-1781vg8") &&
          q(w, "class", T),
        W[4] ?
          I ? I.p(W, X)
          : ((I = Ho(W)), I.c(), I.m(e, j))
        ...
        W[0] ?
          B ? B.p(W, X)
          : ((B = Vo(W)), B.c(), B.m(e, null))
        : B && (B.d(1), (B = null)));
    },
    i: ve,
    o: ve,
    d(W) {
      (W && Xe(e), I && I.d(), B && B.d(), (re = !1), P());
    },
  };
}
function Ti(n) {
    ...
    ~(ue = Tt(n)) && (pe = N[ue] = $e[ue](n)),
    {
      c() {
        ...
        ((w = oe()),
          ...
          q($, "class", "svelte-qcl7nk"),
          q(T, "class", "sidebar svelte-qcl7nk"),
          q(Z, "class", "workspace svelte-qcl7nk"),
