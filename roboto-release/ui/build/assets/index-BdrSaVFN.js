  ...
  return {
    c() {
      ((e = H("div")),
        ...
        $(r, "alt", "camera stream"),
        $(r, "class", "svelte-jyl0g4"),
        $(e, "class", "panel svelte-jyl0g4"));
    },
    m(o, a) {
...
function Vc(n, e, t) {
  ...
  function c(h) {
    ...
    i.forEach((L, w) => {
      L.type === "keypoints" &&
        L.points.forEach((A, q) => {
          const S = A.x - x,
            T = A.y - b;
          S * S + T * T < jr * jr && (a = { annIndex: w, pointIndex: q });
        });
    });
  }
  function u(h) {
...
function Zc(n) {
  ...
  return {
    ...
    p(A, [q]) {
      (q & 1 && jt(o.value) !== A[0] && Qe(o, A[0]),
        q & 2 && jt(l.value) !== A[1] && Qe(l, A[1]),
        q & 4 && jt(d.value) !== A[2] && Qe(d, A[2]),
        q & 8 && jt(_.value) !== A[3] && Qe(_, A[3]),
        q & 16 && jt(M.value) !== A[4] && Qe(M, A[4]));
    },
    i: ve,
    o: ve,
    d(A) {
  ...
  return {
    c() {
      ((e = H("div")),
        ...
        (i = oe()),
        (r = H("canvas")),
        $(r, "class", "svelte-86n1hn"),
        $(e, "class", "panel svelte-86n1hn"));
    },
    m(s, o) {
      (Ye(s, e, o), R(e, t), R(e, i), R(e, r), n[1](r));
    },
    ...
    if (
      ...
      return (
        ...
        : b > L ?
          ...
          : ((r = Math.sqrt(b)), (i = w / r), (s = q / r))
        : L < 0.01 ? ((i = 0.707106781), (r = 0.707106781), (s = 0))
        : ((s = Math.sqrt(L)), (i = A / s), (r = q / s)),
        this.set(i, r, s, t),
        this
      );
    }
...
class St {
  ...
  multiplyMatrices(e, t) {
    ...
    return (
      ...
      (s[4] = o * A + a * V + l * I + c * K),
      (s[8] = o * q + a * j + l * B + c * Y),
      (s[12] = o * S + a * re + l * W + c * te),
      (s[1] = u * w + f * T + d * P + m * X),
      (s[5] = u * A + f * V + d * I + m * K),
      (s[9] = u * q + f * j + d * B + m * Y),
      (s[13] = u * S + f * re + d * W + m * te),
      (s[2] = _ * w + g * T + p * P + h * X),
      (s[6] = _ * A + g * V + p * I + h * K),
      (s[10] = _ * q + g * j + p * B + h * Y),
      (s[14] = _ * S + g * re + p * W + h * te),
      (s[3] = M * w + x * T + b * P + L * X),
      (s[7] = M * A + x * V + b * I + L * K),
      (s[11] = M * q + x * j + b * B + L * Y),
      (s[15] = M * S + x * re + b * W + L * te),
      this
    );
  }
  multiplyScalar(e) {
...
class tr extends si {
  constructor(e = 1, t = 1, i = 1, r = 1, s = 1, o = 1) {
    ...
    function _(g, p, h, M, x, b, L, w, A, q, S) {
      const T = b / A,
        V = L / q,
        j = b / 2,
        re = L / 2,
...
` +
    ...
    (r.deleteShader(w), r.deleteShader(A), (S = new Cr(r, p)), (T = Am(r, p)));
  }
  let S;
  this.getUniforms = function () {
    return (S === void 0 && q(this), S);
  };
  let T;
...
function km(n, e, t, i, r, s, o) {
  ...
  function p(S, T, V, j, re) {
    const P = j.fog,
      I = re.geometry,
      B = S.isMeshStandardMaterial ? j.environment : null,
      W = (S.isMeshStandardMaterial ? t : e).get(S.envMap || B),
  ...
  function h(S) {
    ...
    if (
      (S.shaderID ?
        T.push(S.shaderID)
      : (T.push(S.customVertexShaderID), T.push(S.customFragmentShaderID)),
      S.defines !== void 0)
    )
      for (const V in S.defines) (T.push(V), T.push(S.defines[V]));
    return (
      S.isRawShaderMaterial === !1 &&
        (M(T, S), x(T, S), T.push(n.outputColorSpace)),
  ...
  function L(S, T) {
    ...
    return (V === void 0 && ((V = new Om(n, T, S, s)), c.push(V)), V);
  }
  function w(S) {
    if (--S.usedTimes === 0) {
      const T = c.indexOf(S);
...
function jm(n, e) {
  ...
  function l(u, f) {
    ...
    (V.directionalLength !== g ||
      ...
      (r.spotLightMatrix.length = w + A - q),
    ...
    for (let I = 0, B = w.length; I < B; I++) {
      ...
      for (let te = 0; te < Y; te++) {
        ...
        (o.set(s.x * Q.x, s.y * Q.y, s.x * Q.z, s.y * Q.w),
          ...
          (i = X.getFrustum()),
          b(A, q, X.camera, W, this.type));
      }
      (X.isPointLightShadow !== !0 && this.type === En && M(X, q),
        (X.needsUpdate = !1));
    }
    ((h = this.type), (p.needsUpdate = !1), n.setRenderTarget(S, T, V));
  };
  function M(w, A) {
    const q = e.update(g);
    (d.defines.VSM_SAMPLES !== w.blurSamples &&
      ...
      n.clear(),
      n.renderBufferDirect(A, null, q, d, g, null),
      ...
      n.clear(),
      n.renderBufferDirect(A, null, q, m, g, null));
  }
  function x(w, A, q, S) {
    let T = null;
    const V =
      q.isPointLight === !0 ? w.customDistanceMaterial : w.customDepthMaterial;
    if (V !== void 0) T = V;
    else if (
      ((T = q.isPointLight === !0 ? l : a),
    ...
    if (
      ...
      q.isPointLight === !0 && T.isMeshDistanceMaterial === !0)
    ) {
    ...
    if (
      ...
      if (Array.isArray(P)) {
        ...
        for (let B = 0, W = I.length; B < W; B++) {
          ...
          if (K && K.visible) {
            const Y = x(w, K, S, T);
            (w.onBeforeShadow(n, w, A, q, re, Y, X),
              n.renderBufferDirect(q, null, re, Y, w, X),
              w.onAfterShadow(n, w, A, q, re, Y, X));
          }
        }
      } else if (P.visible) {
        const I = x(w, P, S, T);
        (w.onBeforeShadow(n, w, A, q, re, I, null),
          n.renderBufferDirect(q, null, re, I, w, null),
          w.onAfterShadow(n, w, A, q, re, I, null));
      }
    }
    const j = w.children;
    for (let re = 0, P = j.length; re < P; re++) b(j[re], A, q, S, T);
  }
  function L(w) {
  ...
  function _e(C, he, fe, Le, Ae, it, rt, bt, Nt, st) {
    ...
    ((Ae = Ae || he),
      ...
      (fe !== b || Le !== L || it !== A || rt !== q) &&
        ...
        (q = rt)),
      (bt.equals(S) === !1 || Nt !== T) &&
        (n.blendColor(bt.r, bt.g, bt.b, Nt), S.copy(bt), (T = Nt)),
      (M = C),
      (V = !1));
  }
  function qe(C, he) {
...
function i_(n, e, t, i, r, s, o) {
  ...
  function q(y) {
    const v = y.target;
    (v.removeEventListener("dispose", q), V(v));
  }
  function S(y) {
    const v = i.get(y);
    ...
    function te(U, J) {
      if (((u = J.getViewerPose(c || o)), (_ = J), u !== null)) {
        ...
        m !== null &&
          ...
          e.setRenderTarget(h));
        let ue = !1;
        Z.length !== S.cameras.length && ((S.cameras.length = 0), (ue = !0));
...
function c_(n, e, t, i) {
  ...
  function d(M) {
    ...
    for (let w = 0, A = b.length; w < A; w++) {
      const q = Array.isArray(b[w]) ? b[w] : [b[w]];
  ...
  function m(M, x, b, L) {
      ...
      );
    {
      ...
      if (typeof w == "number" || typeof w == "boolean") {
        if (q !== w) return ((L[A] = w), !0);
      } else if (q.equals(w) === !1) return (q.copy(w), !0);
    }
    return !1;
  }
  function _(M) {
    ...
    let b = 0;
    const L = 16;
    for (let A = 0, q = x.length; A < q; A++) {
      const S = Array.isArray(x[A]) ? x[A] : [x[A]];
      for (let T = 0, V = S.length; T < V; T++) {
        const j = S[T],
  ...
  constructor(e = {}) {
    ...
    ((this.xr = Ge),
      ...
      (this.setPixelRatio = function (E) {
        E !== void 0 && ((W = E), this.setSize(I, B, !1));
      }),
      ...
      (this.setViewport = function (E, D, z, k) {
        (E.isVector4 ? Y.set(E.x, E.y, E.z, E.w) : Y.set(E, D, z, k),
          _e.viewport(T.copy(Y).multiplyScalar(W).floor()));
      }),
      (this.getScissor = function (E) {
        return E.copy(te);
      }),
      (this.setScissor = function (E, D, z, k) {
        (E.isVector4 ? te.set(E.x, E.y, E.z, E.w) : te.set(E, D, z, k),
    ...
    this.renderBufferDirect = function (E, D, z, k, F, me) {
      D === null && (D = ge);
      ...
      if (E.layers.test(D.layers)) {
        if (E.isGroup) z = E.renderOrder;
          ...
          if (!E.frustumCulled || U.intersectsSprite(E)) {
            k && Re.setFromMatrixPosition(E.matrixWorld).applyMatrix4(pe);
    ...
    function ta(E, D, z, k, F, me) {
      (E.onBeforeRender(x, D, z, k, F, me),
        E.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse, E.matrixWorld),
        E.normalMatrix.getNormalMatrix(E.modelViewMatrix),
        F.onBeforeRender(x, D, z, k, E, me),
        F.transparent === !0 && F.side === dn && F.forceSinglePass === !1 ?
          ((F.side = Wt),
          (F.needsUpdate = !0),
          x.renderBufferDirect(z, D, k, F, E, me),
          (F.side = Gn),
          (F.needsUpdate = !0),
          x.renderBufferDirect(z, D, k, F, E, me),
          (F.side = dn))
        : x.renderBufferDirect(z, D, k, F, E, me),
        E.onAfterRender(x, D, z, k, F, me));
    }
    function ir(E, D, z) {
      D.isScene !== !0 && (D = ge);
      const k = Ue.get(E),
      ...
      let ze = k.programs;
      ((k.environment = E.isMeshStandardMaterial ? D.environment : null),
        (k.fog = D.fog),
    ...
    ((this.getActiveCubeFace = function () {
      ...
      (this.readRenderTargetPixels = function (E, D, z, k, F, me, Te) {
      ...
      (this.copyTextureToTexture = function (E, D, z, k = 0) {
        ...
        (y.setTexture2D(z, 0),
          ...
          : N.texSubImage2D(N.TEXTURE_2D, k, E.x, E.y, Te, we, D.image),
          k === 0 && z.generateMipmaps && N.generateMipmap(N.TEXTURE_2D),
          _e.unbindTexture());
      }),
      (this.copyTextureToTexture3D = function (E, D, z, k, F = 0) {
  ...
  return {
    c() {
      ((e = H("div")),
        ...
        (i = oe()),
        (r = H("div")),
        $(r, "class", "svelte-1qp06gq"),
        $(e, "class", "panel svelte-1qp06gq"));
    },
    m(s, o) {
      (Ye(s, e, o), R(e, t), R(e, i), R(e, r), n[1](r));
    },
  ...
  return {
    c() {
      ((e = H("article")),
        ...
        (s = oe()),
        $(t, "class", "svelte-1dhku2"),
        $(r, "class", "svelte-1dhku2"),
        $(e, "class", "svelte-1dhku2"));
    },
    m(o, a) {
...
function E_(n) {
  ...
  return {
    ...
    ohne dass die App überfordert.`),
        $(t, "class", "svelte-1dhku2"),
        $(r, "class", "svelte-1dhku2"),
        $(o, "class", "svelte-1dhku2"),
        $(l, "class", "svelte-1dhku2"),
        $(u, "class", "svelte-1dhku2"),
        $(d, "class", "svelte-1dhku2"),
        $(_, "class", "svelte-1dhku2"),
        $(p, "class", "svelte-1dhku2"),
        $(M, "class", "svelte-1dhku2"),
        $(b, "class", "svelte-1dhku2"),
        $(w, "class", "svelte-1dhku2"),
        $(q, "class", "svelte-1dhku2"),
        $(T, "class", "svelte-1dhku2"),
        $(j, "class", "svelte-1dhku2"),
        $(P, "class", "cards svelte-1dhku2"),
        $(B, "class", "svelte-1dhku2"),
        $(X, "class", "svelte-1dhku2"),
        $(e, "class", "guide svelte-1dhku2"));
    },
    m(U, J) {
      (Ye(U, e, J),
        R(e, t),
  ...
  return {
    c() {
      ((e = H("div")),
        ...
        (p.__value = "mobile"),
        Qe(p, p.__value),
        $(d, "class", "svelte-2fb5c5"),
        n[1] === void 0 && ti(() => n[5].call(d)),
        $(e, "class", "panel svelte-2fb5c5"));
    },
    m(x, b) {
      (Ye(x, e, b),
        R(e, t),
  ...
  return {
    c() {
      ((e = H("div")),
        ...
        (f = Ve(u)),
        (m = oe()),
        $(t, "class", "svelte-1mweq8t"),
        Rt(t, "selected", n[5].active),
        $(c, "class", (d = "status " + n[5].status + " svelte-1mweq8t")),
        $(e, "class", "node"),
...
function Vo(n) {
  ...
  return {
    c() {
      ((e = H("div")), r.c(), $(e, "class", "log svelte-1781vg8"));
    },
    m(s, o) {
      (Ye(s, e, o), r.m(e, null));
    },
  ...
  return {
    c() {
      ((e = H("div")),
        ...
        $(e, "class", "item muted svelte-1781vg8"));
    },
    m(t, i) {
      Ye(t, e, i);
    },
...
function Wo(n) {
  ...
  return {
    c() {
      ((e = H("span")), (t = Ve("— ")), (r = Ve(i)), $(e, "class", "details"));
    },
    m(s, o) {
  ...
  return {
    c() {
      ((e = H("div")),
        ...
        M && M.c(),
        (p = oe()),
        $(t, "class", "time svelte-1781vg8"),
        $(l, "class", "src svelte-1781vg8"),
        $(d, "class", "act"),
        $(e, "class", (h = "item " + n[7].status + " svelte-1781vg8")));
    },
    m(x, b) {
      (Ye(x, e, b),
        R(e, t),
  ...
  return {
    c() {
      ((e = H("div")),
        ...
        (j = oe()),
        B && B.c(),
        $(i, "class", "svelte-1781vg8"),
        $(s, "class", "svelte-1781vg8"),
        $(t, "class", "header svelte-1781vg8"),
        $(u, "class", (_ = "badge " + Ti(n[1]) + " svelte-1781vg8")),
        $(p, "class", (b = "badge " + Ti(n[2]) + " svelte-1781vg8")),
        $(
          w,
          "class",
          (T = "badge " + Ti(n[3] === "connected") + " svelte-1781vg8"),
        ),
        $(c, "class", "badges svelte-1781vg8"),
        $(e, "class", "panel svelte-1781vg8"));
    },
    m(W, X) {
      (Ye(W, e, X),
        R(e, t),
    ...
    p(W, [X]) {
      (X & 1 && o !== (o = W[0] ? "−" : "+") && xt(a, o),
        ...
        X & 4 &&
          ...
          $(p, "class", b),
        X & 8 && q !== (q = W[3].toUpperCase() + "") && xt(S, q),
        X & 8 &&
    ...
    ~(ue = Tt(n)) && (pe = N[ue] = $e[ue](n)),
    {
      c() {
        ((e = H("main")),
          ...
          (L = H("nav")),
          (w = H("h1")),
          (w.textContent = "Roboto Control UI"),
          (A = oe()));
        ...
        ((q = oe()),
          ...
          (Z = H("div")),
          pe && pe.c(),
          $(i, "class", "svelte-qcl7nk"),
          $(o, "class", "badge svelte-qcl7nk"),
          Rt(o, "ok", n[1]),
          Rt(o, "bad", !n[1]),
          $(f, "class", "badge svelte-qcl7nk"),
          Rt(f, "ok", n[2]),
          Rt(f, "bad", !n[2]),
          $(p, "class", "badge svelte-qcl7nk"),
          Rt(p, "ok", n[3] === "connected"),
          Rt(p, "bad", n[3] !== "connected"),
          $(s, "class", "statusbar svelte-qcl7nk"),
          $(w, "class", "svelte-qcl7nk"),
          $(L, "class", "svelte-qcl7nk"),
          $(t, "class", "topbar svelte-qcl7nk"),
          $(T, "class", "sidebar svelte-qcl7nk"),
          $(Z, "class", "workspace svelte-qcl7nk"),
          $(S, "class", "content svelte-qcl7nk"),
          $(e, "class", "app svelte-qcl7nk"));
      },
      m(ee, Se) {
        (Ye(ee, e, Se),
          R(e, t),
