...
class Et {
  ...
  multiplyMatrices(e, t) {
    ...
    return (
      ...
      (s[5] = u * A + h * V + d * F + m * j),
      (s[9] = u * N + h * Z + d * W + m * q),
      (s[13] = u * S + h * se + d * J + m * ee),
      (s[2] = _ * w + g * b + p * D + f * K),
      (s[6] = _ * A + g * V + p * F + f * j),
      (s[10] = _ * N + g * Z + p * W + f * q),
      (s[14] = _ * S + g * se + p * J + f * ee),
      (s[3] = M * w + x * b + T * D + P * K),
      (s[7] = M * A + x * V + T * F + P * j),
...
class tr extends si {
  constructor(e = 1, t = 1, i = 1, r = 1, s = 1, o = 1) {
    ...
    function _(g, p, f, M, x, T, P, w, A, N, S) {
      const b = T / A,
        V = P / N,
        Z = T / 2,
        se = P / 2,
...
function n_(n, e, t) {
  ...
  function B(C, ue, fe) {
    C ?
      ...
      (F !== ue || W !== fe) && (n.polygonOffset(ue, fe), (F = ue), (W = fe)))
...
function i_(n, e, t, i, r, s, o) {
  ...
  function me(y, v, B, ie, ne, re) {
    const Ee = s.convert(B.format, B.colorSpace),
      he = s.convert(B.type),
      _e = T(B.internalFormat, Ee, he, B.colorSpace);
    if (!i.get(v).__hasExternalTextures) {
      ...
      ne === n.TEXTURE_3D || ne === n.TEXTURE_2D_ARRAY ?
        t.texImage3D(ne, re, _e, Be, te, v.depth, 0, Ee, he, null)
      : t.texImage2D(ne, re, _e, Be, te, 0, Ee, he, null);
    }
    ...
    if (
      ...
      for (let ne = 0; ne < ie.length; ne++) {
        const re = ie[ne],
          ...
          _e = T(re.internalFormat, Ee, he, re.colorSpace),
          Re = Se(v);
        B && ve(v) === !1 ?
          n.renderbufferStorageMultisample(
            n.RENDERBUFFER,
  ...
  function L(y) {
      ...
      for (let he = 0; he < 6; he++)
        if (a && v.mipmaps && v.mipmaps.length > 0) {
          ...
          for (let _e = 0; _e < v.mipmaps.length; _e++)
            B.__webglFramebuffer[he][_e] = n.createFramebuffer();
    ...
    if (ne) {
      ...
      if (
        ...
        for (let _e = 0; _e < v.mipmaps.length; _e++)
          me(B.__webglFramebuffer[_e], y, v, n.COLOR_ATTACHMENT0, he, _e);
...
class zl {
  constructor(e = {}) {
    ...
    function fn(E, U, z, H) {
      ...
      const de = E.children;
      for (let ye = 0, we = de.length; ye < we; ye++) fn(de[ye], U, z, H);
    }
    function ea(E, U, z, H) {
      const O = E.opaque,
        de = E.transmissive,
    ...
    function Hl(E, U, z, H, O) {
      ...
      if (
        ...
        Bi &&
          ...
          de && H.fog === !0 && he.refreshFogUniforms(kn, de),
          he.refreshMaterialUniforms(kn, H, J, W, ce),
...
function Vo(n) {
  ...
  return {
    ...
    p(N, S) {
      (w === (w = P(N)) && A ?
        A.p(N, S)
      : (A.d(1), (A = w(N)), A && (A.c(), A.m(e, t))),
        S & 8 && o !== (o = N[3] ? "ONLINE" : "OFFLINE") && Mt(a, o),
        S & 8 &&
          l !== (l = "badge " + Ti(N[3]) + " svelte-1i6pt0p") &&
          X(r, "class", l),
        S & 16 && d !== (d = N[4] ? "ONLINE" : "OFFLINE") && Mt(m, d),
        S & 16 &&
          _ !== (_ = "badge " + Ti(N[4]) + " svelte-1i6pt0p") &&
          X(u, "class", _),
        S & 32 && M !== (M = N[5].toUpperCase() + "") && Mt(x, M),
        S & 32 &&
          T !== (T = "badge " + Ti(N[5] === "connected") + " svelte-1i6pt0p") &&
          X(p, "class", T));
    },
    d(N) {
      (N && Xe(e), A.d());
    ...
    ~(Y = $e(n)) && ($ = Te[Y] = Pe[Y](n)),
    {
      c() {
        ...
        ((w = ae()),
          ...
          X(P, "class", "svelte-14pwfh9"),
          X(t, "class", "topbar svelte-14pwfh9"),
          X(N, "class", "sidebar svelte-14pwfh9"),
