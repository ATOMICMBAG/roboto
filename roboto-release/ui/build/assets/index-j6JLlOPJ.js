  ...
  return {
    c() {
      ((e = W("div")),
        ...
        (i = le()),
        (r = W("img")),
        oa(r.src, (s = n[0])) || Y(r, "src", s),
        Y(r, "alt", "camera stream"),
        Y(r, "class", "svelte-kxb172"),
...
function Vc(n, e, t) {
  ...
  function c(h) {
    ...
    i.forEach((P, w) => {
      P.type === "keypoints" &&
        P.points.forEach((A, N) => {
          const S = A.x - x,
            b = A.y - T;
          S * S + b * b < jr * jr && (a = { annIndex: w, pointIndex: N });
        });
    });
  }
  function u(h) {
    ...
    (u = new Wc({})),
    {
      c() {
        ((e = W("div")),
          ...
          (c = le()),
          dt(u.$$.fragment),
          Y(t, "class", "svelte-1cq807x"),
          Y(e, "class", "vision-container svelte-1cq807x"));
      },
      m(d, m) {
        (qe(d, e, m),
          R(e, t),
    ...
    (o = new qc({})),
    {
      c() {
        ((e = W("div")),
          ...
          (s = le()),
          dt(o.$$.fragment),
          Y(e, "class", "vision-container svelte-1g74rqe"));
      },
      m(l, c) {
        (qe(l, e, c),
          ct(t, e, null),
...
function Zc(n) {
  ...
  return {
    ...
    p(A, [N]) {
      (N & 1 && jt(o.value) !== A[0] && Qe(o, A[0]),
        N & 2 && jt(l.value) !== A[1] && Qe(l, A[1]),
        N & 4 && jt(d.value) !== A[2] && Qe(d, A[2]),
        N & 8 && jt(_.value) !== A[3] && Qe(_, A[3]),
        N & 16 && jt(M.value) !== A[4] && Qe(M, A[4]));
    },
    i: pe,
    o: pe,
    d(A) {
  ...
  return {
    c() {
      ((e = W("div")),
        ...
        (i = le()),
        (r = W("canvas")),
        Y(r, "class", "svelte-1izrls"),
        Y(e, "class", "panel svelte-1izrls"));
    },
    m(s, o) {
      (qe(s, e, o), R(e, t), R(e, i), R(e, r), n[1](r));
    },
    ...
    if (
      ...
      return (
        ...
        : T > P ?
          ...
          : ((r = Math.sqrt(T)), (i = w / r), (s = N / r))
        : P < 0.01 ? ((i = 0.707106781), (r = 0.707106781), (s = 0))
        : ((s = Math.sqrt(P)), (i = A / s), (r = N / s)),
        this.set(i, r, s, t),
        this
      );
    }
...
class Et {
  ...
  multiplyMatrices(e, t) {
    ...
    return (
      ...
      (s[2] = _ * w + g * b + p * D + h * q),
      (s[6] = _ * A + g * X + p * I + h * G),
      (s[10] = _ * N + g * K + p * H + h * J),
      (s[14] = _ * S + g * re + p * j + h * $),
      (s[3] = M * w + x * b + T * D + P * q),
      (s[7] = M * A + x * X + T * I + P * G),
      (s[11] = M * N + x * K + T * H + P * J),
      (s[15] = M * S + x * re + T * j + P * $),
      this
    );
  }
...
class si extends Fi {
  ...
  computeTangents() {
    ...
    const P = new z(),
      ...
      N = new z();
    function S(b) {
      (A.fromArray(s, b * 3), N.copy(A));
      const X = c[b];
      (P.copy(X),
        P.sub(A.multiplyScalar(A.dot(X))).normalize(),
        w.crossVectors(N, X));
...
class tr extends si {
  constructor(e = 1, t = 1, i = 1, r = 1, s = 1, o = 1) {
    ...
    function _(g, p, h, M, x, T, P, w, A, N, S) {
      const b = T / A,
        X = P / N,
        K = T / 2,
        re = P / 2,
      ...
      for (let J = 0; J < N; J++)
        for (let $ = 0; $ < A; $++) {
          const ie = d + $ + I * J,
            ...
            Z = d + ($ + 1) + I * (J + 1),
            se = d + ($ + 1) + I * J;
          (l.push(ie, V, se), l.push(V, Z, se), (q += 6));
        }
      (a.addGroup(m, q, S), (m += q), (d += j));
    }
  }
  copy(e) {
    return (
...
void main() {
  ...
  fn = {
    ...
    depth: {
      uniforms: Ot([oe.common, oe.displacementmap]),
...
function hp(n, e, t, i) {
  ...
  function f(D, I, H, j, q) {
    ...
    if (o) {
      ...
      (c.geometry !== j.id || c.program !== H.id || c.wireframe !== J) &&
        ((c.geometry = j.id), (c.program = H.id), (c.wireframe = J), (G = !0));
    }
  ...
  function g(D, I, H) {
    ...
    G === void 0 && ((G = {}), (q[I.id] = G));
    let J = G[j];
    return (J === void 0 && ((J = p(d())), (G[j] = J)), J);
  }
  function p(D) {
    const I = [],
      H = [],
      j = [];
    for (let q = 0; q < r; q++) ((I[q] = 0), (H[q] = 0), (j[q] = 0));
    return {
      geometry: null,
      program: null,
      wireframe: !1,
        ...
        if (
          (se === void 0 &&
            ...
            ie === "instanceColor" &&
              D.instanceColor &&
              (se = D.instanceColor)),
          Z === void 0 || Z.attribute !== se || (se && Z.data !== se.data))
        )
          return !0;
        J++;
      }
    return c.attributesNum !== J || c.index !== j;
  }
  function M(D, I, H, j) {
    const q = {},
      G = I.attributes;
      ...
      if ($[ie].location >= 0) {
        ...
        Z === void 0 &&
          (ie === "instanceMatrix" &&
            D.instanceMatrix &&
            (Z = D.instanceMatrix),
          ie === "instanceColor" && D.instanceColor && (Z = D.instanceColor));
        const se = {};
        ((se.attribute = Z),
          Z && Z.data && (se.data = Z.data),
          (q[ie] = se),
          J++);
      }
    ((c.attributes = q), (c.attributesNum = J), (c.index = j));
  }
  function x() {
    const D = c.newAttributes;
    for (let I = 0, H = D.length; I < H; I++) D[I] = 0;
  }
  function T(D) {
    P(D, 0);
  }
  ...
  function w() {
    ...
    for (let H = 0, j = I.length; H < j; H++)
      I[H] !== D[H] && (n.disableVertexAttribArray(H), (I[H] = 0));
  }
  function A(D, I, H, j, q, G, J) {
    J === !0 ?
      n.vertexAttribIPointer(D, I, H, q, G)
    : n.vertexAttribPointer(D, I, H, j, q, G);
  }
  function N(D, I, H, j) {
    if (
      i.isWebGL2 === !1 &&
        ...
        if (
          (V === void 0 &&
            ($ === "instanceMatrix" &&
              D.instanceMatrix &&
              (V = D.instanceMatrix),
            $ === "instanceColor" && D.instanceColor && (V = D.instanceColor)),
          V !== void 0)
        ) {
          const Z = V.normalized,
            se = V.itemSize,
            fe = t.get(V);
          if (fe === void 0) continue;
          const me = fe.buffer,
            Me = fe.type,
            Pe = fe.bytesPerElement,
            Te =
              i.isWebGL2 === !0 &&
              (Me === n.INT || Me === n.UNSIGNED_INT || V.gpuType === cl);
          if (V.isInterleavedBufferAttribute) {
            const $e = V.data,
              L = $e.stride,
              Ze = V.offset;
            if ($e.isInstancedInterleavedBuffer) {
              for (let xe = 0; xe < ie.locationSize; xe++)
                P(ie.location + xe, $e.meshPerAttribute);
              D.isInstancedMesh !== !0 &&
                j._maxInstanceCount === void 0 &&
                (j._maxInstanceCount = $e.meshPerAttribute * $e.count);
            } else
              for (let xe = 0; xe < ie.locationSize; xe++) T(ie.location + xe);
            ...
            for (let xe = 0; xe < ie.locationSize; xe++)
              A(
                ...
                Z,
                L * Pe,
                (Ze + (se / ie.locationSize) * xe) * Pe,
                Te,
              );
          } else {
            if (V.isInstancedBufferAttribute) {
              for (let $e = 0; $e < ie.locationSize; $e++)
                P(ie.location + $e, V.meshPerAttribute);
              D.isInstancedMesh !== !0 &&
                j._maxInstanceCount === void 0 &&
                (j._maxInstanceCount = V.meshPerAttribute * V.count);
            } else
              for (let $e = 0; $e < ie.locationSize; $e++) T(ie.location + $e);
            n.bindBuffer(n.ARRAY_BUFFER, me);
            for (let $e = 0; $e < ie.locationSize; $e++)
              A(
                ie.location + $e,
          ...
          if (Z !== void 0)
            switch (Z.length) {
              case 2:
                n.vertexAttrib2fv(ie.location, Z);
                break;
              case 3:
                n.vertexAttrib3fv(ie.location, Z);
                break;
              case 4:
                n.vertexAttrib4fv(ie.location, Z);
                break;
              default:
                n.vertexAttrib1fv(ie.location, Z);
            }
        }
      }
    }
  ...
  function S() {
    ...
    for (const D in a) {
      ...
      for (const H in I) {
        const j = I[H];
        for (const q in j) (_(j[q].object), delete j[q]);
        delete I[H];
      }
      delete a[D];
    }
    ...
    if (e.isWebGL2 === !0) {
      ...
      if (p === void 0 || p.count !== g) {
        ...
        const x = u.morphAttributes.position !== void 0,
          ...
          N = u.morphAttributes.color || [];
        let S = 0;
        (x === !0 && (S = 1), T === !0 && (S = 2), P === !0 && (S = 3));
        let b = u.attributes.position.count * S,
          X = 1;
        b > e.maxTextureSize &&
          ((X = Math.ceil(b / e.maxTextureSize)), (b = e.maxTextureSize));
        const K = new Float32Array(b * X * 4 * g),
          re = new El(K, b, X, g);
          ...
          for (let $ = 0; $ < j.count; $++) {
            ...
            (x === !0 &&
              ...
              P === !0 &&
                ...
                (K[J + ie + 9] = o.y),
                (K[J + ie + 10] = o.z),
                (K[J + ie + 11] = G.itemSize === 4 ? o.w : 1)));
          }
        }
        ((p = { count: g, texture: re, size: new Ke(b, X) }),
          s.set(u, p),
...
` +
  ...
  return (
    (this.isReady = function () {
      return (X === !1 && (X = r.getProgramParameter(p, gm)), X);
    }),
...
function Hm(n, e, t, i, r, s, o) {
  ...
  function p(S, b, X, K, re) {
    const D = K.fog,
      I = re.geometry,
      H = S.isMeshStandardMaterial ? K.environment : null,
      j = (S.isMeshStandardMaterial ? t : e).get(S.envMap || H),
      q = j && j.mapping === Br ? j.image.height : null,
      G = _[S.type];
    S.precision !== null &&
    ...
    const J =
      ...
      $ = J !== void 0 ? J.length : 0;
    let ie = 0;
    (I.morphAttributes.position !== void 0 && (ie = 1),
      I.morphAttributes.normal !== void 0 && (ie = 2),
      I.morphAttributes.color !== void 0 && (ie = 3));
    let V, Z, se, fe;
    if (G) {
      const Nt = fn[G];
      ((V = Nt.vertexShader), (Z = Nt.fragmentShader));
    } else
      ((V = S.vertexShader),
        (Z = S.fragmentShader),
        l.update(S),
        (se = l.getVertexShaderID(S)),
        (fe = l.getFragmentShaderID(S)));
    const me = n.getRenderTarget(),
      Me = re.isInstancedMesh === !0,
      Pe = re.isBatchedMesh === !0,
      Te = !!S.map,
      $e = !!S.matcap,
      L = !!j,
      Ze = !!S.aoMap,
      ...
      _e = te && !!S.clearcoatMap,
      Re = te && !!S.clearcoatNormalMap,
      Be = te && !!S.clearcoatRoughnessMap,
      Q = ee && !!S.iridescenceMap,
      et = ee && !!S.iridescenceThicknessMap,
      We = ne && !!S.sheenColorMap,
      De = ne && !!S.sheenRoughnessMap,
      be = !!S.specularMap,
    ...
    return (
        ...
        (rt = n.toneMapping),
      {
        ...
        batching: Pe,
        instancing: Me,
        instancingColor: Me && re.instanceColor !== null,
        ...
        iridescenceMapUv: Q && g(S.iridescenceMap.channel),
        ...
        vertexTangents: !!I.attributes.tangent && (ve || O),
        ...
        vertexUv2s: Ae,
        vertexUv3s: it,
        pointsUvs: re.isPoints === !0 && !!I.attributes.uv && (Te || ae),
        fog: !!D,
        useFog: S.fog === !0,
  ...
  function h(S) {
    ...
    if (
      ...
      for (const X in S.defines) (b.push(X), b.push(S.defines[X]));
    return (
  ...
  function P(S, b) {
    ...
    return (X === void 0 && ((X = new Om(n, b, S, s)), c.push(X)), X);
  }
  function w(S) {
    if (--S.usedTimes === 0) {
      const b = c.indexOf(S);
...
function jm(n, e) {
  ...
  function l(u, f) {
    ...
    for (let K = 0, re = u.length; K < re; K++) {
      ...
      if (D.isAmbientLight)
        ((d += I.r * H * b), (m += I.g * H * b), (_ += I.b * H * b));
      else if (D.isLightProbe) {
        for (let G = 0; G < 9; G++)
          r.probe[G].addScaledVector(D.sh.coefficients[G], H);
        S++;
      } else if (D.isDirectionalLight) {
        const G = t.get(D);
        if (
          (G.color.copy(D.color).multiplyScalar(D.intensity * b), D.castShadow)
        ) {
          const J = D.shadow,
            $ = i.get(D);
          (($.shadowBias = J.bias),
        ...
        (G.position.setFromMatrixPosition(D.matrixWorld),
          G.color.copy(I).multiplyScalar(H * b),
          (G.distance = j),
        ...
        const G = t.get(D);
        (G.color.copy(I).multiplyScalar(H),
        ...
        const G = t.get(D);
        if (
          (G.color.copy(D.color).multiplyScalar(D.intensity * b),
        ...
        const G = t.get(D);
        (G.skyColor.copy(D.color).multiplyScalar(H * b),
          G.groundColor.copy(D.groundColor).multiplyScalar(H * b),
          (r.hemi[x] = G),
          x++);
      }
    }
    ...
    (X.directionalLength !== g ||
      ...
      (r.spotLightMatrix.length = w + A - N),
  ...
  this.render = function (w, A, N) {
    ...
    for (let I = 0, H = w.length; I < H; I++) {
      ...
      if (
        ...
        (r.x > u || r.y > u) &&
          (r.x > u &&
            ((s.x = Math.floor(u / G.x)),
            (r.x = s.x * G.x),
            (q.mapSize.x = s.x)),
          r.y > u &&
            ((s.y = Math.floor(u / G.y)),
            (r.y = s.y * G.y),
            (q.mapSize.y = s.y))),
        q.map === null || re === !0 || D === !0)
      ) {
        const $ = this.type !== En ? { minFilter: zt, magFilter: zt } : {};
        (q.map !== null && q.map.dispose(),
          (q.map = new ni(r.x, r.y, $)),
          (q.map.texture.name = j.name + ".shadowMap"),
          q.camera.updateProjectionMatrix());
      }
      (n.setRenderTarget(q.map), n.clear());
      const J = q.getViewportCount();
      for (let $ = 0; $ < J; $++) {
        const ie = q.getViewport($);
        (o.set(s.x * ie.x, s.y * ie.y, s.x * ie.z, s.y * ie.w),
          K.viewport(o),
          q.updateMatrices(j, $),
          (i = q.getFrustum()),
          T(A, N, q.camera, j, this.type));
      }
      (q.isPointLightShadow !== !0 && this.type === En && M(q, N),
        (q.needsUpdate = !1));
    }
    ((h = this.type), (p.needsUpdate = !1), n.setRenderTarget(S, b, X));
  };
  function M(w, A) {
    const N = e.update(g);
    (d.defines.VSM_SAMPLES !== w.blurSamples &&
      ...
      n.clear(),
      n.renderBufferDirect(A, null, N, d, g, null),
      ...
      n.clear(),
      n.renderBufferDirect(A, null, N, m, g, null));
  }
  function x(w, A, N, S) {
    let b = null;
    const X =
    ...
    if (X !== void 0) b = X;
      ...
      let I = D[re];
      (I === void 0 &&
        ((I = b.clone()), (D[re] = I), A.addEventListener("dispose", P)),
        (b = I));
    }
    if (
      ((b.visible = A.visible),
      ...
      N.isPointLight === !0 && b.isMeshDistanceMaterial === !0)
    ) {
      const K = n.properties.get(b);
      K.light = N;
    }
    return b;
  }
  function T(w, A, N, S, b) {
    ...
    if (
      ...
      if (Array.isArray(D)) {
        ...
        for (let H = 0, j = I.length; H < j; H++) {
          ...
          if (G && G.visible) {
            const J = x(w, G, S, b);
            (w.onBeforeShadow(n, w, A, N, re, J, q),
              n.renderBufferDirect(N, null, re, J, w, q),
              w.onAfterShadow(n, w, A, N, re, J, q));
          }
        }
      } else if (D.visible) {
        const I = x(w, D, S, b);
        (w.onBeforeShadow(n, w, A, N, re, I, null),
          n.renderBufferDirect(N, null, re, I, w, null),
          w.onAfterShadow(n, w, A, N, re, I, null));
      }
    }
    const K = w.children;
    for (let re = 0, D = K.length; re < D; re++) T(K[re], A, N, S, b);
  }
  function P(w) {
...
function n_(n, e, t) {
  ...
  function r() {
    ...
    return {
      setMask: function (Ae) {
        ue !== Ae && !C && (n.colorMask(Ae, Ae, Ae, Ae), (ue = Ae));
      },
      ...
      setClear: function (Ae, it, rt, bt, Nt) {
        (Nt === !0 && ((Ae *= bt), (it *= bt), (rt *= bt)),
          ce.set(Ae, it, rt, bt),
          Ce.equals(ce) === !1 && (n.clearColor(Ae, it, rt, bt), Ce.copy(ce)));
      },
      reset: function () {
        ((C = !1), (ue = null), Ce.set(-1, 0, 0, 0));
      },
    };
  }
  function s() {
  ...
  function o() {
    ...
    return {
      ...
      setMask: function (st) {
        ce !== st && !C && (n.stencilMask(st), (ce = st));
      },
      setFunc: function (st, Ft, hn) {
        (ue !== st || Ce !== Ft || Ae !== hn) &&
          (n.stencilFunc(st, Ft, hn), (ue = st), (Ce = Ft), (Ae = hn));
      },
  ...
  const V = n.getParameter(n.SCISSOR_BOX),
    ...
    se = new Ct().fromArray(V),
    fe = new Ct().fromArray(Z);
  function me(C, ce, ue, Ce) {
    ...
    for (let rt = 0; rt < ue; rt++)
      i && (C === n.TEXTURE_3D || C === n.TEXTURE_2D_ARRAY) ?
        n.texImage3D(ce, 0, n.RGBA, 1, 1, Ce, 0, n.RGBA, n.UNSIGNED_BYTE, Ae)
      : n.texImage2D(ce + rt, 0, n.RGBA, 1, 1, 0, n.RGBA, n.UNSIGNED_BYTE, Ae);
    return it;
  }
  const Me = {};
  ...
  function $e(C, ce) {
    return m[C] !== ce ?
        (n.bindFramebuffer(C, ce),
        (m[C] = ce),
        i &&
          (C === n.DRAW_FRAMEBUFFER && (m[n.FRAMEBUFFER] = ce),
          C === n.FRAMEBUFFER && (m[n.DRAW_FRAMEBUFFER] = ce)),
        !0)
      : !1;
  }
  function L(C, ce) {
    ...
    if (C)
      if (
        ...
        const Ae = C.texture;
        if (ue.length !== Ae.length || ue[0] !== n.COLOR_ATTACHMENT0) {
          for (let it = 0, rt = Ae.length; it < rt; it++)
            ue[it] = n.COLOR_ATTACHMENT0 + it;
          ((ue.length = Ae.length), (Ce = !0));
        }
      } else
        ue[0] !== n.COLOR_ATTACHMENT0 &&
          ((ue[0] = n.COLOR_ATTACHMENT0), (Ce = !0));
    else ue[0] !== n.BACK && ((ue[0] = n.BACK), (Ce = !0));
    Ce &&
      (t.isWebGL2 ?
        n.drawBuffers(ue)
  ...
  function ve(C, ce, ue, Ce, Ae, it, rt, bt, Nt, st) {
    if (C === Fn) {
      h === !0 && (Te(n.BLEND), (h = !1));
      return;
    }
    if ((h === !1 && (Pe(n.BLEND), (h = !0)), C !== au)) {
      if (C !== M || st !== X) {
        if (
          ((x !== jn || w !== jn) &&
    ...
    ((Ae = Ae || ce),
      ...
      (rt = rt || Ce),
      (ce !== x || Ae !== w) &&
        (n.blendEquationSeparate(xe[ce], xe[Ae]), (x = ce), (w = Ae)),
      (ue !== T || Ce !== P || it !== A || rt !== N) &&
        (n.blendFuncSeparate(Se[ue], Se[Ce], Se[it], Se[rt]),
        (T = ue),
        (P = Ce),
        (A = it),
        (N = rt)),
  ...
  function Oe(C) {
    K !== C && (C ? n.frontFace(n.CW) : n.frontFace(n.CCW), (K = C));
  }
  function y(C) {
    (C !== iu ?
      (Pe(n.CULL_FACE),
  ...
  function O(C, ce, ue) {
    C ?
      ...
      (I !== ce || H !== ue) && (n.polygonOffset(ce, ue), (I = ce), (H = ue)))
  ...
  function ee(C) {
    (C === void 0 && (C = n.TEXTURE0 + j - 1),
      $ !== C && (n.activeTexture(C), ($ = C)));
  }
  function ne(C, ce, ue) {
    ue === void 0 && ($ === null ? (ue = n.TEXTURE0 + j - 1) : (ue = $));
    let Ce = ie[ue];
    (Ce === void 0 && ((Ce = { type: void 0, texture: void 0 }), (ie[ue] = Ce)),
      (Ce.type !== C || Ce.texture !== ce) &&
        ($ !== ue && (n.activeTexture(ue), ($ = ue)),
        n.bindTexture(C, ce || Me[C]),
        (Ce.type = C),
        (Ce.texture = ce)));
  }
  function Ee() {
  ...
  function Je(C) {
    fe.equals(C) === !1 && (n.viewport(C.x, C.y, C.z, C.w), fe.copy(C));
  }
  function _t(C, ce) {
    let ue = f.get(ce);
    ue === void 0 && ((ue = new WeakMap()), f.set(ce, ue));
    let Ce = ue.get(C);
    Ce === void 0 && ((Ce = n.getUniformBlockIndex(ce, C.name)), ue.set(C, Ce));
  }
  function Ge(C, ce) {
    const Ce = f.get(ce).get(C);
    u.get(ce) !== Ce &&
      (n.uniformBlockBinding(ce, Ce, C.__bindingPointIndex), u.set(ce, Ce));
  }
  function ae() {
    (n.disable(n.BLEND),
...
function i_(n, e, t, i, r, s, o) {
  ...
  function g(y, v, O, te) {
    let ee = 1;
    if (
      ((y.width > te || y.height > te) &&
        (ee = te / Math.max(y.width, y.height)),
      ee < 1 || v === !0)
    )
      if (
        ...
        const ne = v ? zs : Math.floor,
          Ee = ne(ee * y.width),
          he = ne(ee * y.height);
        f === void 0 && (f = _(Ee, he));
        const _e = O ? _(Ee, he) : f;
        return (
          (_e.width = Ee),
          (_e.height = he),
  ...
  function T(y, v, O, te, ee = !1) {
    ...
    if (
      (v === n.RED &&
        (O === n.FLOAT && (ne = n.R32F),
        O === n.HALF_FLOAT && (ne = n.R16F),
        O === n.UNSIGNED_BYTE && (ne = n.R8)),
      v === n.RED_INTEGER &&
        (O === n.UNSIGNED_BYTE && (ne = n.R8UI),
        O === n.UNSIGNED_SHORT && (ne = n.R16UI),
        O === n.UNSIGNED_INT && (ne = n.R32UI),
        O === n.BYTE && (ne = n.R8I),
        O === n.SHORT && (ne = n.R16I),
        O === n.INT && (ne = n.R32I)),
      v === n.RG &&
        (O === n.FLOAT && (ne = n.RG32F),
        O === n.HALF_FLOAT && (ne = n.RG16F),
        O === n.UNSIGNED_BYTE && (ne = n.RG8)),
      v === n.RGBA)
    ) {
      const Ee = ee ? Ur : tt.getTransfer(te);
      (O === n.FLOAT && (ne = n.RGBA32F),
        O === n.HALF_FLOAT && (ne = n.RGBA16F),
        O === n.UNSIGNED_BYTE && (ne = Ee === lt ? n.SRGB8_ALPHA8 : n.RGBA8),
        O === n.UNSIGNED_SHORT_4_4_4_4 && (ne = n.RGBA4),
        O === n.UNSIGNED_SHORT_5_5_5_1 && (ne = n.RGB5_A1));
    }
    return (
      (ne === n.R16F ||
        ne === n.R32F ||
  ...
  function N(y) {
    const v = y.target;
    (v.removeEventListener("dispose", N), X(v));
  }
  function S(y) {
    const v = i.get(y);
    ...
    const O = y.source,
      te = d.get(O);
    if (te) {
      const ee = te[v.__cacheKey];
      (ee.usedTimes--,
        ee.usedTimes === 0 && b(y),
        Object.keys(te).length === 0 && d.delete(O));
    }
    i.remove(y);
  }
  function b(y) {
  ...
  function X(y) {
    ...
    if (
      ...
      for (let ee = 0; ee < 6; ee++) {
        if (Array.isArray(O.__webglFramebuffer[ee]))
          for (let ne = 0; ne < O.__webglFramebuffer[ee].length; ne++)
            n.deleteFramebuffer(O.__webglFramebuffer[ee][ne]);
        else n.deleteFramebuffer(O.__webglFramebuffer[ee]);
        O.__webglDepthbuffer && n.deleteRenderbuffer(O.__webglDepthbuffer[ee]);
      }
    else {
      if (Array.isArray(O.__webglFramebuffer))
        for (let ee = 0; ee < O.__webglFramebuffer.length; ee++)
          n.deleteFramebuffer(O.__webglFramebuffer[ee]);
      ...
      if (
        ...
        for (let ee = 0; ee < O.__webglColorRenderbuffer.length; ee++)
  ...
  function V(y, v, O) {
    if (
      (O ?
        ...
        n.texParameteri(y, n.TEXTURE_MAG_FILTER, $[v.magFilter]),
        n.texParameteri(y, n.TEXTURE_MIN_FILTER, $[v.minFilter]))
      ...
      v.compareFunction &&
        ...
        n.texParameteri(y, n.TEXTURE_COMPARE_FUNC, ie[v.compareFunction])),
  ...
  function Z(y, v) {
    ...
    if (ne !== y.__cacheKey) {
      (ee[ne] === void 0 &&
        ((ee[ne] = { texture: n.createTexture(), usedTimes: 0 }),
        o.memory.textures++,
        (O = !0)),
        ee[ne].usedTimes++);
      const Ee = ee[y.__cacheKey];
      (Ee !== void 0 &&
        (ee[y.__cacheKey].usedTimes--, Ee.usedTimes === 0 && b(v)),
        (y.__cacheKey = ne),
        (y.__webglTexture = ee[ne].texture));
    }
    return O;
  }
  function se(y, v, O) {
    ...
    ((v.isDataArrayTexture || v.isCompressedArrayTexture) &&
      ...
      v.isData3DTexture && (te = n.TEXTURE_3D));
    const ee = Z(y, v),
      ne = v.source;
    t.bindTexture(te, y.__webglTexture, n.TEXTURE0 + O);
    const Ee = i.get(ne);
    if (ne.version !== Ee.__version || ee === !0) {
      ...
      let Q = g(v.image, Be, !1, r.maxTextureSize);
      Q = Oe(v, Q);
      const et = p(Q) || a,
      ...
      if (v.isDepthTexture)
        ((be = n.DEPTH_COMPONENT),
          ...
          _t &&
            (Je ?
              t.texStorage2D(n.TEXTURE_2D, 1, be, Q.width, Q.height)
            : t.texImage2D(
                n.TEXTURE_2D,
                0,
                be,
        ...
        if (Ne.length > 0 && et) {
          ...
          for (let ae = 0, C = Ne.length; ae < C; ae++)
            ((ge = Ne[ae]),
              Je ?
                t.texSubImage2D(
                  n.TEXTURE_2D,
          ...
          Je ?
            (_t && t.texStorage2D(n.TEXTURE_2D, Ge, be, Q.width, Q.height),
            t.texSubImage2D(
              n.TEXTURE_2D,
              0,
              0,
        ...
        Je ?
          (_t &&
            t.texStorage3D(n.TEXTURE_3D, Ge, be, Q.width, Q.height, Q.depth),
          t.texSubImage3D(
            n.TEXTURE_3D,
            0,
            0,
        ...
        if (_t)
          if (Je) t.texStorage2D(n.TEXTURE_2D, Ge, be, Q.width, Q.height);
          else {
            let ae = Q.width,
              C = Q.height;
            for (let ce = 0; ce < Ge; ce++)
              (t.texImage2D(n.TEXTURE_2D, ce, be, ae, C, 0, We, De, null),
                (ae >>= 1),
                (C >>= 1));
          }
        ...
        for (let ae = 0, C = Ne.length; ae < C; ae++)
          ((ge = Ne[ae]),
            Je ?
              t.texSubImage2D(n.TEXTURE_2D, ae, 0, 0, We, De, ge)
            : t.texImage2D(n.TEXTURE_2D, ae, be, We, De, ge));
        v.generateMipmaps = !1;
      } else
        Je ?
          (_t && t.texStorage2D(n.TEXTURE_2D, Ge, be, Q.width, Q.height),
          t.texSubImage2D(n.TEXTURE_2D, 0, 0, 0, We, De, Q))
        : t.texImage2D(n.TEXTURE_2D, 0, be, We, De, Q);
      (M(v, et) && x(te),
        (Ee.__version = ne.version),
  ...
  function fe(y, v, O) {
    ...
    if (ee.version !== ne.__version || te === !0) {
      ...
      for (let ae = 0; ae < 6; ae++)
        (!Re && !Be ?
          (Q[ae] = g(v.image[ae], !1, !0, r.maxCubemapSize))
        : (Q[ae] = Be ? v.image[ae].image : v.image[ae]),
          (Q[ae] = Oe(v, Q[ae])));
      const et = Q[0],
        We = p(et) || a,
        ...
        Je = ne.__version === void 0 || te === !0;
      let _t = P(v, et, We);
      V(n.TEXTURE_CUBE_MAP, v, We);
      let Ge;
      if (Re) {
        Ne &&
          Je &&
  ...
  function me(y, v, O, te, ee, ne) {
    const Ee = s.convert(O.format, O.colorSpace),
      he = s.convert(O.type),
      _e = T(O.internalFormat, Ee, he, O.colorSpace);
    if (!i.get(v).__hasExternalTextures) {
      const Be = Math.max(1, v.width >> ne),
        Q = Math.max(1, v.height >> ne);
      ee === n.TEXTURE_3D || ee === n.TEXTURE_2D_ARRAY ?
        t.texImage3D(ee, ne, _e, Be, Q, v.depth, 0, Ee, he, null)
      : t.texImage2D(ee, ne, _e, Be, Q, 0, Ee, he, null);
    }
  ...
  function Me(y, v, O) {
    if (
      ...
      let te = a === !0 ? n.DEPTH_COMPONENT24 : n.DEPTH_COMPONENT16;
      if (O || ve(v)) {
        ...
        ee &&
          ...
          : ee.type === In && (te = n.DEPTH_COMPONENT24));
        const ne = Se(v);
        ve(v) ?
      ...
      } else n.renderbufferStorage(n.RENDERBUFFER, te, v.width, v.height);
      ...
      for (let ee = 0; ee < te.length; ee++) {
        const ne = te[ee],
          Ee = s.convert(ne.format, ne.colorSpace),
          he = s.convert(ne.type),
          _e = T(ne.internalFormat, Ee, he, ne.colorSpace),
          Re = Se(v);
        O && ve(v) === !1 ?
          n.renderbufferStorageMultisample(
            n.RENDERBUFFER,
  ...
  function Pe(y, v) {
    ...
    ((!i.get(v.depthTexture).__webglTexture ||
      ...
      H(v.depthTexture, 0));
    const te = i.get(v.depthTexture).__webglTexture,
      ee = Se(v);
  ...
  function Te(y) {
    ...
    if (y.depthTexture && !v.__autoAllocateDepthBuffer) {
      ...
      for (let te = 0; te < 6; te++)
        (t.bindFramebuffer(n.FRAMEBUFFER, v.__webglFramebuffer[te]),
          (v.__webglDepthbuffer[te] = n.createRenderbuffer()),
          Me(v.__webglDepthbuffer[te], y, !1));
    } else
  ...
  function L(y) {
    const v = y.texture,
      O = i.get(y),
      te = i.get(v);
    (y.addEventListener("dispose", N),
      y.isWebGLMultipleRenderTargets !== !0 &&
        (te.__webglTexture === void 0 &&
          (te.__webglTexture = n.createTexture()),
    ...
    if (ee) {
      (t.bindTexture(n.TEXTURE_CUBE_MAP, te.__webglTexture),
        V(n.TEXTURE_CUBE_MAP, v, Ee));
      for (let he = 0; he < 6; he++)
        if (a && v.mipmaps && v.mipmaps.length > 0)
          for (let _e = 0; _e < v.mipmaps.length; _e++)
            me(
      ...
      for (let _e = 0, Re = he.length; _e < Re; _e++) {
        const Be = he[_e],
          Q = i.get(Be);
        (t.bindTexture(n.TEXTURE_2D, Q.__webglTexture),
          V(n.TEXTURE_2D, Be, Ee),
          me(
            O.__webglFramebuffer,
            y,
            Be,
      ...
      if (
        ...
        t.bindTexture(he, te.__webglTexture),
        V(he, v, Ee),
  ...
  function xe(y) {
    if (a && y.samples > 0 && ve(y) === !1) {
      ...
      for (let Re = 0; Re < v.length; Re++) {
        (ne.push(n.COLOR_ATTACHMENT0 + Re), y.depthBuffer && ne.push(Ee));
        const Be =
          he.__ignoreDepthValues !== void 0 ? he.__ignoreDepthValues : !1;
        if (
          (Be === !1 &&
            (y.depthBuffer && (ee |= n.DEPTH_BUFFER_BIT),
            y.stencilBuffer && (ee |= n.STENCIL_BUFFER_BIT)),
          _e &&
            n.framebufferRenderbuffer(
              n.READ_FRAMEBUFFER,
              n.COLOR_ATTACHMENT0,
          ...
          const Q = i.get(v[Re]).__webglTexture;
          n.framebufferTexture2D(
            n.DRAW_FRAMEBUFFER,
            n.COLOR_ATTACHMENT0,
            n.TEXTURE_2D,
        ...
        (n.blitFramebuffer(0, 0, O, te, 0, 0, O, te, ee, n.NEAREST),
          c && n.invalidateFramebuffer(n.READ_FRAMEBUFFER, ne));
      }
      if (
  ...
  constructor(e, t) {
    ...
    ((this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (V) {
        let Z = M[V];
        return (
          Z === void 0 && ((Z = new As()), (M[V] = Z)),
          Z.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (V) {
        let Z = M[V];
        return (Z === void 0 && ((Z = new As()), (M[V] = Z)), Z.getGripSpace());
      }),
      (this.getHand = function (V) {
        let Z = M[V];
        return (Z === void 0 && ((Z = new As()), (M[V] = Z)), Z.getHandSpace());
      }));
    function K(V) {
      const Z = x.indexOf(V.inputSource);
      if (Z === -1) return;
      const se = M[Z];
      se !== void 0 &&
        (se.update(V.inputSource, V.frame, c || o),
        se.dispatchEvent({ type: V.type, data: V.inputSource }));
    }
    function re() {
      ...
      for (let V = 0; V < M.length; V++) {
        const Z = x[V];
        Z !== null && ((x[V] = null), M[V].disconnect(Z));
      }
      ((b = null),
        (X = null),
        e.setRenderTarget(p),
        ...
        if (((r = V), r !== null)) {
          if (
            ...
            let Z = null,
              ...
              fe = null;
            g.depth &&
              ((fe = g.stencil ? t.DEPTH24_STENCIL8 : t.DEPTH_COMPONENT24),
              (Z = g.stencil ? Ii : Qn),
              (se = g.stencil ? Jn : In));
            const me = {
              colorFormat: t.RGBA8,
    ...
    function D(V) {
      for (let Z = 0; Z < V.removed.length; Z++) {
        const se = V.removed[Z],
          fe = x.indexOf(se);
        fe >= 0 && ((x[fe] = null), M[fe].disconnect(se));
      }
    ...
    function j(V, Z, se) {
      ...
      const fe = I.distanceTo(H),
        me = Z.projectionMatrix.elements,
        ...
        pt = fe / (-Ze + xe),
        Oe = pt * -Ze;
      (Z.matrixWorld.decompose(V.position, V.quaternion, V.scale),
        V.translateX(Oe),
        V.translateZ(pt),
      ...
      const y = Pe + pt,
        ...
        ee = (($e * Te) / v) * y,
        ne = ((L * Te) / v) * y;
      (V.projectionMatrix.makePerspective(O, te, ee, ne, y, v),
        V.projectionMatrixInverse.copy(V.projectionMatrix).invert());
    }
    function q(V, Z) {
      (Z === null ?
        V.matrixWorld.copy(V.matrix)
      : V.matrixWorld.multiplyMatrices(Z.matrixWorld, V.matrix),
        V.matrixWorldInverse.copy(V.matrixWorld).invert());
    }
    this.updateCamera = function (V) {
      if (r === null) return;
      ((S.near = A.near = w.near = V.near),
        (S.far = A.far = w.far = V.far),
        (b !== S.near || X !== S.far) &&
      ...
      const Z = V.parent,
        se = S.cameras;
      q(S, Z);
      for (let fe = 0; fe < se.length; fe++) q(se[fe], Z);
      (se.length === 2 ?
        j(S, w, A)
    ...
    function G(V, Z, se) {
      (se === null ?
        V.matrix.copy(Z.matrixWorld)
      : (V.matrix.copy(se.matrixWorld),
        V.matrix.invert(),
        V.matrix.multiply(Z.matrixWorld)),
        V.matrix.decompose(V.position, V.quaternion, V.scale),
        V.updateMatrixWorld(!0),
        V.projectionMatrix.copy(Z.projectionMatrix),
        V.projectionMatrixInverse.copy(Z.projectionMatrixInverse),
        V.isPerspectiveCamera &&
          ((V.fov = Bs * 2 * Math.atan(1 / V.projectionMatrix.elements[5])),
          (V.zoom = 1)));
    }
    ...
    function $(V, Z) {
      if (((u = Z.getViewerPose(c || o)), (_ = Z), u !== null)) {
        ...
        m !== null &&
          ...
          e.setRenderTarget(h));
        let fe = !1;
        se.length !== S.cameras.length && ((S.cameras.length = 0), (fe = !0));
        for (let me = 0; me < se.length; me++) {
          const Me = se[me];
          let Pe = null;
          if (m !== null) Pe = m.getViewport(Me);
          else {
            const $e = f.getViewSubImage(d, Me);
            ((Pe = $e.viewport),
              me === 0 &&
          ...
          (Te === void 0 &&
            ...
            fe === !0 && S.cameras.push(Te));
        }
      }
      for (let se = 0; se < M.length; se++) {
        const fe = x[se],
          me = M[se];
        fe !== null && me !== void 0 && me.update(fe, Z, c || o);
      }
      (J && J(V, Z),
        Z.detectedPlanes &&
...
function c_(n, e, t, i) {
  ...
  function d(M) {
    ...
    for (let w = 0, A = T.length; w < A; w++) {
      const N = Array.isArray(T[w]) ? T[w] : [T[w]];
        ...
        if (m(X, w, S, P) === !0) {
          ...
          for (let I = 0; I < re.length; I++) {
            ...
            typeof H == "number" || typeof H == "boolean" ?
              ((X.__data[0] = H),
              n.bufferSubData(n.UNIFORM_BUFFER, K + D, X.__data))
            : H.isMatrix3 ?
              ((X.__data[0] = H.elements[0]),
              (X.__data[1] = H.elements[1]),
              (X.__data[2] = H.elements[2]),
              (X.__data[3] = 0),
              (X.__data[4] = H.elements[3]),
              (X.__data[5] = H.elements[4]),
              (X.__data[6] = H.elements[5]),
              (X.__data[7] = 0),
              (X.__data[8] = H.elements[6]),
              (X.__data[9] = H.elements[7]),
              (X.__data[10] = H.elements[8]),
              (X.__data[11] = 0))
            : (H.toArray(X.__data, D),
              (D += j.storage / Float32Array.BYTES_PER_ELEMENT));
          }
          n.bufferSubData(n.UNIFORM_BUFFER, K, X.__data);
        }
      }
    }
    n.bindBuffer(n.UNIFORM_BUFFER, null);
  ...
  function _(M) {
    ...
    for (let A = 0, N = x.length; A < N; A++) {
      ...
      for (let b = 0, X = S.length; b < X; b++) {
        const K = S[b],
          re = Array.isArray(K.value) ? K.value : [K.value];
        for (let D = 0, I = re.length; D < I; D++) {
          const H = re[D],
            j = g(H),
            q = T % P;
          (q !== 0 && P - q < j.boundary && (T += P - q),
  ...
  constructor(e = {}) {
    ...
    function _t() {
      ((xe = new xp(L)),
        ...
        (O = new vp(x)),
        (te = new Ch(L, Se)),
        (Ne = new hp(L, xe, te, Se)),
        (ee = new Mp(L, te, pt, Ne)),
        (ne = new Ap(L, ee, te, pt)),
        (We = new bp(L, Se, y)),
        (Be = new pp(Oe)),
        ...
        (_e = new Wm()),
        (Re = new Km(xe, Se)),
        (et = new up(x, v, O, ve, ne, d, l)),
        (Q = new t_(x, ne, Se)),
        (Je = new c_(L, pt, Se, ve)),
        (De = new fp(L, xe, pt, Se)),
    ...
    ((this.xr = Ge),
      ...
      (this.setPixelRatio = function (E) {
        E !== void 0 && ((j = E), this.setSize(I, H, !1));
      }),
      ...
      (this.setViewport = function (E, U, B, k) {
        (E.isVector4 ? J.set(E.x, E.y, E.z, E.w) : J.set(E, U, B, k),
          ve.viewport(b.copy(J).multiplyScalar(j).floor()));
      }),
      (this.getScissor = function (E) {
        return E.copy($);
      }),
      (this.setScissor = function (E, U, B, k) {
        (E.isVector4 ? $.set(E.x, E.y, E.z, E.w) : $.set(E, U, B, k),
          ve.scissor(X.copy($).multiplyScalar(j).floor()));
      }),
      (this.getScissorTest = function () {
        return ie;
      }),
      (this.setScissorTest = function (E) {
        ve.setScissorTest((ie = E));
      }),
    ...
    function ue(E) {
      const U = E.target;
      (U.removeEventListener("dispose", ue), Ce(U));
    }
    function Ce(E) {
      (Ae(E), Oe.remove(E));
    }
    ...
    this.renderBufferDirect = function (E, U, B, k, F, de) {
      U === null && (U = Te);
      ...
      let Le = B.index,
        ze = 1;
      if (k.wireframe === !0) {
        if (((Le = ee.getWireframeAttribute(B)), Le === void 0)) return;
        ze = 2;
      }
      ...
      Ne.setup(F, k, we, B, Le);
      let _n,
        mt = De;
      if (
        (Le !== null && ((_n = te.get(Le)), (mt = be), mt.setIndex(_n)),
        F.isMesh)
      )
        k.wireframe === !0 ?
      ...
      if (E.layers.test(U.layers)) {
        if (E.isGroup) B = E.renderOrder;
          ...
          if (!E.frustumCulled || V.intersectsSprite(E)) {
            ...
            const ye = ne.update(E),
              we = E.material;
            we.visible && g.push(E, ye, we, B, Pe.z, null);
          }
        } else if (
          ...
          if (
            ...
            for (let ze = 0, Ue = Le.length; ze < Ue; ze++) {
              ...
              vt && vt.visible && g.push(E, ye, vt, B, Pe.z, Ie);
            }
          } else we.visible && g.push(E, ye, we, B, Pe.z, null);
        }
      }
      const de = E.children;
      for (let ye = 0, we = de.length; ye < we; ye++) hn(de[ye], U, B, k);
    }
    function ea(E, U, B, k) {
      const F = E.opaque,
        de = E.transmissive,
        ye = E.transparent;
      (p.setupLightsView(B),
        Z === !0 && Be.setGlobalState(x.clippingPlanes, B),
    ...
    function Gl(E, U, B, k) {
      ...
      (fe === null &&
        ...
        de ? fe.setSize(Me.x, Me.y) : fe.setSize(zs(Me.x), zs(Me.y)));
      const ye = x.getRenderTarget();
      (x.setRenderTarget(fe),
        x.getClearColor(re),
        (D = x.getClearAlpha()),
      ...
      ((x.toneMapping = On),
        nr(E, B, k),
        y.updateMultisampleRenderTarget(fe),
        y.updateRenderTargetMipmap(fe));
      let Le = !1;
      ...
      (Le === !0 &&
        (y.updateMultisampleRenderTarget(fe), y.updateRenderTargetMipmap(fe)),
        x.setRenderTarget(ye),
        x.setClearColor(re, D),
        (x.toneMapping = we));
    }
    function nr(E, U, B) {
    ...
    function ta(E, U, B, k, F, de) {
      (E.onBeforeRender(x, U, B, k, F, de),
        E.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse, E.matrixWorld),
        E.normalMatrix.getNormalMatrix(E.modelViewMatrix),
        F.onBeforeRender(x, U, B, k, E, de),
        F.transparent === !0 && F.side === dn && F.forceSinglePass === !1 ?
          ((F.side = Wt),
          (F.needsUpdate = !0),
          x.renderBufferDirect(B, U, k, F, E, de),
          (F.side = Gn),
          (F.needsUpdate = !0),
          x.renderBufferDirect(B, U, k, F, E, de),
          (F.side = dn))
        : x.renderBufferDirect(B, U, k, F, E, de),
        E.onAfterRender(x, U, B, k, F, de));
    }
    function ir(E, U, B) {
      U.isScene !== !0 && (U = Te);
      const k = Oe.get(E),
        ...
        ye = F.state.version,
        we = Ee.getParameters(E, F.state, de, U, B),
    ...
    function Hl(E, U, B, k, F) {
      ...
      const de = U.fog,
        ...
        Ue = !!B.attributes.tangent && (!!k.normalMap || k.anisotropy > 0),
      ...
      if (
        ...
        Bi &&
          ...
          he.refreshMaterialUniforms(kn, k, j, H, fe),
    ...
    ((this.getActiveCubeFace = function () {
      ...
      (this.setRenderTargetTextures = function (E, U, B) {
        ...
        ((k.__hasExternalTextures = !0),
          k.__hasExternalTextures &&
            ((k.__autoAllocateDepthBuffer = B === void 0),
      ...
      (this.setRenderTarget = function (E, U = 0, B = 0) {
        ...
        if (E) {
          ...
          (b.copy(J).multiplyScalar(j).floor(),
      ...
      (this.readRenderTargetPixels = function (E, U, B, k, F, de, ye) {
        ...
        if ((E.isWebGLCubeRenderTarget && ye !== void 0 && (we = we[ye]), we)) {
          ...
          try {
            ...
            U >= 0 &&
              ...
              B >= 0 &&
              B <= E.height - F &&
              L.readPixels(U, B, k, F, ge.convert(ze), ge.convert(Ue), de);
          } finally {
      ...
      (this.copyFramebufferToTexture = function (E, U, B = 0) {
        ...
        (y.setTexture2D(U, 0),
          L.copyTexSubImage2D(L.TEXTURE_2D, B, 0, 0, E.x, E.y, F, de),
          ve.unbindTexture());
      }),
      (this.copyTextureToTexture = function (E, U, B, k = 0) {
        const F = U.image.width,
          de = U.image.height,
          ye = ge.convert(B.format),
          we = ge.convert(B.type);
        (y.setTexture2D(B, 0),
          ...
          k === 0 && B.generateMipmaps && L.generateMipmap(L.TEXTURE_2D),
          ve.unbindTexture());
      }),
      (this.copyTextureToTexture3D = function (E, U, B, k, F = 0) {
  ...
  return {
    c() {
      ((e = W("div")),
        ...
        (i = le()),
        (r = W("div")),
        Y(r, "class", "canvas svelte-1aodxn9"),
        Y(e, "class", "panel svelte-1aodxn9"));
    },
    m(s, o) {
      (qe(s, e, o), R(e, t), R(e, i), R(e, r), n[1](r));
    },
  ...
  return {
    c() {
      ((e = W("article")),
        ...
        (s = le()),
        Y(t, "class", "svelte-y0nt3a"),
        Y(r, "class", "svelte-y0nt3a"),
        Y(e, "class", "svelte-y0nt3a"));
    },
    m(o, a) {
...
function E_(n) {
  let e,
    ...
    I = rn(n[0]),
    H = [];
  for (let G = 0; G < I.length; G += 1) H[G] = No(Io(n, I, G));
  let j = rn(n[1]),
    q = [];
  for (let G = 0; G < j.length; G += 1) q[G] = Fo(Uo(n, j, G));
  return {
    c() {
      ((e = W("section")),
        (t = W("h2")),
        (t.textContent = "Roboto Control UI"),
        (i = le()),
        (r = W("p")),
        (r.textContent = `Roboto Control verbindet Vision, Motion-Control und Sensorik in einer gemeinsamen Oberfläche.\r
    ...
    für Hardware (z. B. Motoren, Raster-Scan, Mobile Controller) genutzt werden.`),
        (s = le()),
        (o = W("h3")),
        (o.textContent = "Tabs im Überblick"),
        (a = le()),
        (l = W("ul")),
        (l.innerHTML =
        ...
        (c = le()),
        (u = W("h3")),
        (u.textContent = "System Status (wichtig)"),
        (f = le()),
        (d = W("p")),
        (d.textContent = `Im linken Bereich zeigt die App live den Zustand von Backend, Frontend und WebSocket.\r
    Zusätzlich zeigt das Activity-Log jede Aktion und die Antwort vom Backend.`),
        (m = le()),
        (_ = W("h3")),
        (_.textContent = "Quickstart (für Nutzer)"),
        (g = le()),
        (p = W("ol")));
      for (let G = 0; G < H.length; G += 1) H[G].c();
      ((h = le()),
        (M = W("h3")),
        (M.textContent = "Fehler lesen & verstehen"),
        (x = le()),
        (T = W("ul")),
        (T.innerHTML =
        ...
        (P = le()),
        (w = W("h3")),
        (w.textContent = "Hardware-Strategie (praxisnah)"),
        (A = le()),
        (N = W("p")),
        (N.textContent =
      ...
      ((X = le()),
        (K = W("h3")),
        (K.textContent = "Capability-Ansatz:"),
        (re = le()),
        (D = W("p")),
        (D.textContent = `Funktionen dynamisch aktivieren, je nachdem welche Hardware erkannt\r
    ...
    ohne dass die App überfordert.`),
        Y(t, "class", "svelte-y0nt3a"),
        Y(r, "class", "svelte-y0nt3a"),
        Y(o, "class", "svelte-y0nt3a"),
        Y(l, "class", "svelte-y0nt3a"),
        Y(u, "class", "svelte-y0nt3a"),
        Y(d, "class", "svelte-y0nt3a"),
        Y(_, "class", "svelte-y0nt3a"),
        Y(p, "class", "svelte-y0nt3a"),
        Y(M, "class", "svelte-y0nt3a"),
        Y(T, "class", "svelte-y0nt3a"),
        Y(w, "class", "svelte-y0nt3a"),
        Y(N, "class", "svelte-y0nt3a"),
        Y(b, "class", "cards svelte-y0nt3a"),
        Y(K, "class", "svelte-y0nt3a"),
        Y(D, "class", "svelte-y0nt3a"),
        Y(e, "class", "guide svelte-y0nt3a"));
    },
    m(G, J) {
      (qe(G, e, J),
        R(e, t),
        ...
        R(e, g),
        R(e, p));
      for (let $ = 0; $ < H.length; $ += 1) H[$] && H[$].m(p, null);
      (R(e, h),
        R(e, M),
        R(e, x),
        R(e, T),
        ...
        R(e, S),
        R(e, b));
      for (let $ = 0; $ < q.length; $ += 1) q[$] && q[$].m(b, null);
      (R(e, X), R(e, K), R(e, re), R(e, D));
    },
    p(G, [J]) {
      if (J & 1) {
        I = rn(G[0]);
        ...
        for ($ = 0; $ < I.length; $ += 1) {
          const ie = Io(G, I, $);
          H[$] ? H[$].p(ie, J) : ((H[$] = No(ie)), H[$].c(), H[$].m(p, null));
        }
        for (; $ < H.length; $ += 1) H[$].d(1);
        H.length = I.length;
      }
      if (J & 2) {
        j = rn(G[1]);
        ...
        for ($ = 0; $ < j.length; $ += 1) {
          const ie = Uo(G, j, $);
          q[$] ? q[$].p(ie, J) : ((q[$] = Fo(ie)), q[$].c(), q[$].m(b, null));
        }
  ...
  return {
    c() {
      ((e = W("div")),
        ...
        (a.__value = "pose"),
        Qe(a, a.__value),
        Y(r, "class", "svelte-r2nhty"),
        n[0] === void 0 && ti(() => n[2].call(r)),
        Y(e, "class", "panel svelte-r2nhty"));
    },
    m(u, f) {
      (qe(u, e, f),
        R(e, t),
  ...
  return {
    c() {
      ((e = W("div")),
        ...
        (f = Ve(u)),
        (m = le()),
        Y(t, "class", "svelte-z2n7q3"),
        Rt(t, "selected", n[5].active),
        Y(c, "class", (d = "status " + n[5].status + " svelte-z2n7q3")),
        Y(e, "class", "node"),
  ...
  return {
    c() {
      ((e = W("div")),
        ...
        Y(t, "class", "svelte-16qoqwn"),
        Y(r, "class", "svelte-16qoqwn"),
        Y(e, "class", "recorder svelte-16qoqwn"));
    },
    m(a, l) {
      (qe(a, e, l),
        R(e, t),
...
function ko(n) {
  ...
  return {
    c() {
      ((e = W("div")),
        (t = Ve("Letzter Vision Backend Fehler: ")),
        (i = Ve(n[1])),
        Y(e, "class", "error svelte-pv954r"));
    },
    m(r, s) {
  ...
  return {
    c() {
      ((e = W("div")),
        ...
        (T = le()),
        A.c(),
        Y(i, "class", (a = "badge " + Ti(n[2]) + " svelte-pv954r")),
        Y(c, "class", (m = "badge " + Ti(n[3]) + " svelte-pv954r")),
        Y(
          g,
          "class",
          (x = "badge " + Ti(n[4] === "connected") + " svelte-pv954r"),
        ),
        Y(t, "class", "badges svelte-pv954r"),
        Y(e, "class", "log svelte-pv954r"));
    },
    m(N, S) {
      (qe(N, e, S),
        R(e, t),
    ...
    p(N, S) {
      (S & 4 && s !== (s = N[2] ? "ONLINE" : "OFFLINE") && Mt(o, s),
        S & 4 &&
          a !== (a = "badge " + Ti(N[2]) + " svelte-pv954r") &&
          Y(i, "class", a),
        S & 8 && f !== (f = N[3] ? "ONLINE" : "OFFLINE") && Mt(d, f),
        S & 8 &&
          m !== (m = "badge " + Ti(N[3]) + " svelte-pv954r") &&
          Y(c, "class", m),
        S & 16 && h !== (h = N[4].toUpperCase() + "") && Mt(M, h),
        S & 16 &&
          x !== (x = "badge " + Ti(N[4] === "connected") + " svelte-pv954r") &&
          Y(g, "class", x),
        w === (w = P(N)) && A ?
          A.p(N, S)
        : (A.d(1), (A = w(N)), A && (A.c(), A.m(e, null))));
    },
    d(N) {
      (N && Xe(e), A.d());
    },
  ...
  return {
    c() {
      ((e = W("div")),
        ...
        Y(e, "class", "item muted svelte-pv954r"));
    },
    m(t, i) {
      qe(t, e, i);
    },
...
function Wo(n) {
  ...
  return {
    c() {
      ((e = W("span")), (t = Ve("— ")), (r = Ve(i)), Y(e, "class", "details"));
    },
    m(s, o) {
  ...
  return {
    c() {
      ((e = W("div")),
        ...
        M && M.c(),
        (p = le()),
        Y(t, "class", "time svelte-pv954r"),
        Y(l, "class", "src svelte-pv954r"),
        Y(d, "class", "act"),
        Y(e, "class", (h = "item " + n[7].status + " svelte-pv954r")));
    },
    m(x, T) {
      (qe(x, e, T),
        R(e, t),
  ...
  return {
    c() {
      ((e = W("div")),
        ...
        (c = le()),
        m && m.c(),
        Y(i, "class", "svelte-pv954r"),
        Y(s, "class", "svelte-pv954r"),
        Y(t, "class", "header svelte-pv954r"),
        Y(e, "class", "panel svelte-pv954r"));
    },
    m(_, g) {
      (qe(_, e, g),
        R(e, t),
    ...
    ~(Z = $e(n)) && (se = Te[Z] = Pe[Z](n)),
    {
      c() {
        ...
        ((w = le()),
          ...
          (V = W("div")),
          se && se.c(),
          Y(i, "class", "svelte-h517e4"),
          Y(o, "class", "badge svelte-h517e4"),
          Rt(o, "ok", n[1]),
          Rt(o, "bad", !n[1]),
          Y(f, "class", "badge svelte-h517e4"),
          Rt(f, "ok", n[2]),
          Rt(f, "bad", !n[2]),
          Y(p, "class", "badge svelte-h517e4"),
          Rt(p, "ok", n[3] === "connected"),
          Rt(p, "bad", n[3] !== "connected"),
          Y(s, "class", "statusbar svelte-h517e4"),
          Y(P, "class", "svelte-h517e4"),
          Y(t, "class", "topbar svelte-h517e4"),
          Y(N, "class", "sidebar svelte-h517e4"),
          Y(V, "class", "workspace svelte-h517e4"),
          Y(A, "class", "content svelte-h517e4"),
          Y(e, "class", "app svelte-h517e4"));
      },
      m(L, Ze) {
        (qe(L, e, Ze),
          R(e, t),
      ...
      p(L, [Ze]) {
        if (
          ((!fe || Ze & 2) &&
            ...
            Mt(c, l),
          (!fe || Ze & 2) && Rt(o, "ok", L[1]),
          (!fe || Ze & 2) && Rt(o, "bad", !L[1]),
          (!fe || Ze & 4) &&
            m !== (m = L[2] ? "ONLINE" : "OFFLINE") &&
            Mt(_, m),
          (!fe || Ze & 4) && Rt(f, "ok", L[2]),
          (!fe || Ze & 4) && Rt(f, "bad", !L[2]),
          (!fe || Ze & 8) && M !== (M = L[3].toUpperCase() + "") && Mt(x, M),
          (!fe || Ze & 8) && Rt(p, "ok", L[3] === "connected"),
          (!fe || Ze & 8) && Rt(p, "bad", L[3] !== "connected"),
          Ze & 17)
        ) {
          me = rn(L[4]);
          let Se;
