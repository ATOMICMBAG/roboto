...
function ft(n, e, t, i, r, s, o = null, a = [-1]) {
  ...
  if (
    ...
    if (e.hydrate) {
      const h = jl(e.target);
      (c.fragment && c.fragment.l(h), h.forEach(Ge));
...
function pc(n) {
  ...
  return {
    ...
    m(l, c) {
      (Xe(l, e, c), R(e, t), R(e, i), R(e, r), R(r, s), R(r, a));
    },
    p(l, [c]) {
...
function gc(n) {
  ...
  return {
    ...
    m(s, o) {
      (Xe(s, e, o), R(e, t), R(e, i), R(e, r), n[1](r));
    },
    p: ge,
    i: ge,
    o: ge,
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (i = ae()),
        (r = k("img")),
        oa(r.src, (s = n[0])) || X(r, "src", s),
        X(r, "alt", "camera stream"),
        X(r, "class", "svelte-jyl0g4"),
        X(e, "class", "panel svelte-jyl0g4"));
    },
    m(o, a) {
      (Xe(o, e, a), R(e, t), R(e, i), R(e, r));
    },
    p(o, [a]) {
      a & 1 && !oa(r.src, (s = o[0])) && X(r, "src", s);
    },
    i: ge,
    o: ge,
    d(o) {
...
function Vc(n, e, t) {
  ...
  function c(f) {
    ...
    i.forEach((C, w) => {
      C.type === "keypoints" &&
        C.points.forEach((A, H) => {
          const E = A.x - x,
            b = A.y - T;
          E * E + b * b < jr * jr && (a = { annIndex: w, pointIndex: H });
        });
    });
  }
  function u(f) {
  ...
  function g(f) {
    ((s.strokeStyle = "lime"),
      ...
      _.forEach(([M, x]) => {
        ...
        !T ||
          !C ||
          (s.beginPath(), s.moveTo(T.x, T.y), s.lineTo(C.x, C.y), s.stroke());
      }),
    ...
    (u = new Wc({})),
    {
      c() {
        ((e = k("div")),
          ...
          (c = ae()),
          dt(u.$$.fragment),
          X(t, "class", "svelte-1cq807x"),
          X(e, "class", "vision-container svelte-1cq807x"));
      },
      m(d, m) {
        (Xe(d, e, m),
          R(e, t),
      ...
      d(d) {
        (d && Ge(e), n[5](null), ut(r), ut(o), ut(l), ut(u));
      },
    }
  );
}
    ...
    (o = new qc({})),
    {
      c() {
        ((e = k("div")),
          ...
          (s = ae()),
          dt(o.$$.fragment),
          X(e, "class", "vision-container svelte-1g74rqe"));
      },
      m(l, c) {
        (Xe(l, e, c),
          ct(t, e, null),
...
function Zc(n) {
  let e, t, i, r, s, o, a, l, c, u, h, d, m, _, g, p, f, M, x, T, C, w;
  return {
    c() {
      ((e = k("div")),
        (t = k("h2")),
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (i = ae()),
        (r = k("canvas")),
        X(r, "class", "svelte-86n1hn"),
        X(e, "class", "panel svelte-86n1hn"));
    },
    m(s, o) {
      (Xe(s, e, o), R(e, t), R(e, i), R(e, r), n[1](r));
    },
  ...
  setAxisAngleFromRotationMatrix(e) {
    ...
    if (
      ...
      return (
        ...
        : C < 0.01 ? ((i = 0.707106781), (r = 0.707106781), (s = 0))
        : ((s = Math.sqrt(C)), (i = A / s), (r = H / s)),
        this.set(i, r, s, t),
        this
      );
    }
...
class Et {
  ...
  multiplyMatrices(e, t) {
    ...
    return (
      ...
      (s[4] = o * A + a * V + l * N + c * j),
      (s[8] = o * H + a * Z + l * W + c * q),
      (s[12] = o * E + a * se + l * J + c * ee),
      (s[1] = u * w + h * b + d * D + m * K),
      (s[5] = u * A + h * V + d * N + m * j),
      (s[9] = u * H + h * Z + d * W + m * q),
      (s[13] = u * E + h * se + d * J + m * ee),
      (s[2] = _ * w + g * b + p * D + f * K),
      (s[6] = _ * A + g * V + p * N + f * j),
      (s[10] = _ * H + g * Z + p * W + f * q),
      (s[14] = _ * E + g * se + p * J + f * ee),
      (s[3] = M * w + x * b + T * D + C * K),
      (s[7] = M * A + x * V + T * N + C * j),
      (s[11] = M * H + x * Z + T * W + C * q),
      (s[15] = M * E + x * se + T * J + C * ee),
      this
    );
  }
  multiplyScalar(e) {
  ...
  invert() {
    const e = this.elements,
      ...
      C = _ * h * l - u * g * l - _ * a * d + o * g * d + u * a * p - o * h * p,
      w = t * M + i * x + r * T + s * C;
    if (w === 0)
...
class si extends Fi {
  ...
  computeTangents() {
    ...
    function E(b) {
      ...
      const V = c[b];
      (C.copy(V),
        C.sub(A.multiplyScalar(A.dot(V))).normalize(),
        w.crossVectors(H, V));
  ...
  if (u) {
    (r &&
      ...
      o &&
        ...
        (u.normal = ln.getInterpolation(Sr, vi, xi, Mi, so, ao, oo, new z())),
        u.normal.dot(i.direction) > 0 && u.normal.multiplyScalar(-1)));
    const h = { a, b: l, c, normal: new z(), materialIndex: 0 };
...
class tr extends si {
  constructor(e = 1, t = 1, i = 1, r = 1, s = 1, o = 1) {
    ...
    function _(g, p, f, M, x, T, C, w, A, H, E) {
      const b = T / A,
        V = C / H,
        Z = T / 2,
        se = C / 2,
      ...
      for (let q = 0; q < H; q++)
        for (let ee = 0; ee < A; ee++) {
          const Q = d + ee + N * q,
            ...
            Y = d + (ee + 1) + N * (q + 1),
            $ = d + (ee + 1) + N * q;
          (l.push(Q, I, $), l.push(I, Y, $), (K += 6));
        }
      (a.addGroup(m, K, E), (m += K), (d += J));
    }
  }
  copy(e) {
    return (
...
void main() {
  ...
  le = {
    common: {
      ...
      opacity: { value: 1 },
      map: { value: null },
      mapTransform: { value: new Ve() },
      alphaMap: { value: null },
      alphaMapTransform: { value: new Ve() },
      alphaTest: { value: 0 },
    },
    specularmap: {
      specularMap: { value: null },
      specularMapTransform: { value: new Ve() },
    },
    envmap: {
      envMap: { value: null },
      flipEnvMap: { value: -1 },
    ...
    aomap: {
      ...
      aoMapTransform: { value: new Ve() },
    },
    lightmap: {
      lightMap: { value: null },
      lightMapIntensity: { value: 1 },
      lightMapTransform: { value: new Ve() },
    },
    bumpmap: {
      bumpMap: { value: null },
      bumpMapTransform: { value: new Ve() },
      bumpScale: { value: 1 },
    },
    normalmap: {
      normalMap: { value: null },
      normalMapTransform: { value: new Ve() },
      normalScale: { value: new Ke(1, 1) },
    },
    displacementmap: {
      displacementMap: { value: null },
      displacementMapTransform: { value: new Ve() },
      displacementScale: { value: 1 },
      displacementBias: { value: 0 },
    },
    emissivemap: {
      emissiveMap: { value: null },
      emissiveMapTransform: { value: new Ve() },
    },
    metalnessmap: {
      metalnessMap: { value: null },
      metalnessMapTransform: { value: new Ve() },
    },
    roughnessmap: {
      roughnessMap: { value: null },
      roughnessMapTransform: { value: new Ve() },
    },
...
hn.physical = {
  uniforms: Ot([
    hn.standard.uniforms,
    {
      ...
      clearcoatMapTransform: { value: new Ve() },
      clearcoatNormalMap: { value: null },
      clearcoatNormalMapTransform: { value: new Ve() },
      clearcoatNormalScale: { value: new Ke(1, 1) },
      clearcoatRoughness: { value: 0 },
      clearcoatRoughnessMap: { value: null },
      clearcoatRoughnessMapTransform: { value: new Ve() },
      iridescence: { value: 0 },
      iridescenceMap: { value: null },
      iridescenceMapTransform: { value: new Ve() },
      iridescenceIOR: { value: 1.3 },
      iridescenceThicknessMinimum: { value: 100 },
      iridescenceThicknessMaximum: { value: 400 },
      iridescenceThicknessMap: { value: null },
      iridescenceThicknessMapTransform: { value: new Ve() },
      sheen: { value: 0 },
      sheenColor: { value: new je(0) },
      sheenColorMap: { value: null },
      sheenColorMapTransform: { value: new Ve() },
      sheenRoughness: { value: 1 },
      sheenRoughnessMap: { value: null },
      sheenRoughnessMapTransform: { value: new Ve() },
      transmission: { value: 0 },
      transmissionMap: { value: null },
      transmissionMapTransform: { value: new Ve() },
      transmissionSamplerSize: { value: new Ke() },
      transmissionSamplerMap: { value: null },
      thickness: { value: 0 },
      thicknessMap: { value: null },
      thicknessMapTransform: { value: new Ve() },
      attenuationDistance: { value: 0 },
      attenuationColor: { value: new je(0) },
      specularColor: { value: new je(1, 1, 1) },
      specularColorMap: { value: null },
      specularColorMapTransform: { value: new Ve() },
      specularIntensity: { value: 1 },
      specularIntensityMap: { value: null },
      specularIntensityMapTransform: { value: new Ve() },
      anisotropyVector: { value: new Ke() },
      anisotropyMap: { value: null },
      anisotropyMapTransform: { value: new Ve() },
    },
  ]),
  vertexShader: Fe.meshphysical_vert,
  fragmentShader: Fe.meshphysical_frag,
    ...
    : T === "alpha-blend" && i.buffers.color.setClear(0, 0, 0, 0, o),
      ...
      x && (x.isCubeTexture || x.mapping === Br) ?
        (u === void 0 &&
          ...
          (u.onBeforeRender = function (C, w, A) {
...
function fp(n, e, t, i) {
  ...
  function h(D, N, W, J, K) {
    ...
    if (o) {
      ...
      (c.geometry !== J.id || c.program !== W.id || c.wireframe !== q) &&
        ((c.geometry = J.id), (c.program = W.id), (c.wireframe = q), (j = !0));
    }
  ...
  function g(D, N, W) {
    const J = W.wireframe === !0;
    let K = a[D.id];
    K === void 0 && ((K = {}), (a[D.id] = K));
    let j = K[N.id];
    j === void 0 && ((j = {}), (K[N.id] = j));
    let q = j[J];
    return (q === void 0 && ((q = p(d())), (j[J] = q)), q);
  }
  function p(D) {
    const N = [],
      W = [],
      J = [];
    for (let K = 0; K < r; K++) ((N[K] = 0), (W[K] = 0), (J[K] = 0));
    return {
      geometry: null,
      program: null,
      wireframe: !1,
        ...
        if (
          ($ === void 0 &&
            (Q === "instanceMatrix" &&
              D.instanceMatrix &&
              ($ = D.instanceMatrix),
            Q === "instanceColor" && D.instanceColor && ($ = D.instanceColor)),
          Y === void 0 || Y.attribute !== $ || ($ && Y.data !== $.data))
        )
          return !0;
        q++;
      }
    return c.attributesNum !== q || c.index !== J;
  }
  function M(D, N, W, J) {
    const K = {},
      j = N.attributes;
    ...
    for (const Q in ee)
      if (ee[Q].location >= 0) {
        let Y = j[Q];
        Y === void 0 &&
          (Q === "instanceMatrix" && D.instanceMatrix && (Y = D.instanceMatrix),
          Q === "instanceColor" && D.instanceColor && (Y = D.instanceColor));
        const $ = {};
        (($.attribute = Y), Y && Y.data && ($.data = Y.data), (K[Q] = $), q++);
      }
    ((c.attributes = K), (c.attributesNum = q), (c.index = J));
  }
  function x() {
    const D = c.newAttributes;
    for (let N = 0, W = D.length; N < W; N++) D[N] = 0;
  }
  function T(D) {
    C(D, 0);
  }
  function C(D, N) {
    ...
    ((W[D] = 1),
      J[D] === 0 && (n.enableVertexAttribArray(D), (J[D] = 1)),
      K[D] !== N &&
  ...
  function w() {
    ...
    for (let W = 0, J = N.length; W < J; W++)
      N[W] !== D[W] && (n.disableVertexAttribArray(W), (N[W] = 0));
  }
  function A(D, N, W, J, K, j, q) {
    q === !0 ?
      n.vertexAttribIPointer(D, N, W, K, j)
    : n.vertexAttribPointer(D, N, W, J, K, j);
  }
  function H(D, N, W, J) {
    if (
      i.isWebGL2 === !1 &&
      (D.isInstancedMesh || J.isInstancedBufferGeometry) &&
      ...
      if (Q.location >= 0) {
        ...
        if (
          ...
          if (I.isInterleavedBufferAttribute) {
            ...
            if (qe.isInstancedInterleavedBuffer) {
              for (let xe = 0; xe < Q.locationSize; xe++)
                C(Q.location + xe, qe.meshPerAttribute);
              D.isInstancedMesh !== !0 &&
                J._maxInstanceCount === void 0 &&
                (J._maxInstanceCount = qe.meshPerAttribute * qe.count);
            } else
            ...
            for (let xe = 0; xe < Q.locationSize; xe++)
              A(
                ...
                Y,
                P * Pe,
                (Ze + ($ / Q.locationSize) * xe) * Pe,
                Te,
              );
          } else {
            if (I.isInstancedBufferAttribute) {
              for (let qe = 0; qe < Q.locationSize; qe++)
                C(Q.location + qe, I.meshPerAttribute);
              D.isInstancedMesh !== !0 &&
                J._maxInstanceCount === void 0 &&
                (J._maxInstanceCount = I.meshPerAttribute * I.count);
            } else
          ...
          if (Y !== void 0)
            switch (Y.length) {
              case 2:
                n.vertexAttrib2fv(Q.location, Y);
                break;
              case 3:
                n.vertexAttrib3fv(Q.location, Y);
                break;
              case 4:
                n.vertexAttrib4fv(Q.location, Y);
                break;
              default:
                n.vertexAttrib1fv(Q.location, Y);
            }
        }
      }
    }
  ...
  function E() {
    ...
    for (const D in a) {
      ...
      for (const W in N) {
        const J = N[W];
        for (const K in J) (_(J[K].object), delete J[K]);
        delete N[W];
      }
      delete a[D];
    }
...
class fo {
  ...
  _halfBlur(e, t, i, r, s, o, a) {
    ...
    const T = this._sizeLods[r],
      C = 3 * T * (r > x - Ai ? r - x + Ai : 0),
      w = 4 * (this._cubeSize - T);
    (Ar(t, C, w, 3 * T, 2 * T), l.setRenderTarget(t), l.render(h, Ss));
  }
}
function _p(n) {
  const e = [],
  ...
  for (let o = 0; o < s; o++) {
    ...
    for (let w = 0; w < m; w++) {
      ...
      (M.set(E, g * _ * w), x.set(d, p * _ * w));
      const b = [w, w, w, w, w, w];
      T.set(b, f * _ * w);
    }
    const C = new si();
    (C.setAttribute("position", new pn(M, g)),
      C.setAttribute("uv", new pn(x, p)),
      C.setAttribute("faceIndex", new pn(T, f)),
      e.push(C),
      r > Ai && r--);
  }
  ...
  function l(c, u, h) {
    ...
    if (e.isWebGL2 === !0) {
      ...
      if (p === void 0 || p.count !== g) {
        let N = function () {
          (se.dispose(), s.delete(u), u.removeEventListener("dispose", N));
        };
        var m = N;
          ...
          for (let ee = 0; ee < J.count; ee++) {
            ...
            (x === !0 &&
              ...
              C === !0 &&
                ...
                (Z[q + Q + 9] = o.y),
                (Z[q + Q + 10] = o.z),
                (Z[q + Q + 11] = j.itemSize === 4 ? o.w : 1)));
          }
        }
        ((p = { count: g, texture: se, size: new Ke(b, V) }),
          s.set(u, p),
...
` +
    ...
    (r.deleteShader(w), r.deleteShader(A), (E = new Cr(r, p)), (b = Am(r, p)));
  }
  let E;
...
function Hm(n, e, t, i, r, s, o) {
  ...
  function p(E, b, V, Z, se) {
    const D = Z.fog,
      N = se.geometry,
      W = E.isMeshStandardMaterial ? Z.environment : null,
      J = (E.isMeshStandardMaterial ? t : e).get(E.envMap || W),
      K = J && J.mapping === Br ? J.image.height : null,
      j = _[E.type];
    E.precision !== null &&
    ...
    if (j) {
      const Nt = hn[j];
      ((I = Nt.vertexShader), (Y = Nt.fragmentShader));
    } else
      ((I = E.vertexShader),
        (Y = E.fragmentShader),
        l.update(E),
        ($ = l.getVertexShaderID(E)),
        (ce = l.getFragmentShaderID(E)));
    const pe = n.getRenderTarget(),
      Me = se.isInstancedMesh === !0,
      Pe = se.isBatchedMesh === !0,
      Te = !!E.map,
      qe = !!E.matcap,
      P = !!J,
      Ze = !!E.aoMap,
      ...
      re = E.sheen > 0,
      Ee = E.transmission > 0,
      he = O && !!E.anisotropyMap,
      me = ie && !!E.clearcoatMap,
      Re = ie && !!E.clearcoatNormalMap,
      Be = ie && !!E.clearcoatRoughnessMap,
      te = ne && !!E.iridescenceMap,
      et = ne && !!E.iridescenceThicknessMap,
      $e = re && !!E.sheenColorMap,
      De = re && !!E.sheenRoughnessMap,
      be = !!E.specularMap,
      _e = !!E.specularColorMap,
      Ne = !!E.specularIntensityMap,
      Je = Ee && !!E.transmissionMap,
      _t = Ee && !!E.thicknessMap,
      He = !!E.gradientMap,
      oe = !!E.alphaMap,
      L = E.alphaTest > 0,
      ue = !!E.alphaHash,
    ...
    return (
        ...
        (rt = n.toneMapping),
      {
        ...
        batching: Pe,
        instancing: Me,
        instancingColor: Me && se.instanceColor !== null,
        ...
        emissiveMap: Oe,
        normalMapObjectSpace: ve && E.normalMapType === Yu,
        normalMapTangentSpace: ve && E.normalMapType === gl,
        metalnessMap: y,
        roughnessMap: v,
        anisotropy: O,
        anisotropyMap: he,
        ...
        thicknessMap: _t,
        gradientMap: He,
        opaque: E.transparent === !1 && E.blending === Ci,
        alphaMap: oe,
        alphaTest: L,
        alphaHash: ue,
        combine: E.combine,
        mapUv: Te && g(E.map.channel),
        aoMapUv: Ze && g(E.aoMap.channel),
        lightMapUv: xe && g(E.lightMap.channel),
        bumpMapUv: Se && g(E.bumpMap.channel),
        normalMapUv: ve && g(E.normalMap.channel),
        displacementMapUv: pt && g(E.displacementMap.channel),
        emissiveMapUv: Oe && g(E.emissiveMap.channel),
        metalnessMapUv: y && g(E.metalnessMap.channel),
        roughnessMapUv: v && g(E.roughnessMap.channel),
        anisotropyMapUv: he && g(E.anisotropyMap.channel),
        clearcoatMapUv: me && g(E.clearcoatMap.channel),
        clearcoatNormalMapUv: Re && g(E.clearcoatNormalMap.channel),
        clearcoatRoughnessMapUv: Be && g(E.clearcoatRoughnessMap.channel),
        iridescenceMapUv: te && g(E.iridescenceMap.channel),
        iridescenceThicknessMapUv: et && g(E.iridescenceThicknessMap.channel),
        ...
        specularColorMapUv: _e && g(E.specularColorMap.channel),
        specularIntensityMapUv: Ne && g(E.specularIntensityMap.channel),
        transmissionMapUv: Je && g(E.transmissionMap.channel),
        thicknessMapUv: _t && g(E.thicknessMap.channel),
        alphaMapUv: oe && g(E.alphaMap.channel),
        ...
        vertexUv2s: Ae,
        vertexUv3s: it,
        pointsUvs: se.isPoints === !0 && !!N.attributes.uv && (Te || oe),
        fog: !!D,
        useFog: E.fog === !0,
        ...
        decodeVideoTexture:
          ...
          tt.getTransfer(E.map.colorSpace) === lt,
        ...
        extensionDerivatives: fe && E.extensions.derivatives === !0,
        extensionFragDepth: fe && E.extensions.fragDepth === !0,
        extensionDrawBuffers: fe && E.extensions.drawBuffers === !0,
        extensionShaderTextureLOD: fe && E.extensions.shaderTextureLOD === !0,
        extensionClipCullDistance:
          fe &&
          E.extensions.clipCullDistance &&
  ...
  function f(E) {
    ...
    if (
      (E.shaderID ?
        b.push(E.shaderID)
      : (b.push(E.customVertexShaderID), b.push(E.customFragmentShaderID)),
      E.defines !== void 0)
    )
      for (const V in E.defines) (b.push(V), b.push(E.defines[V]));
    return (
      E.isRawShaderMaterial === !1 &&
        (M(b, E), x(b, E), b.push(n.outputColorSpace)),
  ...
  function M(E, b) {
    (E.push(b.precision),
      ...
      E.push(b.aoMapUv),
      E.push(b.bumpMapUv),
      E.push(b.normalMapUv),
      E.push(b.displacementMapUv),
      E.push(b.emissiveMapUv),
      E.push(b.metalnessMapUv),
      E.push(b.roughnessMapUv),
      E.push(b.anisotropyMapUv),
      E.push(b.clearcoatMapUv),
      E.push(b.clearcoatNormalMapUv),
      E.push(b.clearcoatRoughnessMapUv),
      E.push(b.iridescenceMapUv),
      E.push(b.iridescenceThicknessMapUv),
      E.push(b.sheenColorMapUv),
      E.push(b.sheenRoughnessMapUv),
      E.push(b.specularMapUv),
      E.push(b.specularColorMapUv),
      E.push(b.specularIntensityMapUv),
      E.push(b.transmissionMapUv),
      E.push(b.thicknessMapUv),
      E.push(b.combine),
      E.push(b.fogExp2),
  ...
  function C(E, b) {
    let V;
    for (let Z = 0, se = c.length; Z < se; Z++) {
      const D = c[Z];
      if (D.cacheKey === b) {
        ((V = D), ++V.usedTimes);
        break;
    ...
    return (V === void 0 && ((V = new Om(n, b, E, s)), c.push(V)), V);
  }
  function w(E) {
    if (--E.usedTimes === 0) {
      const b = c.indexOf(E);
      ((c[b] = c[c.length - 1]), c.pop(), E.destroy());
    }
  }
  function A(E) {
    l.remove(E);
...
function jm(n, e) {
  ...
  function l(u, h) {
    ...
    for (let Z = 0, se = u.length; Z < se; Z++) {
      const D = u[Z],
        N = D.color,
        W = D.intensity,
        J = D.distance,
      ...
      if (D.isAmbientLight)
        ((d += N.r * W * b), (m += N.g * W * b), (_ += N.b * W * b));
      else if (D.isLightProbe) {
        for (let j = 0; j < 9; j++)
          r.probe[j].addScaledVector(D.sh.coefficients[j], W);
        E++;
        ...
        (j.position.setFromMatrixPosition(D.matrixWorld),
          j.color.copy(N).multiplyScalar(W * b),
          (j.distance = J),
        ...
        const j = t.get(D);
        (j.color.copy(N).multiplyScalar(W),
        ...
        const j = t.get(D);
        (j.skyColor.copy(D.color).multiplyScalar(W * b),
          j.groundColor.copy(D.groundColor).multiplyScalar(W * b),
          (r.hemi[x] = j),
          x++);
      }
    }
  ...
  function c(u, h) {
    ...
    for (let M = 0, x = u.length; M < x; M++) {
      ...
      if (T.isDirectionalLight) {
        const C = r.directional[d];
        (C.direction.setFromMatrixPosition(T.matrixWorld),
...
function t_(n, e, t) {
  ...
  this.render = function (w, A, H) {
    ...
    (Z.setBlending(Fn),
      ...
      Z.setScissorTest(!1));
    const se = f !== En && this.type === En,
      D = f === En && this.type !== En;
    for (let N = 0, W = w.length; N < W; N++) {
      const J = w[N],
        K = J.shadow;
      if (K === void 0) {
      ...
      for (let ee = 0; ee < q; ee++) {
        const Q = K.getViewport(ee);
        (o.set(s.x * Q.x, s.y * Q.y, s.x * Q.z, s.y * Q.w),
          Z.viewport(o),
          K.updateMatrices(J, ee),
          (i = K.getFrustum()),
          T(A, H, K.camera, J, this.type));
      }
      (K.isPointLightShadow !== !0 && this.type === En && M(K, H),
        (K.needsUpdate = !1));
    }
    ((f = this.type), (p.needsUpdate = !1), n.setRenderTarget(E, b, V));
  };
  function M(w, A) {
    const H = e.update(g);
  ...
  function x(w, A, H, E) {
    ...
    if (V !== void 0) b = V;
      ...
      let N = D[se];
      (N === void 0 &&
        ((N = b.clone()), (D[se] = N), A.addEventListener("dispose", C)),
        (b = N));
    }
    if (
      ((b.visible = A.visible),
    ...
    if (
      ...
      if (Array.isArray(D)) {
        ...
        for (let W = 0, J = N.length; W < J; W++) {
          ...
          if (j && j.visible) {
            const q = x(w, j, E, b);
            (w.onBeforeShadow(n, w, A, H, se, q, K),
              n.renderBufferDirect(H, null, se, q, w, K),
              w.onAfterShadow(n, w, A, H, se, q, K));
          }
        }
      } else if (D.visible) {
        const N = x(w, D, E, b);
        (w.onBeforeShadow(n, w, A, H, se, N, null),
          n.renderBufferDirect(H, null, se, N, w, null),
          w.onAfterShadow(n, w, A, H, se, N, null));
      }
    }
    const Z = w.children;
    for (let se = 0, D = Z.length; se < D; se++) T(Z[se], A, H, E, b);
  }
  function C(w) {
...
function n_(n, e, t) {
  ...
  function r() {
    ...
    return {
      setMask: function (Ae) {
        fe !== Ae && !L && (n.colorMask(Ae, Ae, Ae, Ae), (fe = Ae));
      },
  ...
  function o() {
    ...
    return {
      setTest: function (st) {
        L || (st ? Pe(n.STENCIL_TEST) : Te(n.STENCIL_TEST));
      },
      setMask: function (st) {
        ue !== st && !L && (n.stencilMask(st), (ue = st));
      },
  ...
  q.indexOf("WebGL") !== -1 ?
    ((j = parseFloat(/^WebGL (\d)/.exec(q)[1])), (K = j >= 1))
  : q.indexOf("OpenGL ES") !== -1 &&
    ((j = parseFloat(/^OpenGL ES (\d)/.exec(q)[1])), (K = j >= 2));
  let ee = null,
    Q = {};
  const I = n.getParameter(n.SCISSOR_BOX),
    Y = n.getParameter(n.VIEWPORT),
    $ = new Ct().fromArray(I),
    ce = new Ct().fromArray(Y);
  function pe(L, ue, fe, Ce) {
    const Ae = new Uint8Array(4),
      it = n.createTexture();
    (n.bindTexture(L, it),
      n.texParameteri(L, n.TEXTURE_MIN_FILTER, n.NEAREST),
      n.texParameteri(L, n.TEXTURE_MAG_FILTER, n.NEAREST));
    for (let rt = 0; rt < fe; rt++)
      i && (L === n.TEXTURE_3D || L === n.TEXTURE_2D_ARRAY) ?
        n.texImage3D(ue, 0, n.RGBA, 1, 1, Ce, 0, n.RGBA, n.UNSIGNED_BYTE, Ae)
      : n.texImage2D(ue + rt, 0, n.RGBA, 1, 1, 0, n.RGBA, n.UNSIGNED_BYTE, Ae);
    return it;
  }
  const Me = {};
  ((Me[n.TEXTURE_2D] = pe(n.TEXTURE_2D, n.TEXTURE_2D, 1)),
    (Me[n.TEXTURE_CUBE_MAP] = pe(
      n.TEXTURE_CUBE_MAP,
      n.TEXTURE_CUBE_MAP_POSITIVE_X,
      6,
    )),
    i &&
      ((Me[n.TEXTURE_2D_ARRAY] = pe(
        n.TEXTURE_2D_ARRAY,
        n.TEXTURE_2D_ARRAY,
        1,
        1,
      )),
      (Me[n.TEXTURE_3D] = pe(n.TEXTURE_3D, n.TEXTURE_3D, 1, 1))),
    a.setClear(0, 0, 0, 1),
    l.setClear(1),
    c.setClear(0),
    Pe(n.DEPTH_TEST),
    ...
    ve(Fn));
  function Pe(L) {
    d[L] !== !0 && (n.enable(L), (d[L] = !0));
  }
  function Te(L) {
    d[L] !== !1 && (n.disable(L), (d[L] = !1));
  }
  function qe(L, ue) {
    return m[L] !== ue ?
        (n.bindFramebuffer(L, ue),
        (m[L] = ue),
        i &&
          (L === n.DRAW_FRAMEBUFFER && (m[n.FRAMEBUFFER] = ue),
          L === n.FRAMEBUFFER && (m[n.DRAW_FRAMEBUFFER] = ue)),
        !0)
      : !1;
  }
  function P(L, ue) {
  ...
  function Ze(L) {
    return p !== L ? (n.useProgram(L), (p = L), !0) : !1;
  }
  const xe = {
    [jn]: n.FUNC_ADD,
    [ou]: n.FUNC_SUBTRACT,
  ...
  if (i) ((xe[pa] = n.MIN), (xe[ma] = n.MAX));
    ...
    L !== null && ((xe[pa] = L.MIN_EXT), (xe[ma] = L.MAX_EXT));
  }
  const Se = {
    [cu]: n.ZERO,
    [uu]: n.ONE,
  ...
  function ve(L, ue, fe, Ce, Ae, it, rt, bt, Nt, st) {
    if (L === Fn) {
      f === !0 && (Te(n.BLEND), (f = !1));
      return;
    }
    if ((f === !1 && (Pe(n.BLEND), (f = !0)), L !== au)) {
      if (L !== M || st !== V) {
        if (
          ((x !== jn || w !== jn) &&
    ...
    ((Ae = Ae || ue),
      ...
      (fe !== T || Ce !== C || it !== A || rt !== H) &&
        ...
        (H = rt)),
      (bt.equals(E) === !1 || Nt !== b) &&
        (n.blendColor(bt.r, bt.g, bt.b, Nt), E.copy(bt), (b = Nt)),
      (M = L),
      (V = !1));
  }
  function pt(L, ue) {
    L.side === dn ? Te(n.CULL_FACE) : Pe(n.CULL_FACE);
    let fe = L.side === Wt;
    (ue && (fe = !fe),
      Oe(fe),
      L.blending === Ci && L.transparent === !1 ?
        ve(Fn)
      : ve(
          L.blending,
          L.blendEquation,
    ...
    (c.setTest(Ce),
      ...
      O(L.polygonOffset, L.polygonOffsetFactor, L.polygonOffsetUnits),
      L.alphaToCoverage === !0 ?
        Pe(n.SAMPLE_ALPHA_TO_COVERAGE)
      : Te(n.SAMPLE_ALPHA_TO_COVERAGE));
  }
  function Oe(L) {
    Z !== L && (L ? n.frontFace(n.CW) : n.frontFace(n.CCW), (Z = L));
  }
  function y(L) {
    (L !== iu ?
      (Pe(n.CULL_FACE),
      L !== se &&
        (L === ua ? n.cullFace(n.BACK)
        : L === ru ? n.cullFace(n.FRONT)
        : n.cullFace(n.FRONT_AND_BACK)))
    : Te(n.CULL_FACE),
      (se = L));
  }
  function v(L) {
    L !== D && (K && n.lineWidth(L), (D = L));
  }
  function O(L, ue, fe) {
    L ?
      (Pe(n.POLYGON_OFFSET_FILL),
      (N !== ue || W !== fe) && (n.polygonOffset(ue, fe), (N = ue), (W = fe)))
    : Te(n.POLYGON_OFFSET_FILL);
  }
  function ie(L) {
    L ? Pe(n.SCISSOR_TEST) : Te(n.SCISSOR_TEST);
  }
  function ne(L) {
    (L === void 0 && (L = n.TEXTURE0 + J - 1),
      ee !== L && (n.activeTexture(L), (ee = L)));
  }
  function re(L, ue, fe) {
    fe === void 0 && (ee === null ? (fe = n.TEXTURE0 + J - 1) : (fe = ee));
    let Ce = Q[fe];
    (Ce === void 0 && ((Ce = { type: void 0, texture: void 0 }), (Q[fe] = Ce)),
      (Ce.type !== L || Ce.texture !== ue) &&
        (ee !== fe && (n.activeTexture(fe), (ee = fe)),
        n.bindTexture(L, ue || Me[L]),
        (Ce.type = L),
        (Ce.texture = ue)));
  }
  function Ee() {
    ...
    L !== void 0 &&
      L.type !== void 0 &&
      (n.bindTexture(L.type, null), (L.type = void 0), (L.texture = void 0));
  }
  function he() {
    try {
  ...
  function Ne(L) {
    $.equals(L) === !1 && (n.scissor(L.x, L.y, L.z, L.w), $.copy(L));
  }
  function Je(L) {
    ce.equals(L) === !1 && (n.viewport(L.x, L.y, L.z, L.w), ce.copy(L));
  }
  function _t(L, ue) {
    let fe = h.get(ue);
    fe === void 0 && ((fe = new WeakMap()), h.set(ue, fe));
    let Ce = fe.get(L);
    Ce === void 0 && ((Ce = n.getUniformBlockIndex(ue, L.name)), fe.set(L, Ce));
  }
  function He(L, ue) {
    const Ce = h.get(ue).get(L);
    u.get(ue) !== Ce &&
      (n.uniformBlockBinding(ue, Ce, L.__bindingPointIndex), u.set(ue, Ce));
  }
  function oe() {
    (n.disable(n.BLEND),
      ...
      (N = null),
      (W = null),
      $.set(0, 0, n.canvas.width, n.canvas.height),
...
function i_(n, e, t, i, r, s, o) {
  ...
  function g(y, v, O, ie) {
    let ne = 1;
    if (
      ((y.width > ie || y.height > ie) &&
        (ne = ie / Math.max(y.width, y.height)),
      ne < 1 || v === !0)
    )
      if (
        ...
        const re = v ? zs : Math.floor,
          Ee = re(ne * y.width),
          he = re(ne * y.height);
        h === void 0 && (h = _(Ee, he));
        const me = O ? _(Ee, he) : h;
        return (
          (me.width = Ee),
          (me.height = he),
          me.getContext("2d").drawImage(y, 0, 0, Ee, he),
          console.warn(
  ...
  function T(y, v, O, ie, ne = !1) {
    ...
    if (
      (v === n.RED &&
        (O === n.FLOAT && (re = n.R32F),
        O === n.HALF_FLOAT && (re = n.R16F),
        O === n.UNSIGNED_BYTE && (re = n.R8)),
      v === n.RED_INTEGER &&
        (O === n.UNSIGNED_BYTE && (re = n.R8UI),
        O === n.UNSIGNED_SHORT && (re = n.R16UI),
        O === n.UNSIGNED_INT && (re = n.R32UI),
        O === n.BYTE && (re = n.R8I),
        O === n.SHORT && (re = n.R16I),
        O === n.INT && (re = n.R32I)),
      v === n.RG &&
        (O === n.FLOAT && (re = n.RG32F),
        O === n.HALF_FLOAT && (re = n.RG16F),
        O === n.UNSIGNED_BYTE && (re = n.RG8)),
      v === n.RGBA)
    ) {
      const Ee = ne ? Ur : tt.getTransfer(ie);
      (O === n.FLOAT && (re = n.RGBA32F),
        O === n.HALF_FLOAT && (re = n.RGBA16F),
        O === n.UNSIGNED_BYTE && (re = Ee === lt ? n.SRGB8_ALPHA8 : n.RGBA8),
        O === n.UNSIGNED_SHORT_4_4_4_4 && (re = n.RGBA4),
        O === n.UNSIGNED_SHORT_5_5_5_1 && (re = n.RGB5_A1));
    }
    return (
      (re === n.R16F ||
        re === n.R32F ||
  ...
  function E(y) {
    ...
    const O = y.source,
      ie = d.get(O);
    if (ie) {
      const ne = ie[v.__cacheKey];
      (ne.usedTimes--,
        ne.usedTimes === 0 && b(y),
        Object.keys(ie).length === 0 && d.delete(O));
    }
    i.remove(y);
  }
  function b(y) {
    ...
    if (
      ...
      for (let ne = 0; ne < 6; ne++) {
        if (Array.isArray(O.__webglFramebuffer[ne]))
          for (let re = 0; re < O.__webglFramebuffer[ne].length; re++)
            n.deleteFramebuffer(O.__webglFramebuffer[ne][re]);
  ...
  const q = { [Ns]: n.REPEAT, [cn]: n.CLAMP_TO_EDGE, [Fs]: n.MIRRORED_REPEAT },
    ee = {
      [zt]: n.NEAREST,
  ...
  function I(y, v, O) {
    if (
      (O ?
        (n.texParameteri(y, n.TEXTURE_WRAP_S, q[v.wrapS]),
        n.texParameteri(y, n.TEXTURE_WRAP_T, q[v.wrapT]),
        (y === n.TEXTURE_3D || y === n.TEXTURE_2D_ARRAY) &&
          n.texParameteri(y, n.TEXTURE_WRAP_R, q[v.wrapR]),
  ...
  function Y(y, v) {
    ...
    const ie = v.source;
    let ne = d.get(ie);
    ne === void 0 && ((ne = {}), d.set(ie, ne));
    const re = N(v);
    if (re !== y.__cacheKey) {
      (ne[re] === void 0 &&
        ((ne[re] = { texture: n.createTexture(), usedTimes: 0 }),
        o.memory.textures++,
        (O = !0)),
        ne[re].usedTimes++);
      ...
      (Ee !== void 0 &&
        ...
        (y.__cacheKey = re),
        (y.__webglTexture = ne[re].texture));
    }
    return O;
  }
  function $(y, v, O) {
    ...
    ((v.isDataArrayTexture || v.isCompressedArrayTexture) &&
      (ie = n.TEXTURE_2D_ARRAY),
      v.isData3DTexture && (ie = n.TEXTURE_3D));
    const ne = Y(y, v),
      re = v.source;
    t.bindTexture(ie, y.__webglTexture, n.TEXTURE0 + O);
    const Ee = i.get(re);
    if (re.version !== Ee.__version || ne === !0) {
      t.activeTexture(n.TEXTURE0 + O);
      const he = tt.getPrimaries(tt.workingColorSpace),
        me = v.colorSpace === nn ? null : tt.getPrimaries(v.colorSpace),
        Re =
          v.colorSpace === nn || he === me ? n.NONE : n.BROWSER_DEFAULT_WEBGL;
      ...
      te = Oe(v, te);
      const et = p(te) || a,
        $e = s.convert(v.format, v.colorSpace);
      let De = s.convert(v.type),
        be = T(v.internalFormat, $e, De, v.colorSpace, v.isVideoTexture);
      I(ie, v, et);
      let _e;
      const Ne = v.mipmaps,
      ...
      if (v.isDepthTexture)
        ...
        if (Ne.length > 0 && et) {
          Je &&
            _t &&
            t.texStorage2D(n.TEXTURE_2D, He, be, Ne[0].width, Ne[0].height);
          for (let oe = 0, L = Ne.length; oe < L; oe++)
            ((_e = Ne[oe]),
              Je ?
                t.texSubImage2D(
                  n.TEXTURE_2D,
          ...
          Je ?
            (_t && t.texStorage2D(n.TEXTURE_2D, He, be, te.width, te.height),
            t.texSubImage2D(
              n.TEXTURE_2D,
              0,
              0,
        ...
        Je ?
          (_t &&
            t.texStorage3D(n.TEXTURE_3D, He, be, te.width, te.height, te.depth),
          t.texSubImage3D(
            n.TEXTURE_3D,
            0,
            0,
        ...
        if (_t)
          if (Je) t.texStorage2D(n.TEXTURE_2D, He, be, te.width, te.height);
          else {
            let oe = te.width,
              L = te.height;
            for (let ue = 0; ue < He; ue++)
              (t.texImage2D(n.TEXTURE_2D, ue, be, oe, L, 0, $e, De, null),
                (oe >>= 1),
                (L >>= 1));
          }
        ...
        for (let oe = 0, L = Ne.length; oe < L; oe++)
          ((_e = Ne[oe]),
            Je ?
              t.texSubImage2D(n.TEXTURE_2D, oe, 0, 0, $e, De, _e)
            : t.texImage2D(n.TEXTURE_2D, oe, be, $e, De, _e));
        v.generateMipmaps = !1;
      } else
        Je ?
          (_t && t.texStorage2D(n.TEXTURE_2D, He, be, te.width, te.height),
          t.texSubImage2D(n.TEXTURE_2D, 0, 0, 0, $e, De, te))
        : t.texImage2D(n.TEXTURE_2D, 0, be, $e, De, te);
      (M(v, et) && x(ie),
  ...
  function ce(y, v, O) {
    ...
    const re = i.get(ne);
    if (ne.version !== re.__version || ie === !0) {
      t.activeTexture(n.TEXTURE0 + O);
      ...
      const et = te[0],
        ...
        be = s.convert(v.type),
        _e = T(v.internalFormat, De, be, v.colorSpace),
        Ne = a && v.isVideoTexture !== !0,
        Je = re.__version === void 0 || ie === !0;
      let _t = C(v, et, $e);
      I(n.TEXTURE_CUBE_MAP, v, $e);
      let He;
      if (Re) {
        Ne &&
          Je &&
          t.texStorage2D(n.TEXTURE_CUBE_MAP, _t, _e, et.width, et.height);
        for (let oe = 0; oe < 6; oe++) {
          He = te[oe].mipmaps;
      ...
      (M(v, $e) && x(n.TEXTURE_CUBE_MAP),
        (re.__version = ne.version),
        v.onUpdate && v.onUpdate(v));
    }
    y.__version = v.version;
  }
  function pe(y, v, O, ie, ne, re) {
    const Ee = s.convert(O.format, O.colorSpace),
      he = s.convert(O.type),
      me = T(O.internalFormat, Ee, he, O.colorSpace);
    if (!i.get(v).__hasExternalTextures) {
      const Be = Math.max(1, v.width >> re),
        te = Math.max(1, v.height >> re);
      ne === n.TEXTURE_3D || ne === n.TEXTURE_2D_ARRAY ?
        t.texImage3D(ne, re, me, Be, te, v.depth, 0, Ee, he, null)
      : t.texImage2D(ne, re, me, Be, te, 0, Ee, he, null);
    }
    ...
    if (
      ...
      if (O || ve(v)) {
        ...
        ne &&
          ...
          : ne.type === In && (ie = n.DEPTH_COMPONENT24));
        const re = Se(v);
        ve(v) ?
      ...
      } else n.renderbufferStorage(n.RENDERBUFFER, ie, v.width, v.height);
      ...
      for (let ne = 0; ne < ie.length; ne++) {
        const re = ie[ne],
          Ee = s.convert(re.format, re.colorSpace),
          he = s.convert(re.type),
          me = T(re.internalFormat, Ee, he, re.colorSpace),
          Re = Se(v);
        O && ve(v) === !1 ?
          n.renderbufferStorageMultisample(
            n.RENDERBUFFER,
        ...
        : n.renderbufferStorage(n.RENDERBUFFER, me, v.width, v.height);
      }
    }
  ...
  function Pe(y, v) {
    ...
    ((!i.get(v.depthTexture).__webglTexture ||
      ...
      W(v.depthTexture, 0));
    const ie = i.get(v.depthTexture).__webglTexture,
      ne = Se(v);
  ...
  function Te(y) {
    ...
    if (y.depthTexture && !v.__autoAllocateDepthBuffer) {
      ...
      for (let ie = 0; ie < 6; ie++)
        (t.bindFramebuffer(n.FRAMEBUFFER, v.__webglFramebuffer[ie]),
          (v.__webglDepthbuffer[ie] = n.createRenderbuffer()),
          Me(v.__webglDepthbuffer[ie], y, !1));
    } else
  ...
  function P(y) {
    ...
    (y.addEventListener("dispose", H),
      y.isWebGLMultipleRenderTargets !== !0 &&
        (ie.__webglTexture === void 0 &&
          (ie.__webglTexture = n.createTexture()),
        (ie.__version = v.version),
        o.memory.textures++));
    const ne = y.isWebGLCubeRenderTarget === !0,
      re = y.isWebGLMultipleRenderTargets === !0,
      Ee = p(y) || a;
    if (ne) {
      ...
      for (let he = 0; he < 6; he++)
        if (a && v.mipmaps && v.mipmaps.length > 0) {
          ...
          for (let me = 0; me < v.mipmaps.length; me++)
            O.__webglFramebuffer[he][me] = n.createFramebuffer();
      ...
      if (a && y.samples > 0 && ve(y) === !1) {
        ...
        for (let me = 0; me < he.length; me++) {
          const Re = he[me];
          ((O.__webglColorRenderbuffer[me] = n.createRenderbuffer()),
            n.bindRenderbuffer(n.RENDERBUFFER, O.__webglColorRenderbuffer[me]));
    ...
    if (ne) {
      ...
      if (
        ...
        t.bindTexture(he, ie.__webglTexture),
        I(he, v, Ee),
        a && v.mipmaps && v.mipmaps.length > 0)
      )
        for (let me = 0; me < v.mipmaps.length; me++)
          pe(O.__webglFramebuffer[me], y, v, n.COLOR_ATTACHMENT0, he, me);
      else pe(O.__webglFramebuffer, y, v, n.COLOR_ATTACHMENT0, he, 0);
  ...
  function Ze(y) {
    ...
    for (let ie = 0, ne = O.length; ie < ne; ie++) {
      const re = O[ie];
      if (M(re, v)) {
        const Ee =
            y.isWebGLCubeRenderTarget ? n.TEXTURE_CUBE_MAP : n.TEXTURE_2D,
          he = i.get(re).__webglTexture;
  ...
  function xe(y) {
    if (a && y.samples > 0 && ve(y) === !1) {
      ...
      const re = [],
        ...
        he = i.get(y),
        me = y.isWebGLMultipleRenderTargets === !0;
      if (me)
      ...
      for (let Re = 0; Re < v.length; Re++) {
        (re.push(n.COLOR_ATTACHMENT0 + Re), y.depthBuffer && re.push(Ee));
        const Be =
        ...
        (n.blitFramebuffer(0, 0, O, ie, 0, 0, O, ie, ne, n.NEAREST),
          c && n.invalidateFramebuffer(n.READ_FRAMEBUFFER, re));
      }
      if (
  ...
  constructor(e, t) {
    ...
    ((this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (I) {
        let Y = M[I];
        return (
          Y === void 0 && ((Y = new As()), (M[I] = Y)),
          Y.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (I) {
        let Y = M[I];
        return (Y === void 0 && ((Y = new As()), (M[I] = Y)), Y.getGripSpace());
      }),
      (this.getHand = function (I) {
        let Y = M[I];
        return (Y === void 0 && ((Y = new As()), (M[I] = Y)), Y.getHandSpace());
      }));
    function Z(I) {
      const Y = x.indexOf(I.inputSource);
      if (Y === -1) return;
      const $ = M[Y];
      $ !== void 0 &&
        ($.update(I.inputSource, I.frame, c || o),
        $.dispatchEvent({ type: I.type, data: I.inputSource }));
    }
    function se() {
      ...
      for (let I = 0; I < M.length; I++) {
        const Y = x[I];
        Y !== null && ((x[I] = null), M[I].disconnect(Y));
      }
      ((b = null),
        (V = null),
        e.setRenderTarget(p),
    ...
    function D(I) {
      for (let Y = 0; Y < I.removed.length; Y++) {
        const $ = I.removed[Y],
          ce = x.indexOf($);
        ce >= 0 && ((x[ce] = null), M[ce].disconnect($));
      }
      for (let Y = 0; Y < I.added.length; Y++) {
        const $ = I.added[Y];
        let ce = x.indexOf($);
        if (ce === -1) {
    ...
    const N = new z(),
      W = new z();
    function J(I, Y, $) {
      (N.setFromMatrixPosition(Y.matrixWorld),
        W.setFromMatrixPosition($.matrixWorld));
      const ce = N.distanceTo(W),
        ...
        pt = ce / (-Ze + xe),
        Oe = pt * -Ze;
      (Y.matrixWorld.decompose(I.position, I.quaternion, I.scale),
        I.translateX(Oe),
        I.translateZ(pt),
      ...
      const y = Pe + pt,
        ...
        ne = ((qe * Te) / v) * y,
        re = ((P * Te) / v) * y;
      (I.projectionMatrix.makePerspective(O, ie, ne, re, y, v),
        I.projectionMatrixInverse.copy(I.projectionMatrix).invert());
    }
    function K(I, Y) {
      (Y === null ?
        I.matrixWorld.copy(I.matrix)
      : I.matrixWorld.multiplyMatrices(Y.matrixWorld, I.matrix),
        I.matrixWorldInverse.copy(I.matrixWorld).invert());
    }
    this.updateCamera = function (I) {
      if (r === null) return;
      ((E.near = A.near = w.near = I.near),
        (E.far = A.far = w.far = I.far),
        (b !== E.near || V !== E.far) &&
      ...
      const Y = I.parent,
        $ = E.cameras;
      K(E, Y);
      for (let ce = 0; ce < $.length; ce++) K($[ce], Y);
      ($.length === 2 ?
        J(E, w, A)
    ...
    function j(I, Y, $) {
      ...
      : (I.matrix.copy($.matrixWorld),
        I.matrix.invert(),
        I.matrix.multiply(Y.matrixWorld)),
        I.matrix.decompose(I.position, I.quaternion, I.scale),
        I.updateMatrixWorld(!0),
        I.projectionMatrix.copy(Y.projectionMatrix),
        I.projectionMatrixInverse.copy(Y.projectionMatrixInverse),
    ...
    let q = null;
    function ee(I, Y) {
      if (((u = Y.getViewerPose(c || o)), (_ = Y), u !== null)) {
        const $ = u.views;
        m !== null &&
        ...
        for (let pe = 0; pe < $.length; pe++) {
          ...
          if (m !== null) Pe = m.getViewport(Me);
            ...
            const qe = h.getViewSubImage(d, Me);
            ((Pe = qe.viewport),
              pe === 0 &&
          ...
          (Te === void 0 &&
            ...
            pe === 0 &&
              (E.matrix.copy(Te.matrix),
              E.matrix.decompose(E.position, E.quaternion, E.scale)),
            ce === !0 && E.cameras.push(Te));
        }
      }
      for (let $ = 0; $ < M.length; $++) {
        const ce = x[$],
          pe = M[$];
        ce !== null && pe !== void 0 && pe.update(ce, Y, c || o);
      }
      (q && q(I, Y),
        Y.detectedPlanes &&
          i.dispatchEvent({ type: "planesdetected", data: Y }),
        (_ = null));
    }
    const Q = new Pl();
  ...
  function d(M) {
    ...
    for (let w = 0, A = T.length; w < A; w++) {
      ...
      for (let E = 0, b = H.length; E < b; E++) {
        ...
        if (m(V, w, E, C) === !0) {
          const Z = V.__offset,
            se = Array.isArray(V.value) ? V.value : [V.value];
          let D = 0;
          for (let N = 0; N < se.length; N++) {
            ...
            : W.isMatrix3 ?
              ((V.__data[0] = W.elements[0]),
              (V.__data[1] = W.elements[1]),
              (V.__data[2] = W.elements[2]),
              (V.__data[3] = 0),
              (V.__data[4] = W.elements[3]),
              (V.__data[5] = W.elements[4]),
              (V.__data[6] = W.elements[5]),
              (V.__data[7] = 0),
              (V.__data[8] = W.elements[6]),
              (V.__data[9] = W.elements[7]),
              (V.__data[10] = W.elements[8]),
              (V.__data[11] = 0))
            : (W.toArray(V.__data, D),
  ...
  function _(M) {
    ...
    for (let A = 0, H = x.length; A < H; A++) {
      ...
      for (let b = 0, V = E.length; b < V; b++) {
        const Z = E[b],
          se = Array.isArray(Z.value) ? Z.value : [Z.value];
        for (let D = 0, N = se.length; D < N; D++) {
          const W = se[D],
            J = g(W),
            K = T % C;
          (K !== 0 && C - K < J.boundary && (T += C - K),
    ...
    const w = T % C;
    return (w > 0 && (T += C - w), (M.__size = T), (M.__cache = {}), this);
  }
  function g(M) {
  ...
  constructor(e = {}) {
    ...
    try {
      ...
      if (
        ...
        if (
          (x.isWebGL1Renderer === !0 && U.shift(), (P = Ze(U, S)), P === null)
        )
          throw Ze(U) ?
              new Error(
    ...
    function _t() {
      ((xe = new xp(P)),
        ...
        (pt = new Ep(P)),
        (Oe = new km()),
        (y = new i_(P, xe, ve, Oe, Se, _e, pt)),
        (v = new mp(x)),
        (O = new vp(x)),
        (ie = new Lf(P, Se)),
        (Ne = new fp(P, xe, ie, Se)),
        (ne = new Mp(P, ie, pt, Ne)),
        (re = new Ap(P, ne, ie, pt)),
        ($e = new bp(P, Se, y)),
        (Be = new pp(Oe)),
        ...
        (me = new Wm()),
        (Re = new Km(xe, Se)),
        (et = new up(x, v, O, ve, re, d, l)),
        (te = new t_(x, re, Se)),
        (Je = new c_(P, pt, Se, ve)),
        (De = new hp(P, xe, pt, Se)),
        (be = new Sp(P, xe, pt, Se)),
    ...
    ((this.xr = He),
      ...
      (this.setPixelRatio = function (S) {
        S !== void 0 && ((J = S), this.setSize(N, W, !1));
      }),
      ...
      (this.setSize = function (S, U, B = !0) {
        ...
        ((N = S),
          ...
          (t.height = Math.floor(U * J)),
          B === !0 && ((t.style.width = S + "px"), (t.style.height = U + "px")),
          this.setViewport(0, 0, S, U));
      }),
      (this.getDrawingBufferSize = function (S) {
        return S.set(N * J, W * J).floor();
      }),
      ...
      (this.setViewport = function (S, U, B, G) {
        (S.isVector4 ? q.set(S.x, S.y, S.z, S.w) : q.set(S, U, B, G),
          ve.viewport(b.copy(q).multiplyScalar(J).floor()));
      }),
      (this.getScissor = function (S) {
        return S.copy(ee);
      }),
      (this.setScissor = function (S, U, B, G) {
        (S.isVector4 ? ee.set(S.x, S.y, S.z, S.w) : ee.set(S, U, B, G),
          ve.scissor(V.copy(ee).multiplyScalar(J).floor()));
      }),
      (this.getScissorTest = function () {
        return Q;
      }),
      (this.setScissorTest = function (S) {
        ve.setScissorTest((Q = S));
      }),
      ...
      (this.getClearColor = function (S) {
        return S.copy(et.getClearColor());
      }),
      ...
      (this.dispose = function () {
        (t.removeEventListener("webglcontextlost", oe, !1),
          ...
          Ee.dispose(),
          He.dispose(),
          He.removeEventListener("sessionstart", Nt),
          He.removeEventListener("sessionend", st),
    ...
    function Ae(S) {
      const U = Oe.get(S).programs;
      U !== void 0 &&
        (U.forEach(function (B) {
          Ee.releaseProgram(B);
        }),
        S.isShaderMaterial && Ee.releaseShaderCache(S));
    }
    this.renderBufferDirect = function (S, U, B, G, F, de) {
      U === null && (U = Te);
      ...
      let Le = B.index,
        ze = 1;
      if (G.wireframe === !0) {
        if (((Le = ne.getWireframeAttribute(B)), Le === void 0)) return;
        ze = 2;
      }
      ...
      Ne.setup(F, G, we, B, Le);
      let _n,
        mt = De;
      if (
        (Le !== null && ((_n = ie.get(Le)), (mt = be), mt.setIndex(_n)),
        F.isMesh)
      )
        G.wireframe === !0 ?
          (ve.setLineWidth(G.wireframeLinewidth * qe()), mt.setMode(P.LINES))
        : mt.setMode(P.TRIANGLES);
      else if (F.isLine) {
        let ke = G.linewidth;
        (ke === void 0 && (ke = 1),
          ve.setLineWidth(ke * qe()),
          F.isLineSegments ? mt.setMode(P.LINES)
          : F.isLineLoop ? mt.setMode(P.LINE_LOOP)
          : mt.setMode(P.LINE_STRIP));
      } else
        F.isPoints ?
          mt.setMode(P.POINTS)
        : F.isSprite && mt.setMode(P.TRIANGLES);
      if (F.isBatchedMesh)
        mt.renderMultiDraw(
          F._multiDrawStarts,
          F._multiDrawCounts,
        ...
        const ke = B._maxInstanceCount !== void 0 ? B._maxInstanceCount : 1 / 0,
          Vr = Math.min(B.instanceCount, ke);
        mt.renderInstances(vt, At, Vr);
      } else mt.render(vt, At);
    };
    function it(S, U, B) {
      S.transparent === !0 && S.side === dn && S.forceSinglePass === !1 ?
        ((S.side = Wt),
        (S.needsUpdate = !0),
        ir(S, U, B),
        (S.side = Gn),
    ...
    ((this.compile = function (S, U, B = null) {
      ...
      (this.compileAsync = function (S, U, B = null) {
        const G = this.compile(S, U, B);
        return new Promise((F) => {
          function de() {
            if (
              (G.forEach(function (ye) {
                Oe.get(ye).currentProgram.isReady() && G.delete(ye);
              }),
              G.size === 0)
            ) {
              F(S);
    ...
    (Ft.setAnimationLoop(bt),
      ...
      (this.setAnimationLoop = function (S) {
        ((rt = S), He.setAnimationLoop(S), S === null ? Ft.stop() : Ft.start());
      }),
      He.addEventListener("sessionstart", Nt),
      He.addEventListener("sessionend", st),
      (this.render = function (S, U) {
        ...
        (S.matrixWorldAutoUpdate === !0 && S.updateMatrixWorld(),
          ...
          He.enabled === !0 &&
            He.isPresenting === !0 &&
            (He.cameraAutoUpdate === !0 && He.updateCamera(U),
            (U = He.getCamera())),
          S.isScene === !0 && S.onBeforeRender(x, S, U, A),
          (p = Re.get(S, M.length)),
          p.init(),
          M.push(p),
          pe.multiplyMatrices(U.projectionMatrix, U.matrixWorldInverse),
          I.setFromProjectionMatrix(pe),
          ($ = this.localClippingEnabled),
          (Y = Be.init(this.clippingPlanes, $)),
          (g = me.get(S, f.length)),
          g.init(),
          f.push(g),
          fn(S, U, 0, x.sortObjects),
          g.finish(),
          x.sortObjects === !0 && g.sort(K, j),
        ...
        if (
          ...
          const G = U.cameras;
          for (let F = 0, de = G.length; F < de; F++) {
            const ye = G[F];
            ea(g, S, ye, ye.viewport);
          }
        } else ea(g, S, U);
        (A !== null &&
          (y.updateMultisampleRenderTarget(A), y.updateRenderTargetMipmap(A)),
          S.isScene === !0 && S.onAfterRender(x, S, U),
    ...
    function fn(S, U, B, G) {
      ...
      if (S.layers.test(U.layers)) {
        if (S.isGroup) B = S.renderOrder;
        else if (S.isLOD) S.autoUpdate === !0 && S.update(U);
        else if (S.isLight) (p.pushLight(S), S.castShadow && p.pushShadow(S));
        else if (S.isSprite) {
          if (!S.frustumCulled || I.intersectsSprite(S)) {
            G && Pe.setFromMatrixPosition(S.matrixWorld).applyMatrix4(pe);
            const ye = re.update(S),
              we = S.material;
            we.visible && g.push(S, ye, we, B, Pe.z, null);
          }
        } else if (
          ...
          if (
            ...
            for (let ze = 0, Ue = Le.length; ze < Ue; ze++) {
              ...
              vt && vt.visible && g.push(S, ye, vt, B, Pe.z, Ie);
            }
          } else we.visible && g.push(S, ye, we, B, Pe.z, null);
        }
      }
      const de = S.children;
      for (let ye = 0, we = de.length; ye < we; ye++) fn(de[ye], U, B, G);
    }
    function ea(S, U, B, G) {
      const F = S.opaque,
        de = S.transmissive,
        ye = S.transparent;
      (p.setupLightsView(B),
        Y === !0 && Be.setGlobalState(x.clippingPlanes, B),
        de.length > 0 && Gl(F, de, U, B),
        G && ve.viewport(b.copy(G)),
        F.length > 0 && nr(F, U, B),
        de.length > 0 && nr(de, U, B),
        ye.length > 0 && nr(ye, U, B),
    ...
    function Gl(S, U, B, G) {
      ...
      for (let ze = 0, Ue = U.length; ze < Ue; ze++) {
        const Ie = U[ze],
          ...
          At = Ie.material,
          _n = Ie.group;
        if (At.side === dn && vt.layers.test(G.layers)) {
          const mt = At.side;
          ((At.side = Wt),
            (At.needsUpdate = !0),
            ta(vt, B, G, Xt, At, _n),
      ...
      (Le === !0 &&
        ...
        x.setClearColor(se, D),
        (x.toneMapping = we));
    }
    function nr(S, U, B) {
      const G = U.isScene === !0 ? U.overrideMaterial : null;
      for (let F = 0, de = S.length; F < de; F++) {
        const ye = S[F],
          we = ye.object,
          Le = ye.geometry,
          ze = G === null ? ye.material : G,
          Ue = ye.group;
        we.layers.test(B.layers) && ta(we, U, B, Le, ze, Ue);
      }
    }
    function ta(S, U, B, G, F, de) {
      (S.onBeforeRender(x, U, B, G, F, de),
        S.modelViewMatrix.multiplyMatrices(B.matrixWorldInverse, S.matrixWorld),
        S.normalMatrix.getNormalMatrix(S.modelViewMatrix),
        F.onBeforeRender(x, U, B, G, S, de),
        F.transparent === !0 && F.side === dn && F.forceSinglePass === !1 ?
          ((F.side = Wt),
          (F.needsUpdate = !0),
          x.renderBufferDirect(B, U, G, F, S, de),
          (F.side = Gn),
          (F.needsUpdate = !0),
          x.renderBufferDirect(B, U, G, F, S, de),
          (F.side = dn))
        : x.renderBufferDirect(B, U, G, F, S, de),
        S.onAfterRender(x, U, B, G, F, de));
    }
    function ir(S, U, B) {
      U.isScene !== !0 && (U = Te);
      const G = Oe.get(S),
        ...
        ye = F.state.version,
        we = Ee.getParameters(S, F.state, de, U, B),
        Le = Ee.getProgramCacheKey(we);
      let ze = G.programs;
      ((G.environment = S.isMeshStandardMaterial ? U.environment : null),
        (G.fog = U.fog),
        (G.envMap = (S.isMeshStandardMaterial ? O : v).get(
          S.envMap || G.environment,
        )),
        ze === void 0 &&
      ...
      let Ue = ze.get(Le);
      if (Ue !== void 0) {
        if (G.currentProgram === Ue && G.lightsStateVersion === ye)
          return (ia(S, we), Ue);
      } else
        ((we.uniforms = Ee.getUniforms(S)),
          S.onBuild(B, we, x),
          S.onBeforeCompile(we, x),
          (Ue = Ee.acquireProgram(we, Le)),
          ze.set(Le, Ue),
          (G.uniforms = we.uniforms));
      const Ie = G.uniforms;
      return (
    ...
    function na(S) {
      if (S.uniformsList === null) {
        ...
        S.uniformsList = Cr.seqWithValue(U.seq, S.uniforms);
      }
    ...
    function Hl(S, U, B, G, F) {
      (U.isScene !== !0 && (U = Te), y.resetTextureUnits());
      const de = U.fog,
        ye = G.isMeshStandardMaterial ? U.environment : null,
        we =
          A === null ? x.outputColorSpace
          : A.isXRRenderTarget === !0 ? A.texture.colorSpace
          : An,
        Le = (G.isMeshStandardMaterial ? O : v).get(G.envMap || ye),
        ze =
          G.vertexColors === !0 &&
          !!B.attributes.color &&
          B.attributes.color.itemSize === 4,
        Ue = !!B.attributes.tangent && (!!G.normalMap || G.anisotropy > 0),
        Ie = !!B.morphAttributes.position,
        vt = !!B.morphAttributes.normal,
        Xt = !!B.morphAttributes.color;
      let At = On;
      G.toneMapped &&
      ...
      G.version === ke.__version ?
        ((ke.needsLights && ke.lightsStateVersion !== Vr.state.version) ||
          ...
          ke.vertexAlphas !== ze ||
          ke.vertexTangents !== Ue ||
          ke.morphTargets !== Ie ||
          ke.morphNormals !== vt ||
          ke.morphColors !== Xt ||
          ke.toneMapping !== At ||
          (Se.isWebGL2 === !0 && ke.morphTargetsCount !== mt)) &&
        (gt = !0)
      : ((gt = !0), (ke.__version = G.version));
      let Hn = ke.currentProgram;
      gt === !0 && (Hn = ir(G, U, F));
      let ra = !1,
        Bi = !1,
        Wr = !1;
      ...
      if (
        ...
        (Pt.setValue(P, "projectionMatrix", S.projectionMatrix),
          Pt.setValue(P, "viewMatrix", S.matrixWorldInverse));
        const Jt = Pt.map.cameraPosition;
        (Jt !== void 0 &&
          Jt.setValue(P, Pe.setFromMatrixPosition(S.matrixWorld)),
          ...
          (G.isMeshPhongMaterial ||
            ...
            G.isShaderMaterial) &&
            Pt.setValue(P, "isOrthographic", S.isOrthographicCamera === !0),
          E !== S && ((E = S), (Bi = !0), (Wr = !0)));
      }
      if (F.isSkinnedMesh) {
        (Pt.setOptional(P, F, "bindMatrix"),
          Pt.setOptional(P, F, "bindMatrixInverse"));
        const Jt = F.skeleton;
        Jt &&
          (Se.floatVertexTextures ?
            (Jt.boneTexture === null && Jt.computeBoneTexture(),
            Pt.setValue(P, "boneTexture", Jt.boneTexture, y))
          : console.warn(
              "THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required.",
            ));
      }
      F.isBatchedMesh &&
        (Pt.setOptional(P, F, "batchingTexture"),
        Pt.setValue(P, "batchingTexture", F._matricesTexture, y));
      ...
      if (
        ...
        Bi &&
          (Pt.setValue(P, "toneMappingExposure", x.toneMappingExposure),
          ke.needsLights && kl(kn, Wr),
          de && G.fog === !0 && he.refreshFogUniforms(kn, de),
          he.refreshMaterialUniforms(kn, G, J, W, ce),
          Cr.upload(P, na(ke), kn, y)),
        G.isShaderMaterial &&
          G.uniformsNeedUpdate === !0 &&
          (Cr.upload(P, na(ke), kn, y), (G.uniformsNeedUpdate = !1)),
        G.isSpriteMaterial && Pt.setValue(P, "center", F.center),
        Pt.setValue(P, "modelViewMatrix", F.modelViewMatrix),
        Pt.setValue(P, "normalMatrix", F.normalMatrix),
        Pt.setValue(P, "modelMatrix", F.matrixWorld),
    ...
    function kl(S, U) {
      ((S.ambientLightColor.needsUpdate = U),
        (S.lightProbe.needsUpdate = U),
        (S.directionalLights.needsUpdate = U),
        (S.directionalLightShadows.needsUpdate = U),
        (S.pointLights.needsUpdate = U),
        (S.pointLightShadows.needsUpdate = U),
        (S.spotLights.needsUpdate = U),
        (S.spotLightShadows.needsUpdate = U),
        (S.rectAreaLights.needsUpdate = U),
        (S.hemisphereLights.needsUpdate = U));
    }
    function Vl(S) {
      return (
    ...
    ((this.getActiveCubeFace = function () {
      ...
      (this.setRenderTargetTextures = function (S, U, B) {
        ((Oe.get(S.texture).__webglTexture = U),
          (Oe.get(S.depthTexture).__webglTexture = B));
        const G = Oe.get(S);
        ((G.__hasExternalTextures = !0),
          G.__hasExternalTextures &&
      ...
      (this.setRenderTarget = function (S, U = 0, B = 0) {
        ...
        if (S) {
          ...
          : Le.__webglFramebuffer === void 0 ? y.setupRenderTarget(S)
          : Le.__hasExternalTextures &&
            y.rebindTextures(
              S,
              Oe.get(S.texture).__webglTexture,
              Oe.get(S.depthTexture).__webglTexture,
            );
          const ze = S.texture;
          (ze.isData3DTexture ||
            ...
            (ye = !0);
          const Ue = Oe.get(S).__webglFramebuffer;
          (S.isWebGLCubeRenderTarget ?
            (Array.isArray(Ue[U]) ? (F = Ue[U][B]) : (F = Ue[U]), (de = !0))
          : Se.isWebGL2 && S.samples > 0 && y.useMultisampledRTT(S) === !1 ?
            (F = Oe.get(S).__webglMultisampledFramebuffer)
          ...
          (b.copy(q).multiplyScalar(J).floor(),
            V.copy(ee).multiplyScalar(J).floor(),
            (Z = Q));
        if (
          (ve.bindFramebuffer(P.FRAMEBUFFER, F) &&
            Se.drawBuffers &&
            G &&
            ve.drawBuffers(S, F),
          ve.viewport(b),
      ...
      (this.readRenderTargetPixels = function (S, U, B, G, F, de, ye) {
        ...
        let we = Oe.get(S).__webglFramebuffer;
        if ((S.isWebGLCubeRenderTarget && ye !== void 0 && (we = we[ye]), we)) {
          ...
          try {
            ...
            U >= 0 &&
              ...
              B >= 0 &&
              B <= S.height - F &&
              P.readPixels(U, B, G, F, _e.convert(ze), _e.convert(Ue), de);
          } finally {
            const Le = A !== null ? Oe.get(A).__webglFramebuffer : null;
            ve.bindFramebuffer(P.FRAMEBUFFER, Le);
          }
        }
      }),
      (this.copyFramebufferToTexture = function (S, U, B = 0) {
        const G = Math.pow(2, -B),
          F = Math.floor(U.image.width * G),
          de = Math.floor(U.image.height * G);
        (y.setTexture2D(U, 0),
          P.copyTexSubImage2D(P.TEXTURE_2D, B, 0, 0, S.x, S.y, F, de),
          ve.unbindTexture());
      }),
      (this.copyTextureToTexture = function (S, U, B, G = 0) {
        const F = U.image.width,
          de = U.image.height,
          ye = _e.convert(B.format),
          we = _e.convert(B.type);
        (y.setTexture2D(B, 0),
          P.pixelStorei(P.UNPACK_FLIP_Y_WEBGL, B.flipY),
          P.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL, B.premultiplyAlpha),
          P.pixelStorei(P.UNPACK_ALIGNMENT, B.unpackAlignment),
          U.isDataTexture ?
            P.texSubImage2D(
              P.TEXTURE_2D,
              G,
          ...
          : P.texSubImage2D(P.TEXTURE_2D, G, S.x, S.y, ye, we, U.image),
          G === 0 && B.generateMipmaps && P.generateMipmap(P.TEXTURE_2D),
          ve.unbindTexture());
      }),
      (this.copyTextureToTexture3D = function (S, U, B, G, F = 0) {
        ...
        const de = S.max.x - S.min.x + 1,
          ye = S.max.y - S.min.y + 1,
          we = S.max.z - S.min.z + 1,
          Le = _e.convert(G.format),
          ze = _e.convert(G.type);
        let Ue;
        if (G.isData3DTexture) (y.setTexture3D(G, 0), (Ue = P.TEXTURE_3D));
        else if (G.isDataArrayTexture || G.isCompressedArrayTexture)
          (y.setTexture2DArray(G, 0), (Ue = P.TEXTURE_2D_ARRAY));
        else {
          console.warn(
        ...
        (P.pixelStorei(P.UNPACK_FLIP_Y_WEBGL, G.flipY),
          P.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL, G.premultiplyAlpha),
          P.pixelStorei(P.UNPACK_ALIGNMENT, G.unpackAlignment));
        const Ie = P.getParameter(P.UNPACK_ROW_LENGTH),
          vt = P.getParameter(P.UNPACK_IMAGE_HEIGHT),
          Xt = P.getParameter(P.UNPACK_SKIP_PIXELS),
          At = P.getParameter(P.UNPACK_SKIP_ROWS),
          _n = P.getParameter(P.UNPACK_SKIP_IMAGES),
        ...
        (P.pixelStorei(P.UNPACK_ROW_LENGTH, mt.width),
          ...
          P.pixelStorei(P.UNPACK_SKIP_PIXELS, S.min.x),
          P.pixelStorei(P.UNPACK_SKIP_ROWS, S.min.y),
          P.pixelStorei(P.UNPACK_SKIP_IMAGES, S.min.z),
          B.isDataTexture || B.isData3DTexture ?
            P.texSubImage3D(Ue, F, U.x, U.y, U.z, de, ye, we, Le, ze, mt.data)
          ...
          : P.texSubImage3D(Ue, F, U.x, U.y, U.z, de, ye, we, Le, ze, mt),
          P.pixelStorei(P.UNPACK_ROW_LENGTH, Ie),
          P.pixelStorei(P.UNPACK_IMAGE_HEIGHT, vt),
          P.pixelStorei(P.UNPACK_SKIP_PIXELS, Xt),
          P.pixelStorei(P.UNPACK_SKIP_ROWS, At),
          P.pixelStorei(P.UNPACK_SKIP_IMAGES, _n),
          F === 0 && G.generateMipmaps && P.generateMipmap(Ue),
          ve.unbindTexture());
      }),
      (this.initTexture = function (S) {
        (S.isCubeTexture ? y.setTextureCube(S, 0)
        : S.isData3DTexture ? y.setTexture3D(S, 0)
        : S.isDataArrayTexture || S.isCompressedArrayTexture ?
          y.setTexture2DArray(S, 0)
        : y.setTexture2D(S, 0),
          ve.unbindTexture());
      }),
      (this.resetState = function () {
        ((C = 0), (w = 0), (A = null), ve.reset(), Ne.reset());
      }),
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (i = ae()),
        (r = k("div")),
        X(r, "class", "svelte-1qp06gq"),
        X(e, "class", "panel svelte-1qp06gq"));
    },
    m(s, o) {
      (Xe(s, e, o), R(e, t), R(e, i), R(e, r), n[1](r));
    },
  ...
  return {
    c() {
      ((e = k("article")),
        ...
        (s = ae()),
        X(t, "class", "svelte-179yap3"),
        X(r, "class", "svelte-179yap3"),
        X(e, "class", "svelte-179yap3"));
    },
    m(o, a) {
      (Xe(o, e, a), R(e, t), R(e, i), R(e, r), R(e, s));
    },
    p: ge,
    d(o) {
      o && Ge(e);
...
function E_(n) {
  let e,
    ...
    j = rn(n[0]),
    q = [];
  for (let I = 0; I < j.length; I += 1) q[I] = No(Io(n, j, I));
  let ee = rn(n[1]),
    Q = [];
  ...
  return {
    ...
    Zusätzlich zeigt das Activity-Log jede Aktion und die Antwort vom Backend.`),
      ...
      ((N = ae()),
        (W = k("h3")),
        (W.textContent = "Empfehlung für dein Projekt"),
        (J = ae()),
        (K = k("p")),
        (K.textContent = `Ja, es macht absolut Sinn, Alltags-Hardware zu unterstützen. Der beste Weg ist ein\r
    ...
    ohne dass die App überfordert.`),
        X(t, "class", "svelte-179yap3"),
        X(r, "class", "svelte-179yap3"),
        X(o, "class", "svelte-179yap3"),
        X(l, "class", "svelte-179yap3"),
        X(u, "class", "svelte-179yap3"),
        X(d, "class", "svelte-179yap3"),
        X(_, "class", "svelte-179yap3"),
        X(p, "class", "svelte-179yap3"),
        X(M, "class", "svelte-179yap3"),
        X(T, "class", "svelte-179yap3"),
        X(w, "class", "svelte-179yap3"),
        X(H, "class", "svelte-179yap3"),
        X(b, "class", "svelte-179yap3"),
        X(Z, "class", "svelte-179yap3"),
        X(D, "class", "cards svelte-179yap3"),
        X(W, "class", "svelte-179yap3"),
        X(K, "class", "svelte-179yap3"),
        X(e, "class", "guide svelte-179yap3"));
    },
    m(I, Y) {
      (Xe(I, e, Y),
        R(e, t),
        ...
        R(e, x),
        R(e, T));
      for (let $ = 0; $ < q.length; $ += 1) q[$] && q[$].m(T, null);
      (R(e, C),
        R(e, w),
        R(e, A),
        R(e, H),
        ...
        R(e, se),
        R(e, D));
      for (let $ = 0; $ < Q.length; $ += 1) Q[$] && Q[$].m(D, null);
      (R(e, N), R(e, W), R(e, J), R(e, K));
    },
    p(I, [Y]) {
      if (Y & 1) {
        j = rn(I[0]);
        ...
        for ($ = 0; $ < j.length; $ += 1) {
          const ce = Io(I, j, $);
          q[$] ? q[$].p(ce, Y) : ((q[$] = No(ce)), q[$].c(), q[$].m(T, null));
        }
        for (; $ < q.length; $ += 1) q[$].d(1);
        q.length = j.length;
      }
      if (Y & 2) {
        ee = rn(I[1]);
        ...
        for ($ = 0; $ < ee.length; $ += 1) {
          const ce = Uo(I, ee, $);
          Q[$] ? Q[$].p(ce, Y) : ((Q[$] = Fo(ce)), Q[$].c(), Q[$].m(D, null));
        }
        for (; $ < Q.length; $ += 1) Q[$].d(1);
        Q.length = ee.length;
      }
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (p.__value = "mobile"),
        Qe(p, p.__value),
        X(d, "class", "svelte-2fb5c5"),
        n[1] === void 0 && ti(() => n[5].call(d)),
        X(e, "class", "panel svelte-2fb5c5"));
    },
    m(x, T) {
      (Xe(x, e, T),
        R(e, t),
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (h = We(u)),
        (m = ae()),
        X(t, "class", "svelte-1mweq8t"),
        Rt(t, "selected", n[5].active),
        X(c, "class", (d = "status " + n[5].status + " svelte-1mweq8t")),
        X(e, "class", "node"),
...
function P_(n) {
  ...
  return {
    c() {
      ...
      X(e, "class", "nodes svelte-1mweq8t");
    },
    m(r, s) {
      Xe(r, e, s);
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        X(t, "class", "svelte-16qoqwn"),
        X(r, "class", "svelte-16qoqwn"),
        X(e, "class", "recorder svelte-16qoqwn"));
    },
    m(a, l) {
      (Xe(a, e, l),
        R(e, t),
...
function ko(n) {
  ...
  return {
    c() {
      ((e = k("div")),
        (t = We("Letzter Backend-Fehler: ")),
        (i = We(n[1])),
        X(e, "class", "error svelte-1i6pt0p"));
    },
    m(r, s) {
      (Xe(r, e, s), R(e, t), R(e, i));
    },
    p(r, s) {
      s & 2 && Mt(i, r[1]);
    },
...
function Vo(n) {
  let e;
  function t(s, o) {
    return s[2].length === 0 ? q_ : $_;
  }
  let i = t(n),
    r = i(n);
  return {
    c() {
      ((e = k("div")), r.c(), X(e, "class", "log svelte-1i6pt0p"));
    },
    m(s, o) {
      (Xe(s, e, o), r.m(e, null));
    },
...
function q_(n) {
  let e,
    ...
    r,
    s,
    o = n[3] ? "ONLINE" : "OFFLINE",
    a,
    l,
    c,
    u,
    h,
    d = n[4] ? "ONLINE" : "OFFLINE",
    m,
    _,
    g,
    p,
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (f = We("WS: ")),
        (x = We(M)),
        X(e, "class", "item muted svelte-1i6pt0p"),
        X(r, "class", (l = "badge " + Ti(n[3]) + " svelte-1i6pt0p")),
        X(u, "class", (_ = "badge " + Ti(n[4]) + " svelte-1i6pt0p")),
        X(
          p,
          "class",
          (T = "badge " + Ti(n[5] === "connected") + " svelte-1i6pt0p"),
        ),
        X(i, "class", "badges svelte-1i6pt0p"));
    },
    m(C, w) {
      (Xe(C, e, w),
        Xe(C, t, w),
    ...
    p(C, w) {
      (w & 8 && o !== (o = C[3] ? "ONLINE" : "OFFLINE") && Mt(a, o),
        w & 8 &&
          l !== (l = "badge " + Ti(C[3]) + " svelte-1i6pt0p") &&
          X(r, "class", l),
        w & 16 && d !== (d = C[4] ? "ONLINE" : "OFFLINE") && Mt(m, d),
        w & 16 &&
          _ !== (_ = "badge " + Ti(C[4]) + " svelte-1i6pt0p") &&
          X(u, "class", _),
        w & 32 && M !== (M = C[5].toUpperCase() + "") && Mt(x, M),
        w & 32 &&
          T !== (T = "badge " + Ti(C[5] === "connected") + " svelte-1i6pt0p") &&
          X(p, "class", T));
    },
    d(C) {
      C && (Ge(e), Ge(t), Ge(i));
...
function Wo(n) {
  ...
  return {
    c() {
      ((e = k("span")), (t = We("— ")), (r = We(i)), X(e, "class", "details"));
    },
    m(s, o) {
      (Xe(s, e, o), R(e, t), R(e, r));
    },
    p(s, o) {
      o & 4 && i !== (i = s[7].details + "") && Mt(r, i);
    },
    d(s) {
      s && Ge(e);
    },
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        M && M.c(),
        (p = ae()),
        X(t, "class", "time svelte-1i6pt0p"),
        X(l, "class", "src svelte-1i6pt0p"),
        X(d, "class", "act"),
        X(e, "class", (f = "item " + n[7].status + " svelte-1i6pt0p")));
    },
    m(x, T) {
      (Xe(x, e, T),
        R(e, t),
    ...
    p(x, T) {
      (T & 4 && r !== (r = x[7].ts + "") && Mt(s, r),
        T & 4 && c !== (c = x[7].source + "") && Mt(u, c),
        T & 4 && m !== (m = x[7].action + "") && Mt(_, m),
        x[7].details ?
          M ? M.p(x, T)
          : ((M = Wo(x)), M.c(), M.m(e, p))
        : M && (M.d(1), (M = null)),
        T & 4 &&
          f !== (f = "item " + x[7].status + " svelte-1i6pt0p") &&
          X(e, "class", f));
    },
    d(x) {
      (x && Ge(e), M && M.d());
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (c = ae()),
        m && m.c(),
        X(i, "class", "svelte-1i6pt0p"),
        X(s, "class", "svelte-1i6pt0p"),
        X(t, "class", "header svelte-1i6pt0p"),
        X(e, "class", "panel svelte-1i6pt0p"));
    },
    m(_, g) {
      (Xe(_, e, g),
        R(e, t),
    ...
    p(_, [g]) {
      (g & 1 && o !== (o = _[0] ? "−" : "+") && Mt(a, o),
        ...
        _[0] ?
          m ? m.p(_, g)
          : ((m = Vo(_)), m.c(), m.m(e, null))
        : m && (m.d(1), (m = null)));
    },
    i: ge,
    o: ge,
    d(_) {
      (_ && Ge(e), d && d.d(), m && m.d(), (u = !1), h());
    },
  };
}
function Ti(n) {
  ...
  return {
    c() {
      ((e = k("button")),
        ...
        X(e, "class", "svelte-14pwfh9"),
        Rt(e, "active", n[0] === n[8].id));
    },
    m(s, o) {
      (Xe(s, e, o), t || ((i = Ye(e, "click", r)), (t = !0)));
    },
    p(s, o) {
...
function tg(n) {
  let e,
    ...
    pe = rn(n[4]),
    Me = [];
  for (let P = 0; P < pe.length; P += 1) Me[P] = qo($o(n, pe, P));
  ((E = new K_({})),
    (V = new L_({})),
    (se = new w_({})),
    (N = new U_({})),
    ...
    ~(Y = qe(n)) && ($ = Te[Y] = Pe[Y](n)),
    {
      c() {
        ((e = k("main")),
          ...
          (T = ae()),
          (C = k("nav")));
        for (let P = 0; P < Me.length; P += 1) Me[P].c();
        ((w = ae()),
          (A = k("section")),
          (H = k("aside")),
          dt(E.$$.fragment),
          ...
          (I = k("div")),
          $ && $.c(),
          X(i, "class", "svelte-14pwfh9"),
          X(o, "class", "badge svelte-14pwfh9"),
          Rt(o, "ok", n[1]),
          Rt(o, "bad", !n[1]),
          X(h, "class", "badge svelte-14pwfh9"),
          Rt(h, "ok", n[2]),
          Rt(h, "bad", !n[2]),
          X(p, "class", "badge svelte-14pwfh9"),
          Rt(p, "ok", n[3] === "connected"),
          Rt(p, "bad", n[3] !== "connected"),
          X(s, "class", "statusbar svelte-14pwfh9"),
          X(C, "class", "svelte-14pwfh9"),
          X(t, "class", "topbar svelte-14pwfh9"),
          X(H, "class", "sidebar svelte-14pwfh9"),
          X(I, "class", "workspace svelte-14pwfh9"),
          X(A, "class", "content svelte-14pwfh9"),
          X(e, "class", "app svelte-14pwfh9"));
      },
      m(P, Ze) {
        (Xe(P, e, Ze),
          R(e, t),
          ...
          R(t, T),
          R(t, C));
        for (let xe = 0; xe < Me.length; xe += 1) Me[xe] && Me[xe].m(C, null);
        (R(e, w),
          R(e, A),
          R(A, H),
          ct(E, H, null),
      ...
      p(P, [Ze]) {
        if (
          ((!ce || Ze & 2) &&
            l !== (l = P[1] ? "ONLINE" : "OFFLINE") &&
            Mt(c, l),
          (!ce || Ze & 2) && Rt(o, "ok", P[1]),
          (!ce || Ze & 2) && Rt(o, "bad", !P[1]),
          (!ce || Ze & 4) &&
            m !== (m = P[2] ? "ONLINE" : "OFFLINE") &&
            Mt(_, m),
          (!ce || Ze & 4) && Rt(h, "ok", P[2]),
          (!ce || Ze & 4) && Rt(h, "bad", !P[2]),
          (!ce || Ze & 8) && M !== (M = P[3].toUpperCase() + "") && Mt(x, M),
          (!ce || Ze & 8) && Rt(p, "ok", P[3] === "connected"),
          (!ce || Ze & 8) && Rt(p, "bad", P[3] !== "connected"),
          Ze & 17)
        ) {
          pe = rn(P[4]);
          let Se;
          for (Se = 0; Se < pe.length; Se += 1) {
            const ve = $o(P, pe, Se);
            Me[Se] ?
              Me[Se].p(ve, Ze)
            : ((Me[Se] = qo(ve)), Me[Se].c(), Me[Se].m(C, null));
          }
