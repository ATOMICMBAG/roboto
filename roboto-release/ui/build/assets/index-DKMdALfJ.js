...
class Et {
  ...
  multiplyMatrices(e, t) {
    ...
    return (
      ...
      (s[5] = u * A + f * V + d * N + m * J),
      (s[9] = u * k + f * Z + d * B + m * j),
      (s[13] = u * S + f * ie + d * X + m * ee),
      (s[2] = _ * w + g * b + p * D + h * $),
      (s[6] = _ * A + g * V + p * N + h * J),
      (s[10] = _ * k + g * Z + p * B + h * j),
      (s[14] = _ * S + g * ie + p * X + h * ee),
      (s[3] = M * w + x * b + T * D + P * $),
      (s[7] = M * A + x * V + T * N + P * J),
      (s[11] = M * k + x * Z + T * B + P * j),
...
class tr extends si {
  constructor(e = 1, t = 1, i = 1, r = 1, s = 1, o = 1) {
    ...
    function _(g, p, h, M, x, T, P, w, A, k, S) {
      const b = T / A,
        V = P / k,
        Z = T / 2,
        ie = P / 2,
    ...
    if (
      ...
      if (Array.isArray(D)) {
        ...
        for (let B = 0, X = N.length; B < X; B++) {
          ...
          if (J && J.visible) {
            const j = x(w, J, S, b);
            (w.onBeforeShadow(n, w, A, k, ie, j, $),
              n.renderBufferDirect(k, null, ie, j, w, $),
              w.onAfterShadow(n, w, A, k, ie, j, $));
          }
        }
      } else if (D.visible) {
        const N = x(w, D, S, b);
        (w.onBeforeShadow(n, w, A, k, ie, N, null),
          n.renderBufferDirect(k, null, ie, N, w, null),
          w.onAfterShadow(n, w, A, k, ie, N, null));
      }
    }
    const Z = w.children;
    for (let ie = 0, D = Z.length; ie < D; ie++) T(Z[ie], A, k, S, b);
  }
  function P(w) {
...
function n_(n, e, t) {
  ...
  function O(C, ue, he) {
    C ?
      ...
      (N !== ue || B !== he) && (n.polygonOffset(ue, he), (N = ue), (B = he)))
  ...
  function se(C, ue, he) {
    he === void 0 && (ee === null ? (he = n.TEXTURE0 + X - 1) : (he = ee));
    let Ce = Q[he];
...
function i_(n, e, t, i, r, s, o) {
  ...
  function k(y) {
    const v = y.target;
    (v.removeEventListener("dispose", k), V(v));
  }
  function S(y) {
    const v = i.get(y);
  ...
  function me(y, v, O, re, ne, se) {
    const Ee = s.convert(O.format, O.colorSpace),
      fe = s.convert(O.type),
      _e = T(O.internalFormat, Ee, fe, O.colorSpace);
    if (!i.get(v).__hasExternalTextures) {
      ...
      ne === n.TEXTURE_3D || ne === n.TEXTURE_2D_ARRAY ?
        t.texImage3D(ne, se, _e, Be, te, v.depth, 0, Ee, fe, null)
      : t.texImage2D(ne, se, _e, Be, te, 0, Ee, fe, null);
    }
    ...
    if (
      ...
      for (let ne = 0; ne < re.length; ne++) {
        const se = re[ne],
          ...
          fe = s.convert(se.type),
          _e = T(se.internalFormat, Ee, fe, se.colorSpace),
          Re = Se(v);
        O && ve(v) === !1 ?
          n.renderbufferStorageMultisample(
            n.RENDERBUFFER,
  ...
  function L(y) {
    ...
    if (ne) {
      ...
      for (let fe = 0; fe < 6; fe++)
        if (a && v.mipmaps && v.mipmaps.length > 0) {
          O.__webglFramebuffer[fe] = [];
          for (let _e = 0; _e < v.mipmaps.length; _e++)
            O.__webglFramebuffer[fe][_e] = n.createFramebuffer();
        } else O.__webglFramebuffer[fe] = n.createFramebuffer();
    } else {
      if (a && v.mipmaps && v.mipmaps.length > 0) {
        O.__webglFramebuffer = [];
        for (let fe = 0; fe < v.mipmaps.length; fe++)
          O.__webglFramebuffer[fe] = n.createFramebuffer();
    ...
    if (ne) {
      ...
      if (
        ...
        t.bindTexture(fe, re.__webglTexture),
        I(fe, v, Ee),
        a && v.mipmaps && v.mipmaps.length > 0)
      )
        for (let _e = 0; _e < v.mipmaps.length; _e++)
          me(O.__webglFramebuffer[_e], y, v, n.COLOR_ATTACHMENT0, fe, _e);
      else me(O.__webglFramebuffer, y, v, n.COLOR_ATTACHMENT0, fe, 0);
  ...
  constructor(e = {}) {
    ...
    function _t() {
      ((xe = new xp(L)),
        ...
        (O = new vp(x)),
        (re = new Ch(L, Se)),
        (Ne = new hp(L, xe, re, Se)),
        (ne = new Mp(L, re, pt, Ne)),
        (se = new Ap(L, ne, re, pt)),
        (We = new bp(L, Se, y)),
        (Be = new pp(Oe)),
        (Ee = new km(x, v, O, xe, Se, Ne, Be)),
        (fe = new l_(x, Oe)),
        (_e = new Wm()),
        (Re = new Km(xe, Se)),
    ...
    this.renderBufferDirect = function (E, U, z, H, F, de) {
      U === null && (U = Te);
    ...
    (Ft.setAnimationLoop(bt),
      ...
      (this.render = function (E, U) {
        ...
        if (
          ...
          const H = U.cameras;
          for (let F = 0, de = H.length; F < de; F++) {
            const ye = H[F];
    ...
    function ta(E, U, z, H, F, de) {
      (E.onBeforeRender(x, U, z, H, F, de),
        E.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse, E.matrixWorld),
        E.normalMatrix.getNormalMatrix(E.modelViewMatrix),
        F.onBeforeRender(x, U, z, H, E, de),
        F.transparent === !0 && F.side === dn && F.forceSinglePass === !1 ?
          ((F.side = Wt),
          (F.needsUpdate = !0),
          x.renderBufferDirect(z, U, H, F, E, de),
          (F.side = Gn),
          (F.needsUpdate = !0),
          x.renderBufferDirect(z, U, H, F, E, de),
          (F.side = dn))
        : x.renderBufferDirect(z, U, H, F, E, de),
        E.onAfterRender(x, U, z, H, F, de));
    }
    function ir(E, U, z) {
      U.isScene !== !0 && (U = Te);
      const H = Oe.get(E),
    ...
    function kl(E, U, z, H, F) {
      ...
      const de = U.fog,
        ...
        we =
          ...
          : An,
        Le = (H.isMeshStandardMaterial ? O : v).get(H.envMap || ye),
        ze =
          H.vertexColors === !0 &&
          !!z.attributes.color &&
      ...
      const Pt = kn.getUniforms(),
        Hn = ke.uniforms;
      if (
        (ve.useProgram(kn.program) && ((ra = !0), (Bi = !0), (Wr = !0)),
        H.id !== k && ((k = H.id), (Bi = !0)),
        ra || S !== E)
      ) {
      ...
      if (
        ...
        Bi &&
          ...
          de && H.fog === !0 && fe.refreshFogUniforms(Hn, de),
          fe.refreshMaterialUniforms(Hn, H, X, B, ce),
          Cr.upload(L, na(ke), Hn, y)),
        H.isShaderMaterial &&
          H.uniformsNeedUpdate === !0 &&
          (Cr.upload(L, na(ke), Hn, y), (H.uniformsNeedUpdate = !1)),
    ...
    ((this.getActiveCubeFace = function () {
      ...
      (this.readRenderTargetPixels = function (E, U, z, H, F, de, ye) {
        ...
        if ((E.isWebGLCubeRenderTarget && ye !== void 0 && (we = we[ye]), we)) {
          ...
          try {
            ...
            U >= 0 &&
              ...
              z >= 0 &&
              z <= E.height - F &&
              L.readPixels(U, z, H, F, ge.convert(ze), ge.convert(Ue), de);
          } finally {
      ...
      (this.copyTextureToTexture3D = function (E, U, z, H, F = 0) {
...
function E_(n) {
  ...
  return {
    ...
    ohne dass die App überfordert.`),
        ...
        q(Z, "class", "svelte-1dhku2"),
        q(D, "class", "cards svelte-1dhku2"),
        q(B, "class", "svelte-1dhku2"),
...
function Vo(n) {
  ...
  return {
    c() {
      ((e = W("div")), r.c(), q(e, "class", "log svelte-1781vg8"));
    },
    m(s, o) {
      (qe(s, e, o), r.m(e, null));
    },
    ...
    ~(K = $e(n)) && (Y = Te[K] = Pe[K](n)),
    {
      c() {
        ((e = W("main")),
          (t = W("header")),
          (i = W("h1")),
          (i.textContent = "roboto Control UI"),
          (r = ae()),
          (s = W("div")),
          (o = W("span")),
          (a = Ve("Backend: ")),
        ...
        ((w = ae()),
          ...
          (I = W("div")),
          Y && Y.c(),
          q(i, "class", "svelte-1v4tefk"),
          q(o, "class", "badge svelte-1v4tefk"),
          Rt(o, "ok", n[1]),
          Rt(o, "bad", !n[1]),
          q(f, "class", "badge svelte-1v4tefk"),
          Rt(f, "ok", n[2]),
          Rt(f, "bad", !n[2]),
          q(p, "class", "badge svelte-1v4tefk"),
          Rt(p, "ok", n[3] === "connected"),
          Rt(p, "bad", n[3] !== "connected"),
          q(s, "class", "statusbar svelte-1v4tefk"),
          q(P, "class", "svelte-1v4tefk"),
          q(t, "class", "topbar svelte-1v4tefk"),
          q(k, "class", "sidebar svelte-1v4tefk"),
          q(I, "class", "workspace svelte-1v4tefk"),
          q(A, "class", "content svelte-1v4tefk"),
          q(e, "class", "app svelte-1v4tefk"));
      },
      m(L, Ze) {
        (qe(L, e, Ze),
          R(e, t),
