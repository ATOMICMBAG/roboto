...
class tr extends si {
  constructor(e = 1, t = 1, i = 1, r = 1, s = 1, o = 1) {
    ...
    function _(g, p, h, M, x, T, P, w, A, H, S) {
      const b = T / A,
        V = P / H,
        Z = T / 2,
        ie = P / 2,
...
class zl {
  constructor(e = {}) {
    ...
    function hn(E, U, z, k) {
      ...
      const de = E.children;
      for (let ye = 0, we = de.length; ye < we; ye++) hn(de[ye], U, z, k);
    }
    function ea(E, U, z, k) {
      const F = E.opaque,
        de = E.transmissive,
    ...
    function Hl(E, U, z, k, F) {
      ...
      if (
        ...
        Bi &&
          ...
          de && k.fog === !0 && fe.refreshFogUniforms(kn, de),
          fe.refreshMaterialUniforms(kn, k, X, B, ce),
    ...
    ~(K = $e(n)) && (Y = Te[K] = Pe[K](n)),
    {
      c() {
        ...
        ((w = ae()),
          ...
          (I = W("div")),
          Y && Y.c(),
          q(i, "class", "svelte-o1fxzj"),
          q(o, "class", "badge svelte-o1fxzj"),
          Rt(o, "ok", n[1]),
          Rt(o, "bad", !n[1]),
          q(f, "class", "badge svelte-o1fxzj"),
          Rt(f, "ok", n[2]),
          Rt(f, "bad", !n[2]),
          q(p, "class", "badge svelte-o1fxzj"),
          Rt(p, "ok", n[3] === "connected"),
          Rt(p, "bad", n[3] !== "connected"),
          q(s, "class", "statusbar svelte-o1fxzj"),
          q(P, "class", "svelte-o1fxzj"),
          q(t, "class", "topbar svelte-o1fxzj"),
          q(H, "class", "sidebar svelte-o1fxzj"),
          q(I, "class", "workspace svelte-o1fxzj"),
          q(A, "class", "content svelte-o1fxzj"),
          q(e, "class", "app svelte-o1fxzj"));
      },
      m(L, Ze) {
        (qe(L, e, Ze),
          R(e, t),
