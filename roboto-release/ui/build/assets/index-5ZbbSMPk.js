  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (T = ae()),
        A.c(),
        X(i, "class", (a = "badge " + Ti(n[2]) + " svelte-pv954r")),
        X(c, "class", (m = "badge " + Ti(n[3]) + " svelte-pv954r")),
        X(
          g,
          "class",
          (x = "badge " + Ti(n[4] === "connected") + " svelte-pv954r"),
        ),
        X(t, "class", "badges svelte-pv954r"),
        X(e, "class", "log svelte-pv954r"));
    },
    m(N, S) {
      (qe(N, e, S),
        R(e, t),
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        X(e, "class", "item muted svelte-pv954r"));
    },
    m(t, i) {
      qe(t, e, i);
    },
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        M && M.c(),
        (p = ae()),
        X(t, "class", "time svelte-pv954r"),
        X(l, "class", "src svelte-pv954r"),
        X(d, "class", "act"),
        X(e, "class", (h = "item " + n[7].status + " svelte-pv954r")));
    },
    m(x, T) {
      (qe(x, e, T),
        R(e, t),
  ...
  return {
    c() {
      ((e = k("div")),
        ...
        (c = ae()),
        m && m.c(),
        X(i, "class", "svelte-pv954r"),
        X(s, "class", "svelte-pv954r"),
        X(t, "class", "header svelte-pv954r"),
        X(e, "class", "panel svelte-pv954r"));
    },
    m(_, g) {
      (qe(_, e, g),
        R(e, t),
    ...
    ~(Y = $e(n)) && ($ = Te[Y] = Pe[Y](n)),
    {
      c() {
        ...
        ((w = ae()),
          ...
          (I = k("div")),
          $ && $.c(),
          X(i, "class", "svelte-h517e4"),
          X(o, "class", "badge svelte-h517e4"),
          Rt(o, "ok", n[1]),
          Rt(o, "bad", !n[1]),
          X(f, "class", "badge svelte-h517e4"),
          Rt(f, "ok", n[2]),
          Rt(f, "bad", !n[2]),
          X(p, "class", "badge svelte-h517e4"),
          Rt(p, "ok", n[3] === "connected"),
          Rt(p, "bad", n[3] !== "connected"),
          X(s, "class", "statusbar svelte-h517e4"),
          X(P, "class", "svelte-h517e4"),
          X(t, "class", "topbar svelte-h517e4"),
          X(N, "class", "sidebar svelte-h517e4"),
          X(I, "class", "workspace svelte-h517e4"),
          X(A, "class", "content svelte-h517e4"),
          X(e, "class", "app svelte-h517e4"));
      },
      m(L, Ze) {
        (qe(L, e, Ze),
          R(e, t),
